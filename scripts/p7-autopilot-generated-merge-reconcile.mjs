...
const generatedSpecPattern = /^apps\/web\/tests\/e2e\/platform-v7-agent-generated-smoke.*\.spec\.ts$/;
...
function assertGeneratedScope(prNumber) {
  ...
  for (const file of files) {
    ...
    if (generatedSpecPattern.test(file)) hasGeneratedCode = true;
  }
  if (!hasGeneratedCode) throw new Error(`generated PR ${prNumber} has no generated code/test file`);
}
