...
const CASES = [
  {
    ...
    supportGroups: [
      { id: 'soil-analysis', terms: ['почв', 'ph', 'рн', 'анализ', 'кислот', 'структур'] },
      { id: 'nutrients', terms: ['азот', 'фосфор', 'калий', 'npk', 'питан', 'удобрен', 'макроэлемент'] },
      { id: 'organic-matter', terms: ['органик', 'навоз', 'компост', 'перегной', 'сидерат'] },
      { id: 'timing-application', terms: ['фаз', 'срок', 'посадк', 'внесен', 'подкорм', 'окучив'] },
    ],
  },
  {
  ...
  },
  {
    ...
    supportGroups: [
      { id: 'temperature', terms: ['температур', 'жар', 'холод', 'ночн', 'перепад'] },
      { id: 'water-humidity', terms: ['влаг', 'влажн', 'полив', 'засух', 'переувлаж'] },
      { id: 'pollination', terms: ['опыл', 'пыльц', 'завяз', 'цветен'] },
      { id: 'nutrition', terms: ['питан', 'азот', 'бор', 'калий', 'фосфор', 'дефицит', 'подкорм'] },
      { id: 'light-stress', terms: ['свет', 'освещ', 'стресс', 'ветер', 'нагруз'] },
    ],
  },
  {
    id: 'apple-scab',
    ...
    supportGroups: [
      { id: 'sanitation-inoculum', terms: ['санитар', 'удал', 'убир', 'опавш', 'мумифиц', 'остатк', 'источник инфекции'] },
      { id: 'canopy-drying', terms: ['крон', 'обрез', 'прореж', 'вентиляц', 'проветр', 'высых', 'увлажнение листьев'] },
      ...
      { id: 'labelled-protection', terms: ['фунгиц', 'обработ', 'зарегистрирован', 'этикет', 'защита растений'] },
    ],
  },
  {
    id: 'soil-acidity',
    ...
    supportGroups: [
      { id: 'measurement-analysis', terms: ['ph', 'рн', 'анализ', 'тест', 'лаборатор', 'кислот'] },
      { id: 'liming-material', terms: ['извест', 'доломит', 'мел', 'кальц', 'карбонат'] },
      { id: 'application-rate', terms: ['доз', 'норм', 'внесен', 'расчет', 'заделк', 'смеш'] },
      { id: 'crop-target', terms: ['культур', 'картоф', 'томат', 'яблон', 'виноград', 'требован'] },
      { id: 'soil-buffering', terms: ['структур', 'механическ', 'органик', 'буфер', 'глин', 'песчан'] },
    ],
  },
  {
    id: 'drip-irrigation',
    ...
    supportGroups: [
      { id: 'source-capacity', terms: ['источник', 'скважин', 'колод', 'дебит', 'резервуар', 'доступность воды'] },
      { id: 'flow-demand', terms: ['расход', 'потребност', 'л/час', 'л/сут', 'подач'] },
      { id: 'pressure-hydraulics', terms: ['давлен', 'напор', 'насос', 'редуктор'] },
      { id: 'filtration-quality', terms: ['фильтр', 'примес', 'чистот', 'качество воды', 'засор'] },
      { id: 'layout-zones', terms: ['зон', 'длина', 'лента', 'линия', 'эмиттер', 'шаг', 'гряд'] },
      { id: 'crop-soil-relief', terms: ['культур', 'почв', 'рельеф', 'площад', 'перепад'] },
    ],
  },
  {
    id: 'cow-milk-drop',
    ...
    supportGroups: [
      { id: 'ration-feed', terms: ['корм', 'рацион', 'белок', 'энерги', 'клетчат', 'минерал', 'витамин'] },
      { id: 'health-mastitis', terms: ['здоров', 'мастит', 'болезн', 'инфекц', 'анализ молока', 'симптом'] },
      { id: 'water', terms: ['вода', 'поилк', 'водопотреб'] },
      { id: 'stress-microclimate', terms: ['стресс', 'температур', 'микроклимат', 'вентиляц', 'жар'] },
      { id: 'lactation-stage', terms: ['лактац', 'отел', 'беремен', 'возраст', 'стадия'] },
      { id: 'milking-management', terms: ['доен', 'режим', 'оборудован', 'учет', 'продуктивност'] },
    ],
  },
  {
    ...
    supportGroups: [
      { id: 'ration-nutrients', terms: ['корм', 'рацион', 'белок', 'энерги', 'аминокисл', 'зерн', 'соя'] },
      { id: 'feed-quality', terms: ['качество', 'усвоен', 'переварим', 'гранул', 'влажност корма'] },
      { id: 'health', terms: ['здоров', 'болезн', 'паразит', 'вакцин'] },
      { id: 'water', terms: ['вода', 'поилк', 'водоснабжен'] },
      { id: 'microclimate-stress', terms: ['микроклимат', 'температур', 'вентиляц', 'стресс', 'чистот'] },
      { id: 'management-stage', terms: ['возраст', 'стадия', 'плотност', 'режим кормлен', 'конверс'] },
    ],
  },
  {
    id: 'chicken-egg-drop',
    ...
    supportGroups: [
      ...
      { id: 'lighting', terms: ['свет', 'освещ', 'фотопериод', 'световой день'] },
      { id: 'microclimate', terms: ['температур', 'влажност', 'вентиляц', 'жар', 'холод'] },
      { id: 'health', terms: ['здоров', 'болезн', 'инфекц', 'паразит'] },
      { id: 'stress-management', terms: ['стресс', 'плотност', 'клетк', 'вольер', 'возраст', 'линьк'] },
    ],
  },
  {
    id: 'bee-wintering',
    ...
    supportGroups: [
      { id: 'feed-reserves', terms: ['мед', 'корм', 'запас', 'сироп', 'сот', 'нектар'] },
      { id: 'colony-condition', terms: ['семь', 'семья', 'матк', 'расплод', 'клуб', 'сила семьи'] },
      { id: 'health-parasites', terms: ['варроа', 'клещ', 'паразит', 'болезн', 'нозем', 'акари'] },
      { id: 'hive-microclimate', terms: ['вентиляц', 'влажност', 'конденсат', 'утепл', 'улей', 'леток'] },
      { id: 'weather-protection', terms: ['климат', 'холод', 'мороз', 'ветер', 'осад', 'зим'] },
    ],
  },
  {
    id: 'tractor-overheat',
    ...
    supportGroups: [
      { id: 'cooling-system', terms: ['радиатор', 'охлажд', 'антифриз', 'жидкост', 'вентилятор'] },
      { id: 'thermostat-pump', terms: ['термостат', 'насос', 'помпа', 'ремен'] },
      { id: 'airflow-cleanliness', terms: ['загрязн', 'пыль', 'сетк', 'продув', 'поток воздуха'] },
      { id: 'load-operation', terms: ['нагруз', 'оборот', 'передач', 'скорост', 'режим работы'] },
      { id: 'engine-lubrication', terms: ['масло', 'смаз', 'прокладк', 'головк', 'цилиндр'] },
    ],
  },
  {
    id: 'combine-losses',
    ...
    supportGroups: [
      { id: 'header-cutting', terms: ['жатк', 'мотовил', 'нож', 'высот срез', 'подача массы'] },
      { id: 'threshing', terms: ['молотил', 'барабан', 'зазор', 'ротор', 'обмолот'] },
      { id: 'separation-cleaning', terms: ['решет', 'вентилятор', 'очистк', 'соломотряс', 'сепарац'] },
      { id: 'speed-load', terms: ['скорост', 'подач', 'загрузк', 'производительност'] },
      { id: 'crop-calibration', terms: ['влажност', 'культур', 'зерн', 'замер', 'проб', 'настройк'] },
    ],
  },
  {
    id: 'mower-vibration',
    ...
    supportGroups: [
      { id: 'blade-balance', terms: ['нож', 'лезв', 'баланс', 'деформ', 'заточ'] },
      { id: 'fasteners-mounting', terms: ['креплен', 'болт', 'гайк', 'посадк', 'ослаб'] },
      { id: 'shaft-bearings', terms: ['вал', 'подшип', 'шпиндел', 'люфт'] },
      { id: 'deck-debris', terms: ['трава', 'гряз', 'дек', 'намот', 'засор'] },
      { id: 'engine-drive', terms: ['двигател', 'ремен', 'муфт', 'оборот', 'привод'] },
    ],
  },
  {
    id: 'grain-storage',
    ...
    supportGroups: [
      { id: 'moisture-drying', terms: ['влажн', 'сушк', 'досуш', 'конденсат'] },
      { id: 'temperature-aeration', terms: ['температур', 'вентиляц', 'аэрац', 'охлажд'] },
      { id: 'pests-molds', terms: ['вредител', 'насеком', 'плесен', 'гриб', 'заражен'] },
      { id: 'monitoring-sampling', terms: ['монитор', 'контрол', 'датчик', 'проб', 'измер'] },
      { id: 'storage-hygiene', terms: ['склад', 'силос', 'очистк', 'гермет', 'санитар', 'хранилищ'] },
    ],
  },
  {
    id: 'farm-costs',
    ...
    supportGroups: [
      { id: 'cost-accounting', terms: ['затрат', 'расход', 'себестоим', 'учет', 'анализ', 'бюджет'] },
      { id: 'input-efficiency', terms: ['удобрен', 'семен', 'сзр', 'норм', 'закуп', 'материал'] },
      { id: 'machinery-fuel', terms: ['техник', 'топлив', 'ремонт', 'загрузк', 'маршрут'] },
      { id: 'yield-quality', terms: ['урожайн', 'качество', 'потер', 'выход', 'продуктивност'] },
      { id: 'planning-benchmark', terms: ['план', 'kpi', 'норматив', 'сравнен', 'отклонен', 'приоритет'] },
    ],
  },
  {
    id: 'village-water',
    ...
    supportGroups: [
      { id: 'source-yield', terms: ['скважин', 'колод', 'источник', 'дебит', 'водозабор'] },
      { id: 'pumping-pressure', terms: ['насос', 'давлен', 'напор', 'станц'] },
      { id: 'storage-reserve', terms: ['резерв', 'емкост', 'бак', 'запас', 'накопител'] },
      { id: 'quality-treatment', terms: ['качество', 'анализ', 'фильтр', 'обеззараж', 'очистк'] },
      { id: 'distribution-reliability', terms: ['труб', 'сеть', 'разводк', 'резервир', 'электропитан'] },
    ],
  },
  {
    id: 'farm-excel',
    ...
    supportGroups: [
      { id: 'cost-inputs', terms: ['затрат', 'расход', 'прям', 'косвен', 'себестоим'] },
      { id: 'volume-unit', terms: ['тонн', 'объем', 'масса', 'выход', 'единиц'] },
      { id: 'formula-allocation', terms: ['формул', 'делен', 'сумм', 'распределен', 'ячейк'] },
      { id: 'period-basis', terms: ['период', 'партия', 'урожай', 'сезон'] },
      { id: 'validation-table', terms: ['проверк', 'сверк', 'таблиц', 'столбц', 'excel'] },
    ],
  },
  {
    id: 'potato-en',
    ...
    supportGroups: [
      { id: 'soil-analysis', terms: ['soil', 'ph', 'test', 'analysis', 'texture'] },
      { id: 'nutrients', terms: ['nitrogen', 'phosph', 'potassium', 'npk', 'nutrient', 'fertil'] },
      { id: 'organic-matter', terms: ['manure', 'compost', 'organic matter'] },
      { id: 'timing-application', terms: ['growth stage', 'planting', 'application', 'side-dress', 'timing'] },
      { id: 'water-yield', terms: ['irrigation', 'moisture', 'yield target'] },
    ],
  },
  {
    id: 'cucumber-zh',
    ...
    supportGroups: [
      { id: 'nutrition', terms: ['营养', '氮', '钾', '镁', '缺素', '施肥'] },
      { id: 'water-root', terms: ['浇水', '水分', '根', '干旱', '积水'] },
      { id: 'disease-pests', terms: ['病', '真菌', '病毒', '害虫', '螨', '蚜'] },
      { id: 'climate-light', terms: ['温度', '湿度', '高温', '低温', '光照'] },
    ],
  },
  {
    id: 'context-followup',
    ...
    supportGroups: [
      { id: 'drought-genetics', terms: ['засух', 'гибрид', 'сорт', 'устойчив'] },
      { id: 'soil-moisture', terms: ['влаг', 'почв', 'мульч', 'минимальн', 'no-till', 'сохранение воды'] },
      { id: 'density-timing', terms: ['густот', 'норм высев', 'срок', 'посев', 'ряд'] },
      { id: 'nutrition', terms: ['питан', 'удобрен', 'азот', 'фосфор', 'калий'] },
      { id: 'yield-risk', terms: ['урожайн', 'риск', 'страхован', 'потер'] },
    ],
  },
];
