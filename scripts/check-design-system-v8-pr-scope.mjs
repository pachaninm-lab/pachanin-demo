...
const exact = new Set([
  ...
  'apps/web/app/platform-v7/admin/page.tsx',
  'apps/web/app/platform-v7/control-tower/page.tsx',
  'apps/web/app/platform-v7/control-tower/anti-bypass/page.tsx',
  'apps/web/app/platform-v7/control-tower/bypass-risk/page.tsx',
  'apps/web/app/platform-v7/control-tower/canonical-reconciliation/page.tsx',
  ...
  'apps/web/app/platform-v7/audit-log/page.tsx',
  ...
  'apps/web/app/platform-v7/security/page.tsx',
  'apps/web/app/platform-v7/security/grain/page.tsx',
  'apps/web/app/platform-v7/trust/page.tsx',
  'apps/web/app/platform-v7/simulator/page.tsx',
  ...
  'apps/web/app/platform-v7/seller/deals/page.tsx',
  'apps/web/app/platform-v7/seller/lots/page.tsx',
  'apps/web/app/platform-v7/seller/lots/new/page.tsx',
  'apps/web/app/platform-v7/seller/matches/page.tsx',
  'apps/web/app/platform-v7/seller/offers/page.tsx',
  'apps/web/app/platform-v7/seller/rfq/page.tsx',
  ...
  'apps/web/app/platform-v7/lot/[id]/page.tsx',
  'apps/web/app/platform-v7/buyer/page.tsx',
  'apps/web/app/platform-v7/buyer/rfq/page.tsx',
  ...
  'apps/web/app/platform-v7/buyer/matches/page.tsx',
  'apps/web/app/platform-v7/buyer/reputation/page.tsx',
  'apps/web/app/platform-v7/bank/page.tsx',
  'apps/web/app/platform-v7/bank/payment-basis/page.tsx',
  ...
  'apps/web/app/platform-v7/logistics/[routeId]/page.tsx',
  'apps/web/app/platform-v7/logistics/drivers/page.tsx',
  'apps/web/app/platform-v7/logistics/inbox/page.tsx',
  ...
  'apps/web/components/platform-v7/P7BankPaymentBasisRuntimePanel.tsx',
  ...
  'apps/web/lib/platform-v7/bank-payment-basis-runtime-action.ts',
  ...
  'apps/web/tests/unit/p7BankPaymentBasisRuntimePanel.test.tsx',
  'apps/web/tests/unit/platformV7ApiDocsAuthority.test.ts',
  'apps/web/tests/unit/platformV7ApiDocsLegacyIsolation.test.ts',
  'apps/web/tests/unit/platformV7AuditLogAuthority.test.ts',
  ...
  'apps/web/tests/unit/platformV7OperatorCompatibilityAliases.test.ts',
  ...
  'apps/web/tests/unit/platformV7BankEscrowSurface.test.ts',
  'apps/web/tests/unit/platformV7BuyerRfqAuthority.test.ts',
  'apps/web/tests/unit/platformV7BuyerRiskAuthority.test.ts',
  'apps/web/tests/unit/platformV7BatchLotCanonicalAliases.test.ts',
  'apps/web/tests/unit/platformV7SellerCanonicalAliases.test.ts',
  'apps/web/tests/unit/platformV7SellerRfqAuthority.test.ts',
  'apps/web/tests/unit/platformV7LogisticsSecondaryAuthority.test.ts',
  'apps/web/tests/unit/platformV7BankSecondaryAuthority.test.ts',
  ...
  'apps/web/tests/unit/platformV7SecurityTrustCompatibility.test.ts',
