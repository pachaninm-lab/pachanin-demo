...
const exact = new Set([
  ...
  'apps/web/components/platform-v7/PlatformV7FixedHeaderRuntime.tsx',
  ...
  'apps/web/lib/platform-v7/design-system-v8-routes.ts',
  ...
  'apps/web/tests/unit/designSystemV8LegacyIsolation.test.ts',
  ...
  'apps/web/tests/unit/scopedShellGuard.test.tsx',
  'apps/web/tests/unit/scopedShellGuardMobileHeader.test.ts',
