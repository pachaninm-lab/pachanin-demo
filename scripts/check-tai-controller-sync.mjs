...
for (const fragment of [
  ...
  '- "docs/platform-v7/autopilot/scopes/tai-exact-controller-sync-20260803.json"',
]) requireFragment(docker, fragment, paths.docker);
...
console.log('TAI exact controller sync contract PASS: owner-only exact-main full-stack authority, pinned REG.RU root transport, shared controller lock, prior digest attestation, atomic install, fsync, rollback and unchanged runner privilege.');
