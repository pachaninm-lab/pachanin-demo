...
SELECT
  ...
  (
    ...
    AND has_table_privilege('pc_invitation_acceptance_authority', 'auth.organization_invitations', 'UPDATE')
    ...
    AND has_table_privilege('pc_mfa_recovery_identity_authority', 'auth.credential_states', 'UPDATE')
