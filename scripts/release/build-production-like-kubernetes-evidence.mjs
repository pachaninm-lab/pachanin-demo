...
const actual = {
  ...
  outboxWorkerRuntimeErrors: measurement(read('cluster/outbox-worker-runtime-errors.txt')),
...
const report = {
  ...
  logs: [
    ...
    'kubernetes/postgresql-outbox-worker-policies-apply.log',
    'kubernetes/post-rls-runtime-grants.log',
    'kubernetes/cluster/canonical-rls-proof.txt',
    'kubernetes/cluster/outbox-worker-runtime-smoke.log',
  ...
  artifacts: [
    ...
    'kubernetes/cluster/outbox-worker-runtime-errors.txt',
  ],
  maturityBoundary:
