...
stages = [
    ...
    ('prod_dir="$(docker inspect --format', 'set_internal_deploy_stage TAI_DEPLOY_COMPOSE_FILE_DISCOVERY_FAILED\n'),
    ...
    ('authority_row="$(psql_admin -AtF', 'set_internal_deploy_stage TAI_DEPLOY_BOOTSTRAP_VERIFICATION_FAILED\n'),
    ('role_exists="$(psql_admin -Atc', 'set_internal_deploy_stage TAI_DEPLOY_RUNTIME_ROLE_BOUNDARY_FAILED\n'),
