...
describe('FGIS Grain SDIZ projection contract', () => {
  ...
  it('does not depend on host locale collation for canonical fingerprints', () => {
    ...
    let first: ReturnType<typeof normalizeFgisGrainSdizProjectionCommand> | null = null;
    let second: ReturnType<typeof normalizeFgisGrainSdizProjectionCommand> | null = null;
    try {
    ...
    if (!first || !second) throw new Error('canonical commands were not produced');
