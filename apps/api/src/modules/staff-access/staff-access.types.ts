...
export const StaffPermission = {
  ...
  REGISTRATION_REVIEW_READ: 'registration-review:read',
  REGISTRATION_REVIEW_DECIDE: 'registration-review:decide',
...
export const ROLE_PERMISSION_CEILING: Readonly<Record<StaffRole, readonly StaffPermission[]>> = {
  ...
  PLATFORM_ADMIN: [
    ...
    StaffPermission.REGISTRATION_REVIEW_READ,
    StaffPermission.REGISTRATION_REVIEW_DECIDE,
