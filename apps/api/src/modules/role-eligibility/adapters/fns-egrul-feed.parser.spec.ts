...
<EGRUL ДатаВыг="2026-09-05">
  ...
  it('rejects duplicate/unquoted/adjacent attributes and unsupported or XML-invalid entities', () => {
    ...
    const adjacent = '<EGRUL ДатаВыг="2026-09-05"><СвЮЛ ИНН="7707083893"ОГРН="1027700132195" ПолнНаимОПФ="X"/></EGRUL>';
    expect(() => parseFnsEgrulXml(adjacent, '4.08')).toThrow('FNS_EGRUL_XML_ATTRIBUTE_SYNTAX_INVALID');
  ...
  it('rejects transport declarations that contradict windows-1251 or XML declaration grammar', () => {
    const utf8 = '<?xml version="1.0" encoding="UTF-8"?><EGRUL ДатаВыг="2026-09-05"><СвЮЛ ИНН="7707083893" ОГРН="1027700132195" ПолнНаимОПФ="X"/></EGRUL>';
    expect(() => parseFnsEgrulXml(utf8, '4.08')).toThrow('FNS_EGRUL_XML_ENCODING_MISMATCH');

    const missingVersion = '<?xml encoding="windows-1251"?><EGRUL ДатаВыг="2026-09-05"><СвЮЛ ИНН="7707083893" ОГРН="1027700132195" ПолнНаимОПФ="X"/></EGRUL>';
    expect(() => parseFnsEgrulXml(missingVersion, '4.08')).toThrow('FNS_EGRUL_XML_DECLARATION_INVALID');

    const unknownAttribute = '<?xml version="1.0" encoding="windows-1251" extra="1"?><EGRUL ДатаВыг="2026-09-05"><СвЮЛ ИНН="7707083893" ОГРН="1027700132195" ПолнНаимОПФ="X"/></EGRUL>';
    expect(() => parseFnsEgrulXml(unknownAttribute, '4.08')).toThrow('FNS_EGRUL_XML_DECLARATION_INVALID');

    const invalidStandalone = '<?xml version="1.0" encoding="windows-1251" standalone="maybe"?><EGRUL ДатаВыг="2026-09-05"><СвЮЛ ИНН="7707083893" ОГРН="1027700132195" ПолнНаимОПФ="X"/></EGRUL>';
    expect(() => parseFnsEgrulXml(invalidStandalone, '4.08')).toThrow('FNS_EGRUL_XML_DECLARATION_INVALID');
  });
  ...
  it('normalizes visible status, exclusion decision and PII-free reliability facts with provenance', () => {
    const xml = `<EGRUL ДатаВыг="2026-09-05">
      <СвЮЛ ИНН="7707083893" ОГРН="1027700132195" ПолнНаимОПФ="ООО РОМАШКА">
        ...
        <СвАдресЮЛ>
          <СвНедАдресЮЛ ПризнНедАдресЮЛ="3">
            <ГРНДата ГРН="1234567890124" ДатаЗаписи="2026-07-01"/>
          </СвНедАдресЮЛ>
        </СвАдресЮЛ>
        <СвУпрОрг>
  ...
  it('makes reliability-only adverse EGRUL facts review-required', () => {
    const xml = `<EGRUL ДатаВыг="2026-09-05"><СвЮЛ ИНН="7707083893" ОГРН="1027700132195" ПолнНаимОПФ="ООО РОМАШКА"><СвАдресЮЛ><СвНедАдресЮЛ ПризнНедАдресЮЛ="2"><ГРНДата ДатаЗаписи="2026-07-01"/></СвНедАдресЮЛ></СвАдресЮЛ></СвЮЛ></EGRUL>`;
    const [record] = parseFnsEgrulXml(xml, '4.08').records;
  ...
  it('fails closed when address unreliability lacks required GRNДата provenance', () => {
    const xml = `<EGRUL ДатаВыг="2026-09-05"><СвЮЛ ИНН="7707083893" ОГРН="1027700132195" ПолнНаимОПФ="ООО РОМАШКА"><СвАдресЮЛ><СвНедАдресЮЛ ПризнНедАдресЮЛ="2"/></СвАдресЮЛ></СвЮЛ></EGRUL>`;
    expect(() => parseFnsEgrulXml(xml, '4.08')).toThrow('FNS_EGRUL_RELIABILITY_PROVENANCE_INVALID');
  });
  ...
  it('binds each exclusion decision to its own 105-110 status container', () => {
    const xml = `<EGRUL ДатаВыг="2026-09-05"><СвЮЛ ИНН="7707083893" ОГРН="1027700132195" ПолнНаимОПФ="ООО РОМАШКА"><СвСтатус><СвСтатус КодСтатусЮЛ="101" НаимСтатусЮЛ="НАХОДИТСЯ В СТАДИИ ЛИКВИДАЦИИ"/><СвРешИсклЮЛ ДатаРеш="2026-08-01" НомерРеш="42"/><ГРНДата ДатаЗаписи="2026-08-01"/></СвСтатус><СвСтатус><СвСтатус КодСтатусЮЛ="105" НаимСтатусЮЛ="ПРИНЯТО РЕШЕНИЕ О ПРЕДСТОЯЩЕМ ИСКЛЮЧЕНИИ"/><ГРНДата ДатаЗаписи="2026-08-02"/></СвСтатус></СвЮЛ></EGRUL>`;
    expect(() => parseFnsEgrulXml(xml, '4.08')).toThrow('FNS_EGRUL_EXCLUSION_DECISION_STATUS_MISMATCH');
  });
