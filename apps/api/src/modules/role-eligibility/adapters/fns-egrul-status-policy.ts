...
export const FNS_EGRUL_STATUS_POLICY_VERSION = 'fns-egrul-status-phase-a-v1' as const;
...
export type FnsEgrulStatusEnvelope = {
  ...
  statusPolicyVersion: typeof FNS_EGRUL_STATUS_POLICY_VERSION;
...
export function interpretFnsEgrulStatus(input: FnsEgrulStatusPolicyInput): FnsEgrulStatusEnvelope {
  ...
  return {
    ...
    statusPolicyVersion: FNS_EGRUL_STATUS_POLICY_VERSION,
    classification,
    visibleStatuses,
    exclusionDecisions,
    termination,
