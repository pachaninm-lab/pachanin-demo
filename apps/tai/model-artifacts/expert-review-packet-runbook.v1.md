...
External evidence can be a signed review form, meeting protocol, ticket export or another immutable review artifact. Evidence bytes remain outside Git; only their SHA-256 and locator are accepted later.
