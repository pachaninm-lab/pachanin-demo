...
9. the first v3 run is a governed `BOOTSTRAP` after the source-catalog identity
   change; final acceptance requires a following exact-main run that restores
   the v3 artifact and reports `CONTIGUOUS` history.
