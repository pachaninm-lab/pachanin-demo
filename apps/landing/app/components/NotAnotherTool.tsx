const items = [
  ['Excel', 'не держит доказательства и ответственность по сделке'],
  ['WhatsApp', 'быстрый, пока не начался спор по весу, качеству или оплате'],
  ['Маркетплейс', 'помогает найти цену, но не ведёт исполнение до денег'],
  ['CRM', 'не видит рейс, приёмку, СДИЗ, ЭДО и основание удержания'],
];
    ...
    <section className="relative z-10 py-24">
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-14 max-w-3xl">
          ...
          <p className="text-lg leading-relaxed text-[#8BA89E]">Проблема в том, что после цены нет единого места, где связаны партия, рейс, приёмка, документы, деньги и спор.</p>
        </div>
        ...
        <div className="mt-6 rounded-3xl border border-[rgba(126,242,196,0.12)] bg-[rgba(126,242,196,0.045)] p-6 text-lg font-semibold leading-relaxed text-[#C9D8D2]">
          «Прозрачная Цена» нужна там, где цена уже согласована, но деньги ещё под риском.
        </div>
      </div>
    </section>
  );
