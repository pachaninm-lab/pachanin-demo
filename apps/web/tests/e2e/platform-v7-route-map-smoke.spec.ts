...
const ROUTE_MAP = [
  ...
  { route: '/platform-v7/seller/batches', label: 'seller-batches' },
  { route: '/platform-v7/seller/batches/new', label: 'seller-batch-new' },
  { route: '/platform-v7/seller/lots', label: 'seller-lots' },
  { route: '/platform-v7/buyer', label: 'buyer' },
  { route: '/platform-v7/buyer/rfq', label: 'buyer-rfq' },
  { route: '/platform-v7/buyer/rfq/new', label: 'buyer-rfq-new' },
  { route: '/platform-v7/lots', label: 'lots' },
  { route: '/platform-v7/proposals', label: 'proposals' },
  { route: '/platform-v7/deals', label: 'deals' },
  { route: '/platform-v7/money', label: 'money' },
  { route: '/platform-v7/documents', label: 'documents' },
  ...
  { route: '/platform-v7/compliance', label: 'compliance' },
  { route: '/platform-v7/arbitrator', label: 'arbitrator' },
  { route: '/platform-v7/operator', label: 'operator' },
  { route: '/platform-v7/investor', label: 'investor' },
  { route: '/platform-v7/executive', label: 'executive' },
  ...
  { route: '/platform-v7/connectors', label: 'connectors' },
