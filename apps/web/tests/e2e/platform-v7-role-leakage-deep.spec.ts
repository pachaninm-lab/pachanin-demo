...
const ROLE_CASES = [
  {
    ...
    visibleText: ['Рейс водителя', 'Полевой режим · только рейс'],
  },
  {
  ...
  },
  {
    ...
    visibleText: ['Банк · резерв → основание → подтверждение статуса', 'Проверить основание, удержание и причину остановки'],
  },
  {
