...
const AUTHORITY_AHASH: Record<string,{hash:string;maxDistance:number}> = {
  '01-home-desktop': { hash:'fffffffbffe74e8dff0000007fffffff73777777ffff833fffff7fffb7fff77f', maxDistance:90 },
...
test.describe('capabilities exact public route boundary', () => {
  const headings = {
    ru: 'Что платформа связывает в одной Сделке',
    en: 'What the platform connects in one Deal',
    zh: '平台如何连接整笔交易',
  } as const;
