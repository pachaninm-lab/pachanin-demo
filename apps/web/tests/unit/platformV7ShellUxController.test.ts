...
// Canonical shell contract = registry-sourced navigation (see platformV7ShellUxRegistry).
// The former hardcoded per-role dock map was removed as dead code; these cases assert
// the behaviours that survive that decision: home routes, logout, logo target, legacy-nav
// hiding / overflow protection, and role-scoped notices.
