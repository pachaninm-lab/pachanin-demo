...
describe('platform-v7 workspace mode CSS', () => {
  ...
  it('is imported after visual hardening layers', () => {
    ...
    expect(accessibilityCss).toContain("@import '../styles/platform-v7-workspace-mode.css';");
    expect(accessibilityCss.indexOf('platform-v7-mobile-notification-safe.css')).toBeLessThan(
      accessibilityCss.indexOf('platform-v7-workspace-mode.css'),
    );
  });
