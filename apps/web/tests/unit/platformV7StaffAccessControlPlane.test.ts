...
const proxy = read('apps/web/lib/server/staff/staff-api-channel-proxy.ts');
const page = read('apps/web/app/platform-v7/staff/page.tsx');
const client = read('apps/web/components/platform-v7/staff/StaffControlCenterClient.tsx');
const viewAs = read('apps/web/components/platform-v7/staff/StaffViewAsClient.tsx');
const messages = read('apps/web/i18n/staff-messages.ts');
const css = read('apps/web/styles/platform-v7-staff.css');
