...
const BASE: Deal360Scenario = {
  ...
  nextAction: 'закрыть СДИЗ, ЭТрН, ГИС ЭПД, УПД, акт приёмки, акт расхождения и протокол качества перед банковским основанием',
  cockpit: {
    currentStage: 'Документы — неполный пакет',
    nextActor: 'продавец (СДИЗ) · покупатель (УПД) · грузополучатель (ЭТрН)',
    moneyStatus: { label: 'резерв ожидает подтверждения · банковское основание 0 ₽', state: 'stop' },
    docStatus: { label: '5 из 9 документов блокируют банковское основание', state: 'stop' },
    tripStatus: { label: 'TRIP-2403-001 · в пути · 62%', state: 'ok' },
    ...
    cannotHappenReason: 'банковское основание не готовится: СДИЗ не подтверждён · ЭТрН не закрыта · УПД ждёт подписи · акт приёмки готовится · протокол качества ожидается',
  },
  chain: [
    ...
    { title: 'Водитель', value: 'TRIP-2403-001 · 62% пути', state: 'ok' },
    { title: 'Приёмка', value: 'ожидает финального веса', state: 'wait' },
    { title: 'Документы', value: 'неполный пакет', state: 'stop' },
    { title: 'Банк', value: 'основание не готово', state: 'stop' },
  ],
  money: [
    { title: 'Сумма сделки', value: '9,65 млн ₽', note: 'расчёт по принятой ставке', state: 'ok' },
    { title: 'Резерв покупателя', value: 'ожидает подтверждения', note: 'банковский контур · безопасная сделка', state: 'wait' },
    { title: 'Банковское основание сейчас', value: '0 ₽', note: 'есть документные и приёмочные условия', state: 'stop' },
    { title: 'Потенциальное основание', value: 'до 9,65 млн ₽', note: 'после закрытия всех условий сделки', state: 'manual' },
  ],
  providerGates: [
    { provider: 'Сбер · Безопасные сделки', object: 'резерв и банковское событие', status: 'ждёт полного набора условий', impact: 'платформа не двигает деньги напрямую', state: 'wait' },
    ...
    { provider: 'ФГИС «Зерно»', object: 'СДИЗ по партии', status: 'СДИЗ ожидает подтверждения', impact: 'останавливает банковское основание', state: 'stop' },
    { provider: 'Контур.Диадок', object: 'договор, УПД, акт', status: 'УПД ждёт подписи покупателя', impact: 'останавливает банковское основание', state: 'stop' },
    { provider: 'СБИС / Saby ЭТрН', object: 'электронная транспортная накладная', status: 'ждёт подписи грузополучателя', impact: 'останавливает банковское основание', state: 'stop' },
    ...
    { provider: 'Лабораторный контур качества', object: 'протокол качества', status: 'протокол качества ожидается', impact: 'без качества банковское основание не готовится', state: 'stop' },
    { provider: 'GigaChat Enterprise', object: 'помощник оператора', status: 'объясняет причины остановки и готовит черновики', impact: 'не принимает решений и не двигает деньги', state: 'manual' },
  ],
  documents: [
...
const DL_9102: Deal360Scenario = {
  ...
  chain: [
    ...
    { title: 'Деньги', value: 'резерв отмечен · удержание 624 тыс. ₽', state: 'manual' },
    { title: 'Логистика', value: 'LOG-9102', state: 'ok' },
    { title: 'Водитель', value: 'ТМБ-14 · рейс завершён', state: 'ok' },
    { title: 'Приёмка', value: 'закрыта · отклонение веса в споре', state: 'wait' },
    { title: 'Документы', value: 'в порядке', state: 'ok' },
    { title: 'Банк', value: 'спорная часть удержана', state: 'stop' },
  ],
  ...
  cockpit: {
    ...
    cannotHappenReason: 'спорная сумма 624 тыс. ₽ не входит в банковское основание до решения DSP-9102-WEIGHT · арбитр должен вынести решение',
  },
  money: [
    ...
    { title: 'Банковское основание сейчас', value: '5,616 млн ₽', note: 'без спорной части, после внешнего банковского подтверждения', state: 'manual' },
