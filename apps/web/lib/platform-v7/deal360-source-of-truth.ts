...
const BASE: Deal360Scenario = {
  ...
  providerGates: [
    { provider: 'Сбер · Безопасные сделки', object: 'резерв и выплата', status: 'пилот — ждёт полного набора условий', impact: 'деньги продавцу не выпускаются', state: 'wait' },
  ...
  documents: [
    { title: 'Договор', source: 'Контур.Диадок', responsible: 'продавец + покупатель', status: 'подписан в пилотном контуре', blocksMoney: false },
