...
const BASE: Deal360Scenario = {
  ...
  providerGates: [
    ...
    { provider: 'ФГИС «Зерно»', object: 'СДИЗ по партии', status: 'СДИЗ ожидает подтверждения', impact: 'останавливает финальную выплату', state: 'stop' },
...
const DL_9102: Deal360Scenario = {
  ...
  chain: [
    ...
    { title: 'Выплата', value: 'спорная часть удержана', state: 'stop' },
  ],
