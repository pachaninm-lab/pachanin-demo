...
export const PLATFORM_V7_EXECUTION_SOURCE: {
  ...
  readiness: {
    fgis: { status: 'проверить', blocker: 'сверка партии ФГИС', note: 'Партия указана в сценарии; внешняя сверка ФГИС требует доступа и подтверждения' },
    ...
    dispute: { status: 'готово', blocker: '', note: 'Критичных споров в текущем сценарии нет' },
  ...
  audit: [
    ...
    { time: '10:05', actor: 'Система', action: 'Партия отправлена на сверку', note: 'ФГИС-68-2403-001 указан в сценарии; внешний статус ожидает подтверждения', status: 'проверить' },
