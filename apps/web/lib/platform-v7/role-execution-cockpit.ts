...
export const OPERATIONAL_ROLE_EXECUTION_COCKPITS = {
  logistics: {
    ...
    kpis: [
      { label: 'В пути', value: '1 рейс', note: 'TRIP-2403-001 · 62% маршрута', tone: 'info' },
    ...
    operations: [
      {
        ...
        status: 'в пути',
        statusTone: 'info',
        shortFact: 'TRIP-2403-001 · 62% маршрута · прибытие 14:28',
  ...
  driver: {
    ...
    kpis: [
      { label: 'Рейс', value: 'TRIP-2403-001', note: 'одна активная задача', tone: 'info' },
    ...
    operations: [
      {
        ...
        statusTone: 'success',
        shortFact: 'TRIP-2403-001 · маршрут до элеватора ВРЖ-08',
  ...
  elevator: {
    ...
    kpis: [
      { label: 'Рейс', value: 'TRIP-2403-001', note: 'прибыл на элеватор ВРЖ-08', tone: 'success' },
  ...
  lab: {
    ...
    kpis: [
      { label: 'Проба', value: 'отобрана', note: 'привязана к рейсу TRIP-2403-001', tone: 'success' },
    ...
    operations: [
      {
        ...
        status: 'ожидает',
        statusTone: 'warning',
        shortFact: 'Протокол по TRIP-2403-001 ещё не прикреплён',
