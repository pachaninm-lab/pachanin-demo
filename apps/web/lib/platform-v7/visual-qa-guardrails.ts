...
export const PLATFORM_V7_VISUAL_QA_ROUTES: readonly PlatformV7VisualQaRoute[] = [
  ...
  },
  {
    ...
    mustAnswer: ['тестовый контур', 'требуются доступы', 'нет заявления о промышленный интеграции', 'затронутые экраны', 'режим деградации'],
  },
  {
...
export { PLATFORM_V7_VISUAL_QA_BLOCKERS } from '@/lib/platform-v7/external-copy-guardrails';
