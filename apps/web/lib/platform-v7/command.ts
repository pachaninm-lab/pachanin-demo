...
export const PLATFORM_V7_COMMAND_SECTION_ITEMS: PlatformV7CommandSectionItem[] = [
  ...
  },
  {
    ...
    subtitle: 'Резервы, удержания, события банка, банковское подтверждение',
    href: PLATFORM_V7_BANK_ROUTE,
    keywords: 'банк деньги резерв удержание подтверждение события',
  },
  {
    id: 'sec-release-safety',
    group: 'Разделы',
    title: 'Проверка банковского основания',
    subtitle: 'Блокеры, удержания и кандидаты к банковскому подтверждению',
    href: PLATFORM_V7_RELEASE_SAFETY_ROUTE,
    keywords: 'проверка деньги подтверждение удержания блокеры банк',
  },
  {
    id: 'sec-data-room',
    group: 'Разделы',
