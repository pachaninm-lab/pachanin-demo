...
export const PLATFORM_V7_COMMAND_SECTION_ITEMS: PlatformV7CommandSectionItem[] = [
  ...
  {
    id: 'sec-deal-condition-checks',
    group: 'Разделы',
    title: 'Проверка условий сделки',
    subtitle: 'Отклонения, блокеры и следующий шаг по сделке',
    href: PLATFORM_V7_SIMULATOR_ROUTE,
    keywords: 'проверка условия сделка блокеры следующий шаг',
  },
  {
    id: 'sec-deal-flow',
    group: 'Разделы',
    ...
    href: PLATFORM_V7_DEAL_FLOW_ROUTE,
    keywords: 'путь сделки цепочка исполнение обзор',
  },
  {
    id: 'sec-reports',
    group: 'Разделы',
