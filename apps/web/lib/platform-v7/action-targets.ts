...
export const PLATFORM_V7_ACTION_TARGETS: PlatformV7ActionTarget[] = [
  ...
  { id: 'deal-request-release', surface: 'deal-detail', actionId: 'requestRelease', workspaceActionId: 'request-release', scope: 'deal', label: 'Запросить банковскую проверку', requiresFeedback: true },
  { id: 'deal-release-funds', surface: 'deal-detail', actionId: 'releaseFunds', workspaceActionId: 'release-funds', scope: 'bank', label: 'Передать основание банку', requiresFeedback: true },
  ...
  { id: 'ct-request-release', surface: 'control-tower', actionId: 'requestRelease', workspaceActionId: 'request-release', scope: 'deal', label: 'Запросить банковскую проверку', requiresFeedback: true },
  ...
  { id: 'bank-release-funds', surface: 'bank', actionId: 'releaseFunds', workspaceActionId: 'release-funds', scope: 'bank', label: 'Передать основание банку', requiresFeedback: true },
  { id: 'bank-request-release', surface: 'bank', actionId: 'requestRelease', workspaceActionId: 'request-release', scope: 'bank', label: 'Запросить банковскую проверку', requiresFeedback: true },
  ...
  { id: 'bank-webhook-retry', surface: 'bank-webhooks', actionId: 'retryWebhook', scope: 'bank', label: 'Повторить запрос банка', requiresFeedback: true },
  ...
  { id: 'e4-redeem-sdiz', surface: 'offer-to-deal', actionId: 'redeemSdiz', scope: 'deal', label: 'Погасить СДИЗ', requiresFeedback: true },
  { id: 'e4-refuse-sdiz-redemption', surface: 'offer-to-deal', actionId: 'refuseSdizRedemption', scope: 'deal', label: 'Зафиксировать отказ от погашения СДИЗ', requiresFeedback: true },
  { id: 'e4-send-sdiz-manual-review', surface: 'offer-to-deal', actionId: 'sendSdizManualReview', scope: 'deal', label: 'Отправить СДИЗ на ручную проверку', requiresFeedback: true },
];
