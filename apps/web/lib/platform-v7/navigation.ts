...
export const PLATFORM_V7_NAV_BY_ROLE: Record<PlatformRole, PlatformV7NavItem[]> = {
  operator: [
    { href: '/platform-v7/control-tower', label: PLATFORM_V7_LEXICON.nav.controlTower, icon: 'dashboard' }, { href: '/platform-v7/deals', label: PLATFORM_V7_LEXICON.nav.deals, icon: 'deals' }, { href: '/platform-v7/lots', label: PLATFORM_V7_LEXICON.nav.lots, icon: 'lots' }, { href: '/platform-v7/logistics', label: PLATFORM_V7_LEXICON.nav.logistics, icon: 'logistics' }, { href: '/platform-v7/executive', label: PLATFORM_V7_LEXICON.nav.analytics, icon: 'analytics' }, { href: '/platform-v7/connectors', label: PLATFORM_V7_LEXICON.nav.connectors, icon: 'integrations' }, { href: '/platform-v7/bank', label: PLATFORM_V7_LEXICON.nav.bank, icon: 'bank' }, { href: '/platform-v7/disputes', label: PLATFORM_V7_LEXICON.nav.disputes, icon: 'disputes' },
  ],
  buyer: [
    { href: '/platform-v7/buyer', label: PLATFORM_V7_LEXICON.nav.cabinet, icon: 'cabinet' }, { href: '/platform-v7/procurement', label: PLATFORM_V7_LEXICON.nav.procurement, icon: 'procurement' }, { href: '/platform-v7/deals', label: PLATFORM_V7_LEXICON.nav.deals, icon: 'deals' }, { href: '/platform-v7/bank', label: PLATFORM_V7_LEXICON.nav.money, icon: 'bank' },
  ],
  seller: [
    { href: '/platform-v7/seller', label: PLATFORM_V7_LEXICON.nav.cabinet, icon: 'cabinet' }, { href: '/platform-v7/lots', label: PLATFORM_V7_LEXICON.nav.lots, icon: 'lots' }, { href: '/platform-v7/lots/create', label: PLATFORM_V7_LEXICON.nav.createLot, icon: 'create' }, { href: '/platform-v7/deals', label: PLATFORM_V7_LEXICON.nav.deals, icon: 'deals' },
  ],
  logistics: [
    { href: '/platform-v7/logistics', label: 'Диспетчерская', icon: 'logistics' }, { href: '/platform-v7/driver', label: PLATFORM_V7_LEXICON.nav.driver, icon: 'cabinet' }, { href: '/platform-v7/elevator', label: PLATFORM_V7_LEXICON.nav.receiving, icon: 'receiving' }, { href: '/platform-v7/lab', label: PLATFORM_V7_LEXICON.nav.lab, icon: 'lab' },
  ],
  ...
  bank: [
    { href: '/platform-v7/bank', label: 'Банковый контур', icon: 'bank' }, { href: '/platform-v7/bank/factoring', label: PLATFORM_V7_LEXICON.nav.factoring, icon: 'bank' }, { href: '/platform-v7/bank/escrow', label: PLATFORM_V7_LEXICON.nav.escrow, icon: 'bank' }, { href: '/platform-v7/deals', label: PLATFORM_V7_LEXICON.nav.deals, icon: 'deals' }, { href: '/platform-v7/disputes', label: PLATFORM_V7_LEXICON.nav.holds, icon: 'disputes' },
  ],
  arbitrator: [{ href: '/platform-v7/arbitrator', label: 'Разбор', icon: 'analytics' }, { href: '/platform-v7/disputes', label: PLATFORM_V7_LEXICON.nav.disputes, icon: 'disputes' }],
  compliance: [{ href: '/platform-v7/compliance', label: 'Допуск', icon: 'cabinet' }, { href: '/platform-v7/deals', label: PLATFORM_V7_LEXICON.nav.deals, icon: 'deals' }],
