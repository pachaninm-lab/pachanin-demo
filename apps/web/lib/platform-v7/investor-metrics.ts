...
export const PLATFORM_V7_INVESTOR_METRICS: PlatformV7InvestorMetric[] = [
  {
    ...
    tone: 'growth',
    note: 'ГИПОТЕЗА сценария: месячный оборот по контуру исполнения.',
  },
  {
    id: 'activeCompanies',
    ...
    tone: 'growth',
    note: 'ГИПОТЕЗА сценария: продавцы, покупатели и сервисные роли.',
  },
  {
    id: 'disputeRate',
    ...
    tone: 'risk',
    note: 'ГИПОТЕЗА сценария: снижение спорности через evidence-first контур.',
  },
  {
    id: 'cycleDays',
    title: 'Цикл сделки',
    ...
    tone: 'growth',
    note: 'ГИПОТЕЗА сценария: лот → документы → приёмка → банковская проверка выплаты.',
  },
  {
    id: 'controlledPilots',
    title: 'Контуры исполнения',
    value: 3,
    unit: 'контуров',
    trend: [1, 1, 2, 2, 3, 3],
    tone: 'neutral',
    note: 'ГИПОТЕЗА сценария: банк, регион, якорные участники.',
  },
  {
    id: 'releaseAutomation',
    title: 'Автоматизация проверки выплаты',
    value: 64,
    unit: '%',
    trend: [22, 31, 39, 48, 57, 64],
    tone: 'growth',
    note: 'ГИПОТЕЗА сценария: доля сделок без ручного денежного стопа.',
  },
];
