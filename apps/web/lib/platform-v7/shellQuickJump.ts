...
export const PLATFORM_V7_QUICK_JUMP_ITEMS: PlatformV7QuickJumpItem[] = [
  { href: PLATFORM_V7_ROLES_ROUTE, label: 'Все роли', group: 'Навигация' },
  ...
  { href: PLATFORM_V7_EXECUTIVE_ROUTE, label: 'Сводка', group: 'Навигация' },
  ...
  { href: PLATFORM_V7_DRIVER_FIELD_ROUTE, label: 'Переключить роль: Водитель', group: 'Роли', action: 'role:driver' },
  { href: PLATFORM_V7_ARBITRATOR_ROUTE, label: 'Переключить роль: Арбитр', group: 'Роли', action: 'role:arbitrator' },
