...
export const PLATFORM_V7_INVESTOR_STORY: PlatformV7InvestorStoryBlock[] = [
  {
    id: 'execution-rail',
    title: 'Не доска объявлений, а контур исполнения сделки',
  ...
  },
  {
    ...
    body: 'Логика контура строится вокруг резерва, удержания и банковской проверки выплаты: выплата возможна только после закрытия проверяемых условий.',
    metricIds: ['releaseAutomation', 'disputeRate'],
  },
  {
    id: 'execution-contour',
    title: 'Контур исполнения без завышения зрелости',
    body: 'Investor-mode показывает контур исполнения: сильная предынтеграционная сборка, но без заявления боевой готовности до подтверждённых подключений.',
