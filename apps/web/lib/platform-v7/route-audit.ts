...
export const PLATFORM_V7_FAST_PASS_ROUTE_AUDIT: readonly PlatformV7RouteAuditItem[] = [
  ...
  { route: '/platform-v7/driver', surface: 'role', owner: 'driver', status: 'current-smoke', p0Smoke: true, notes: 'Current driver route kept for compatibility until field shell redirect lands.' },
  { route: '/platform-v7/driver/field', surface: 'role', owner: 'driver', status: 'known-gap', p0Smoke: false, notes: 'Target field-shell route for PR-5; not part of P0 smoke until implemented.' },
