...
export const PLATFORM_V7_ROLE_NAVIGATION: Record<PlatformRole, PlatformV7RoleNavigationEntry> = {
  ...
  elevator: {
    ...
    allowedPrefixes: [PLATFORM_V7_ELEVATOR_ROUTE, DEAL_ACCEPTANCE_ROUTE],
  },
  lab: {
    ...
    allowedPrefixes: [PLATFORM_V7_LAB_ROUTE, DEAL_ACCEPTANCE_ROUTE],
  },
  bank: {
    home: PLATFORM_V7_BANK_ROUTE,
    bottom: [
      { href: PLATFORM_V7_BANK_ROUTE, label: 'Основание' },
      { href: PLATFORM_V7_BANK_PAYMENT_BASIS_ROUTE, label: 'Основания' },
      { href: PLATFORM_V7_BANK_FACTORING_ROUTE, label: 'Кредит' },
      { href: PLATFORM_V7_BANK_ESCROW_ROUTE, label: 'Счёт' },
      { href: PLATFORM_V7_BANK_EVENTS_ROUTE, label: 'События' },
    ],
    drawer: [],
    command: [
  ...
  arbitrator: {
    ...
    allowedPrefixes: [PLATFORM_V7_ARBITRATOR_ROUTE, DEAL_ACCEPTANCE_ROUTE, PLATFORM_V7_DISPUTES_ROUTE],
  },
  compliance: {
