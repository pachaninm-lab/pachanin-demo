...
const ACCOUNTING_ROUTE = '/platform-v7/accounting';
...
export const PLATFORM_V7_ROLE_NAVIGATION: Record<PlatformRole, PlatformV7RoleNavigationEntry> = {
  ...
  buyer: {
    ...
    allowedPrefixes: [PLATFORM_V7_BUYER_ROUTE, AUCTION_ROUTE, PLATFORM_V7_PROCUREMENT_ROUTE, PLATFORM_V7_PROPOSALS_ROUTE, PLATFORM_V7_DOCUMENTS_ROUTE, DEAL_DOCUMENTS_BASIS_ROUTE, PLATFORM_V7_MONEY_ROUTE, PLATFORM_V7_BANK_PAYMENT_BASIS_ROUTE, PLATFORM_V7_DEALS_ROUTE, DEAL_ACCEPTANCE_ROUTE, PLATFORM_V7_DISPUTES_ROUTE, ACCOUNTING_ROUTE],
  },
  seller: {
    ...
    allowedPrefixes: [PLATFORM_V7_SELLER_ROUTE, FGIS_ACCESS_ROUTE, AUCTION_ROUTE, PLATFORM_V7_SELLER_LOTS_ROUTE, PLATFORM_V7_SELLER_BATCHES_ROUTE, PLATFORM_V7_DOCUMENTS_ROUTE, DEAL_DOCUMENTS_BASIS_ROUTE, PLATFORM_V7_MONEY_ROUTE, PLATFORM_V7_BANK_PAYMENT_BASIS_ROUTE, PLATFORM_V7_DEALS_ROUTE, DEAL_LOGISTICS_ROUTE, ACCOUNTING_ROUTE],
  },
  logistics: {
