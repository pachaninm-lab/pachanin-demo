...
export const PLATFORM_V7_ROLE_NAVIGATION: Record<PlatformRole, PlatformV7RoleNavigationEntry> = {
  operator: {
    ...
    command: [
      ...
      { href: PLATFORM_V7_ADMIN_ROUTE, label: 'Админ' },
    ],
    allowedPrefixes: [PLATFORM_V7_CONTROL_TOWER_ROUTE, PLATFORM_V7_OPERATOR_ROUTE, PLATFORM_V7_DEALS_ROUTE, PLATFORM_V7_OPERATOR_QUEUES_ROUTE, PLATFORM_V7_COMPLIANCE_ROUTE, PLATFORM_V7_BANK_CLEAN_ROUTE, PLATFORM_V7_BANK_EVENTS_ROUTE, PLATFORM_V7_TRUST_ROUTE, PLATFORM_V7_REPORTS_ROUTE, PLATFORM_V7_ADMIN_ROUTE],
  },
  buyer: {
  ...
  executive: {
    ...
    allowedPrefixes: [PLATFORM_V7_EXECUTIVE_ROUTE, PLATFORM_V7_MONEY_ROUTE, PLATFORM_V7_REPORTS_ROUTE, PLATFORM_V7_DEMO_EXECUTION_FLOW_ROUTE, PLATFORM_V7_SIMULATOR_ROUTE, PLATFORM_V7_BANK_CLEAN_ROUTE, PLATFORM_V7_ADMIN_ROUTE],
  },
};
