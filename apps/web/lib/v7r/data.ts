...
const RAW_DEALS: Deal[] = [
  ...
  { id: 'DL-9106', grain: 'Пшеница 4 класс', quantity: 600, unit: 'т', seller: { name: 'ГК АгроСтарт' }, buyer: { name: 'Экспортёр Юг' }, status: 'payment_reserved', reservedAmount: 9648000, pricePerTon: 16080, totalAmount: 9648000, holdAmount: 0, riskScore: 18, slaDeadline: '2026-04-30', blockers: [], lotId: 'LOT-2403', routeId: 'ВРЖ-08', routeState: 'Ожидание погрузки', routeEta: '16:10' },
