...
export const DEALS: Deal[] = [
  ...
  { id: 'DL-9106', grain: 'Пшеница 4 класс', quantity: 600, unit: 'т', seller: { name: 'КФХ «Северное поле»' }, buyer: { name: 'Покупатель 1' }, status: 'payment_reserved', reservedAmount: 9648000, holdAmount: 0, riskScore: 18, slaDeadline: '2026-04-30', blockers: ['reserve', 'sdiz', 'transport_pack'], pricePerTon: 16080, totalAmount: 9648000, releaseAmount: 0, lotId: 'LOT-2403', routeId: 'TRIP-SIM-001', routeState: 'Ожидает погрузки · Элеватор ВРЖ-08', routeEta: '7–14 дней' },
