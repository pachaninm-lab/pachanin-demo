...
export const lots: LotItem[] = [
  ...
  {
    id: 'LOT-2404',
    title: 'Подсолнечник / Воронеж',
    grain: 'Подсолнечник',
    volumeTons: 420,
    sourceType: 'FGIS',
    sourceReference: 'FGIS-PARTY-88245',
    readiness: { state: 'PASS', blockers: [], nextStep: 'Готов к торгам, gate чистый.', nextOwner: 'Покупатель' },
  },
  {
    id: 'LOT-2405',
    title: 'Пшеница 3 кл. / Курск',
    grain: 'Пшеница 3 кл.',
    volumeTons: 560,
    sourceType: 'FGIS',
    sourceReference: 'FGIS-PARTY-88308',
    readiness: { state: 'PASS', blockers: [], nextStep: 'Лот закреплён за экспортной заявкой.', nextOwner: 'Покупатель' },
  },
  {
    id: 'LOT-2406',
    title: 'Кукуруза 3 кл. / Липецк',
    grain: 'Кукуруза 3 кл.',
    volumeTons: 220,
    sourceType: 'FGIS',
    sourceReference: 'FGIS-PARTY-88412',
    readiness: { state: 'REVIEW', blockers: [sharedDocsBlocker], nextStep: 'Догрузить ветеринарный сертификат.', nextOwner: 'Продавец' },
  },
  {
    id: 'LOT-2407',
    title: 'Ячмень 2 кл. / Орёл',
    grain: 'Ячмень 2 кл.',
    volumeTons: 130,
    sourceType: 'MANUAL',
    sourceReference: null,
    readiness: { state: 'REVIEW', blockers: [sharedDocsBlocker], nextStep: 'Подгрузить протокол лаборатории и подписать акт.', nextOwner: 'Продавец' },
  },
  {
    id: 'LOT-2408',
    title: 'Пшеница 4 кл. / Белгород',
    grain: 'Пшеница 4 кл.',
    volumeTons: 700,
    sourceType: 'FGIS',
    sourceReference: 'FGIS-PARTY-88501',
    readiness: { state: 'PASS', blockers: [], nextStep: 'Размещён под крупного экспортёра.', nextOwner: 'Покупатель' },
  },
  {
    id: 'LOT-2409',
    title: 'Рапс / Тамбов',
    ...
    sourceType: 'MANUAL',
    sourceReference: null,
    readiness: { state: 'PASS', blockers: [], nextStep: 'Готов к продаже маслопрессу.', nextOwner: 'Покупатель' },
  },
  {
    id: 'LOT-2410',
    title: 'Соя / Ростов',
    ...
    readiness: { state: 'FAIL', blockers: [sharedFgisBlocker], nextStep: 'ФГИС-объект ждёт перепроверки региональным куратором.', nextOwner: 'Оператор' },
  },
  {
    id: 'LOT-2411',
    title: 'Овёс / Брянск',
    ...
    sourceType: 'MANUAL',
    sourceReference: null,
    readiness: { state: 'PASS', blockers: [], nextStep: 'Можно вывесить на витрину.', nextOwner: 'Покупатель' },
  },
  {
    id: 'LOT-2412',
    title: 'Гречиха / Алтай',
    ...
    volumeTons: 75,
    sourceType: 'FGIS',
    sourceReference: 'FGIS-PARTY-88712',
    readiness: { state: 'REVIEW', blockers: [sharedDocsBlocker], nextStep: 'Сверить пробу и подписать протокол.', nextOwner: 'Лаборатория' },
  },
  {
    id: 'LOT-2413',
    title: 'Подсолнечный жмых / Краснодар',
    grain: 'Подсолнечный жмых',
    volumeTons: 320,
    sourceType: 'FGIS',
    sourceReference: 'FGIS-PARTY-88810',
    readiness: { state: 'PASS', blockers: [], nextStep: 'Покупатель выбран, ждём подписания.', nextOwner: 'Покупатель' },
  },
  {
    id: 'LOT-2414',
    title: 'Кукуруза 1 кл. / Ставрополь',
    grain: 'Кукуруза 1 кл.',
    volumeTons: 480,
    sourceType: 'FGIS',
    sourceReference: 'FGIS-PARTY-88905',
    readiness: { state: 'REVIEW', blockers: [sharedEsiaBlocker], nextStep: 'Закрепить ESIA-связку продавца.', nextOwner: 'Комплаенс' },
  },
  {
    id: 'LOT-2415',
    title: 'Пшеница 5 кл. / Саратов',
    grain: 'Пшеница 5 кл.',
    volumeTons: 350,
    sourceType: 'MANUAL',
    sourceReference: null,
    readiness: { state: 'PASS', blockers: [], nextStep: 'Готов к продаже на корм.', nextOwner: 'Покупатель' },
  },
  {
    id: 'LOT-2416',
    title: 'Сорго / Волгоград',
    grain: 'Сорго',
    volumeTons: 60,
    sourceType: 'MANUAL',
    sourceReference: null,
    readiness: { state: 'REVIEW', blockers: [sharedDocsBlocker], nextStep: 'Уточнить базис поставки и условия оплаты.', nextOwner: 'Продавец' },
  },
];
