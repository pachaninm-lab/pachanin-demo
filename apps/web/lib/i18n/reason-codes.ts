export const REASON_CODES_RU: Record<string, { title: string; description: string }> = {
  ...
  BANK_REVIEW_PENDING:       { title: 'Банк проверяет основание',             description: 'Сделка на ручной проверке банка перед внешним банковским подтверждением.' },
  DISPUTE_OPEN:              { title: 'Открыт спор',                          description: 'По сделке открыт спор — банковский шаг заблокирован.' },
  SYNC_CONFIRM_REQUIRED:     { title: 'Требуется финальная сверка',           description: 'Нужно подтвердить синхронизацию данных перед банковским шагом.' },
