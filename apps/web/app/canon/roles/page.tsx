...
const roles = [
  ['Фермер / Продавец', 'Продажа зерна и масличных', '/canon/market'],
  ['Покупатель', 'Закупка, исполнение, приёмка', '/canon/deals'],
  ['Бухгалтерия', 'Платежи, ЭДО и сверки', '/canon/finance'],
  ['Логистика / Операции', 'Рейсы, слоты, handoff', '/canon/operations'],
  ['Лаборатория', 'Качество и price impact', '/canon/quality'],
  ['Оператор / Контроль', 'Очереди риска и блокеры', '/canon/control'],
];
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#050914', color: '#f8fafc', fontFamily: '-apple-system,BlinkMacSystemFont,Segoe UI,sans-serif', padding: '24px 16px 48px' }}>
      <div style={{ maxWidth: 620, margin: '0 auto' }}>
        ...
        <p style={{ margin: '14px 0 24px', color: '#94a3b8', fontSize: 16, lineHeight: 1.5 }}>Каждая роль получает свой кабинет, KPI, очередь задач и следующий рабочий шаг.</p>
