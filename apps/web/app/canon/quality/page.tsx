      ...
      <div style={{ maxWidth: 620, margin: '0 auto', padding: '18px 16px 0' }}>
        <section style={{ background: '#0b1220', border: '1px solid rgba(255,255,255,.08)', borderRadius: 28, padding: 18 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', gap: 12, alignItems: 'flex-start' }}>
            ...
            <div style={{ background: 'rgba(251,191,36,.14)', color: '#fbbf24', borderRadius: 16, padding: '10px 14px', fontWeight: 800 }}>Незначительные отклонения</div>
          </div>
          <div style={{ display: 'grid', gap: 10, marginTop: 18 }}>
            {rows.map(([name, base, fact, delta]) => (
              <div key={name} style={{ display: 'grid', gridTemplateColumns: '1.5fr .8fr .8fr .8fr', gap: 10, padding: '12px 0', borderTop: '1px solid rgba(255,255,255,.05)' }}>
