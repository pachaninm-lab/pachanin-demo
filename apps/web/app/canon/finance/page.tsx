...
const queue = [
  ['Кукуруза · #deal-1', '37 337 000 ₽', 'Не готово'],
  ['Ячмень фуражный · #deal-2', '16 283 000 ₽', 'Не готово'],
  ['Ячмень фуражный · #deal-3', '5 368 000 ₽', 'Заблокировано'],
];
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#060b16', color: '#f8fafc', fontFamily: '-apple-system,BlinkMacSystemFont,Segoe UI,sans-serif', paddingBottom: 40 }}>
      ...
      <div style={{ maxWidth: 620, margin: '0 auto', padding: '18px 16px 0' }}>
        <div style={{ fontSize: 28, fontWeight: 800 }}>Финансовый кабинет</div>
        <div style={{ color: '#94a3b8', margin: '6px 0 18px' }}>Платежи, сверки, hold/release и документы</div>
