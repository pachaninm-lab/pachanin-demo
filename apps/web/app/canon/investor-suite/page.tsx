...
const pages = [
  ['Investor Control Room', '/canon/investor-control-room', 'Главный investor-хаб'],
  ['Investor Walkthrough', '/canon/investor-walkthrough', 'Готовый маршрут показа'],
  ['Deal Mission Control', '/canon/deal-mission-control', 'Сильный экран одной сделки'],
  ['Investor Finance', '/canon/investor-finance', 'Контур денег и переходов'],
  ['Investor Risk', '/canon/investor-risk', 'Очередь рисков и эскалаций'],
  ['Investor Docs', '/canon/investor-docs', 'Документный контур сделки'],
  ['Investor Quality', '/canon/investor-quality', 'Качество, отклонения, влияние на цену'],
  ['Ops Live Rail', '/canon/ops-live', 'Логистика, ETA, handoff'],
] as const;
  ...
  return (
    <main style={{ minHeight: '100vh', background: 'radial-gradient(circle at top, rgba(30,64,175,.18) 0%, rgba(5,9,20,1) 28%, rgba(4,7,15,1) 100%)', color: '#f8fafc', fontFamily: '-apple-system,BlinkMacSystemFont,Segoe UI,sans-serif', padding: '24px 16px 56px' }}>
      <div style={{ maxWidth: 1180, margin: '0 auto' }}>
        <div style={{ color: '#22c55e', fontWeight: 800, fontSize: 15, marginBottom: 16 }}>Прозрачная Цена · Investor Suite</div>
        <h1 style={{ margin: 0, fontSize: 54, lineHeight: 1.02, fontWeight: 900, letterSpacing: '-0.03em' }}>Investor suite</h1>
        <p style={{ margin: '16px 0 24px', color: '#94a3b8', fontSize: 18, lineHeight: 1.6, maxWidth: 940 }}>Единый набор самых сильных экранов для показа инвестору: контур сделки, денег, рисков, документов, качества и логистики.</p>
