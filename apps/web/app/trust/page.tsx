  ...
  ru: {
    ...
    domains: [
      ...
      },
      {
        ...
        text: 'Гекта — аграрный интеллект для анализа, а не самостоятельный владелец решения.',
        points: [
  ...
  en: {
    ...
    domains: [
      ...
      },
      {
        ...
        text: 'Gekta is an agricultural intelligence layer for analysis, not an independent decision owner.',
        points: [
  ...
  zh: {
    ...
    domains: [
      ...
      },
      {
        id: 'ai',
        title: 'Gekta 使用边界',
        text: 'Gekta 是用于分析的农业智能层，而不是独立决策主体。',
        points: [
          'Gekta 对照条件、事件、文件与来源。',
