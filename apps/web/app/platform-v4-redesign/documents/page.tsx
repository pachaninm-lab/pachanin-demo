...
export default function Page(){
  const rows=['Комплект собран на 92%','1 документ блокирует release','На подписи акт приемки','Есть связь с банком'];
  return <div style={{minHeight:'100vh',background:'#f8fafc',padding:24,color:'#0f172a'}}><div style={{maxWidth:1200,margin:'0 auto',display:'grid',gap:16}}>
    ...
    <section style={{background:'#fff',border:'1px solid #e2e8f0',borderRadius:16,padding:24}}><div style={{fontSize:12,fontWeight:800,letterSpacing:'.08em',color:'#2563eb'}}>DOCUMENTS</div><h1 style={{margin:'10px 0 0',fontSize:'clamp(2rem,4vw,2.75rem)',lineHeight:1.1}}>Документы — это gate, а не просто список файлов</h1><p style={{margin:'12px 0 0',maxWidth:760,color:'#334155',lineHeight:1.6}}>Экран фокусируется на полноте комплекта, критичных документах и их прямом влиянии на release.</p></section>
