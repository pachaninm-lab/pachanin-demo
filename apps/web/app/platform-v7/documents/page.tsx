import '@/styles/platform-v7-documents.css';
...
const documentSummary = [
  ...
  { label: 'Что блокирует', value: 'СДИЗ, ЭТрН, УПД, акт, качество', note: 'Без полного пакета банковская проверка выплаты продавцу закрыт.' },
...
const requiredDocuments = [
  { title: 'СДИЗ', source: 'ФГИС «Зерно»', responsible: 'продавец + оператор', status: 'не оформлен', impact: 'останавливает финальный банковская проверка выплаты' },
