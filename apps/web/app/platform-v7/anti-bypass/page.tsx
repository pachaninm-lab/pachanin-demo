import '@/styles/platform-v7-anti-bypass.css';
...
const rules = [
  ...
  ['Банк и оператор', 'Банк, оператор и проверочный контур видят полные данные сторон для комплаенса и проверки основания расчёта.', 'готово'],
...
const visibility = [
  ...
  ['Банк', 'полные данные, деньги, комплаенс, проверка основания', 'полный доступ'],
];
