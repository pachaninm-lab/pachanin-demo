...
const card = { textDecoration: 'none', color: 'inherit', background: 'linear-gradient(180deg,#FFFFFF 0%,#F8FAFC 100%)', border: '1px solid var(--pc-border, #E4E6EA)', borderRadius: 20, padding: 16, display: 'grid', gap: 7 } as const;
const title = { color: 'var(--pc-text-primary, #0F1419)', fontSize: 19, lineHeight: 1.2, fontWeight: 950 } as const;
