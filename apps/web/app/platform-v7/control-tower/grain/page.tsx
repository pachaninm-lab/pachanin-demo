...
const routes = [
  ...
  },
  {
    ...
    detail: 'Допуск отгрузки, приёмки и release-основания через документальный контур.',
    href: '/platform-v7/deals/grain-sdiz',
  },
  {
    step: '06',
    title: 'Деньги',
    detail: 'Резерв, удержание, банковское основание и причина остановки.',
  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .grain-control-title{margin:0;color:var(--pc-text-primary, #0F1419);font-size:18px;line-height:1.2;font-weight:900}
        .grain-control-detail{margin:0;color:var(--pc-text-muted, #6B778C);font-size:13px;line-height:1.5}
        .grain-control-note{display:grid;gap:8px;padding:16px;border:1px solid var(--pc-border, #E4E6EA);border-radius:18px;background:#F8FAFB;color:var(--pc-text-secondary, #334155);font-size:13px;line-height:1.55}
        @media(max-width:767px){
          [data-testid='platform-v7-control-tower-grain-page']{gap:10px!important}
          .grain-control-grid{grid-template-columns:1fr!important;gap:8px!important}
          .grain-control-card{min-height:auto!important;padding:12px!important;border-radius:16px!important;gap:7px!important}
          .grain-control-card:nth-child(n+6){display:none!important}
          .grain-control-step{font-size:10px!important;padding:3px 7px!important}
          .grain-control-title{font-size:16px!important;line-height:1.12!important}
          .grain-control-detail{font-size:12px!important;line-height:1.35!important}
      ...
      <P7Page
        ...
        subtitle='Операторская точка входа в цепочку: партия, закупочный запрос, качество, вес, СДИЗ, документы, деньги и путь сделки.'
        testId='platform-v7-control-tower-grain-page'
      >
        <P7Section
          title='Рабочие зоны'
          subtitle='Каждая карточка ведёт в конкретную часть исполнения сделки.'
        >
        ...
        <P7Section
          ...
          subtitle='Экран нужен для быстрой проверки, где сейчас сделка и почему деньги не должны переходить в release-основание раньше фактического закрытия условий.'
        >
          <section className='grain-control-note'>
            <div><strong>Главный объект:</strong> сделка, а не витрина лотов.</div>
            <div><strong>Деньги:</strong> release-основание формируется только после проверки качества, веса, документов, СДИЗ и причин удержания.</div>
            <div><strong>Ручные действия:</strong> допустимы только с причиной, ответственным и следом в журнале.</div>
            <div><strong>Интеграции:</strong> внешние контуры временно не подключены; статус показывается только как ручная проверка или ожидание внешнего подтверждения.</div>
          </section>
        </P7Section>
      </P7Page>
    </>
