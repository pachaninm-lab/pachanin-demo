const steps = [
  ...
  },
  {
    ...
    note: 'Данные для расчётов, удержаний и банковского подтверждения.',
  },
  {
    title: '4. Документы',
  ...
  },
  {
    ...
    note: 'Финансовый контур и правила подтверждения основания.',
  },
  {
    title: '6. Первый лот',
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', gap: 12, alignItems: 'flex-start', flexWrap: 'wrap' }}>
          <div>
            ...
            <div style={{ fontSize: 13, color: '#6B778C', lineHeight: 1.7, marginTop: 8, maxWidth: 860 }}>
              Пошаговый вход в платформу: компания, роль, реквизиты, документы, банковый контур и первый лот. Контур показывает целевую механику проверочного подключения.
            </div>
          </div>
