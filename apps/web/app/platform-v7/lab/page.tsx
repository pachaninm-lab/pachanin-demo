  ...
  const primary = (
    <div className={workspace.stack}>
      <NextActionPanel
        ...
        title='Финализировать протокол качества'
        description='Сорная примесь 2,4% превышает допуск 2%. Нужно зафиксировать показатели и выдать протокол с допуском либо отказом.'
        blocker='протокол качества не закрыт'
        moneyImpact={impactLabel}
        action={<a className={workspace.primaryLink} href='#quality-protocol'>Открыть протокол</a>}
        secondaryAction={<a className={workspace.secondaryLink} href='#quality-evidence'>Проверить доказательства</a>}
      />
