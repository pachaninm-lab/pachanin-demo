...
const stages = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Проверка банковского основания', href: '/platform-v7/bank/release-safety' },
    ],
  },
  {
    title: '5. Исполнение',
...
const principles = [
  ...
  'Банковское основание нельзя передавать без документов, логистики, банка и отсутствия открытого спора.',
