...
const BLOCKS = [
  ...
  },
  {
    ...
    body: 'На текущей стадии часть контуров уже проверяется близко к реальному режиму, а часть ещё работает как тестовый контур с сопровождением. Это не заявление о полном промышленном контуре.',
  },
];
