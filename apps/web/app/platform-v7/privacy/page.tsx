...
export const metadata: Metadata = {
  ...
  description:
    'Рабочая версия политики конфиденциальности для контура контролируемого пилота / преинтеграции по исполнению зерновой сделки.',
  alternates: {
...
const BLOCKS = [
  {
    ...
    body: 'В рабочем контуре сделки могут использоваться данные о компаниях, ролях, документах, маршрутах, статусах денег и событиях исполнения. В проверочном режиме часть данных хранится локально в браузере.',
  },
  {
    title: 'Для чего используются данные',
    body: 'Данные нужны не ради аналитики как таковой, а для исполнения сделки: показать следующий шаг, понять причину остановки, собрать документы, подтвердить маршрут и не выпустить деньги раньше времени.',
  },
  {
  ...
  },
  {
    ...
    body: 'На текущей стадии часть контуров уже проверяется близко к реальному режиму, а часть ещё работает как предынтеграционный контур с сопровождением. Это не заявление о полном промышленном контуре.',
  },
];
...
const DATA_MODULES = [
  {
    ...
    note: 'Вход, регистрация и онбординг задают точку входа в контур данных и ролей.',
  ...
  {
    title: 'Статус',
    note: 'Статусный слой показывает, какие внешние контуры уже активны, а какие ещё требуют проверки.',
    ...
    <div style={{ display: 'grid', gap: 16, maxWidth: 1040, margin: '0 auto' }}>
      <section style={{ background: '#fff', border: '1px solid var(--pc-border, #E4E6EA)', borderRadius: 18, padding: 18 }}>
        ...
        <div style={{ marginTop: 8, fontSize: 13, color: 'var(--pc-text-muted, #6B778C)', lineHeight: 1.7 }}>
          Это краткая рабочая версия для проверочного контура: что за данные участвуют в исполнении сделки, зачем они нужны и как ограничивается доступ.
        </div>
      </section>
      ...
      <section style={{ background: '#fff', border: '1px solid var(--pc-border, #E4E6EA)', borderRadius: 18, padding: 18, display: 'grid', gap: 14 }}>
        <div>
          <div style={{ fontSize: 20, lineHeight: 1.2, fontWeight: 800, color: 'var(--pc-text-primary, #0F1419)' }}>Модули контроля данных</div>
      ...
      <section style={{ background: '#fff', border: '1px solid var(--pc-border, #E4E6EA)', borderRadius: 18, padding: 18, display: 'grid', gap: 10 }}>
        <div style={{ fontSize: 18, fontWeight: 800, color: 'var(--pc-text-primary, #0F1419)' }}>Ключевой принцип</div>
