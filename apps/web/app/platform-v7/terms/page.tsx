...
export const metadata: Metadata = {
  ...
  description:
    'Рабочая версия условий использования для контура контролируемого пилота / преинтеграции по исполнению зерновой сделки.',
  alternates: {
...
const BLOCKS = [
  ...
  },
  {
    ...
    body: 'Часть данных и сценариев в проверочном контуре используется для проверки логики продукта. Это не должно трактоваться как подтверждение полной зрелости всех интеграций.',
  },
  {
  ...
  },
  {
    ...
    body: 'Контур сделки помогает снижать хаос, спорность и риск раннего банковской проверки выплаты, но не подменяет собой правовую экспертизу, банковое решение, регуляторное подтверждение или внутренние процедуры сторон.',
  },
];
...
const MODULE_LINKS = [
  ...
  },
  {
    ...
    note: 'Проверка выплаты, события банка, факторинг, эскроу и транспортные условия оформлены в отдельную поверхность.',
    ...
    <div style={{ display: 'grid', gap: 16, maxWidth: 1040, margin: '0 auto' }}>
      <section style={{ background: '#fff', border: '1px solid var(--pc-border, #E4E6EA)', borderRadius: 18, padding: 18 }}>
        ...
        <div style={{ marginTop: 8, fontSize: 13, color: 'var(--pc-text-muted, #6B778C)', lineHeight: 1.7 }}>
          Краткая рабочая версия правил использования проверочного контура и пилотного режима. Без завышения зрелости и без притворства, что внешние подключения уже подтверждены.
        </div>
      </section>
      ...
      <section style={{ background: '#fff', border: '1px solid var(--pc-border, #E4E6EA)', borderRadius: 18, padding: 18, display: 'grid', gap: 10 }}>
        <div style={{ fontSize: 18, fontWeight: 800, color: 'var(--pc-text-primary, #0F1419)' }}>Главный принцип</div>
