...
const BLOCKS = [
  ...
  },
  {
    ...
    body: 'Часть данных и сценариев в проверочном контуре может имитироваться для проверки логики продукта. Это не должно трактоваться как подтверждение полного промышленного статуса всех интеграций.',
  },
  {
  ...
  },
  {
    ...
    body: 'Контур сделки помогает снижать хаос, спорность и риск ранней передачи неполного основания банку, но не подменяет собой правовую экспертизу, банковое решение, регуляторное подтверждение или внутренние процедуры сторон.',
  },
];
    ...
    <div style={{ display: 'grid', gap: 16, maxWidth: 1040, margin: '0 auto' }}>
      <section style={{ background: '#fff', border: '1px solid #E4E6EA', borderRadius: 18, padding: 18 }}>
        ...
        <div style={{ marginTop: 8, fontSize: 13, color: '#6B778C', lineHeight: 1.7 }}>
          Краткая рабочая версия правил использования контура исполнения и проверочного режима. Без завышения зрелости и без притворства, что всё уже боевое.
        </div>
      </section>
      ...
      <section style={{ background: '#fff', border: '1px solid #E4E6EA', borderRadius: 18, padding: 18, display: 'grid', gap: 10 }}>
        ...
        <div style={{ fontSize: 13, color: '#475569', lineHeight: 1.7 }}>
          Всё, что пользователь видит в контуре, должно помогать исполнению сделки: не передавать банку неполное основание, не терять документы, не размазывать спор по мессенджерам и не ломать доказательную цепочку.
        </div>
      </section>
