...
const METRICS = [
  ...
  { label: 'Экспорт / внутренний рынок', value: '18 / 82', note: 'Соотношение по текущему проверочному портфелю.' },
];
...
const BLOCKS = [
  ...
  },
  {
    ...
    body: 'Часть показателей в текущем контуре агрегируется на основе проверочных данных. Это полезно для логики и упаковки, но не должно выдаваться за финальную официальную отчётность без внешних подтверждений.',
  },
];

const REGIONS = [
  { name: 'Тамбовская область', share: '32%', status: 'ядро проверки' },
