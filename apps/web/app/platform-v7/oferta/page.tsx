...
const BLOCKS = [
  {
    ...
    body: 'Проверочный контур предоставляет пользователю доступ к рабочим экранам, статусам, документам, маршрутам, событиям и действиям, связанным с исполнением сделки. Оферта описывает использование этого контура как сервиса сопровождения, а не как замену договора между сторонами сделки.',
  },
  {
  ...
  },
  {
    ...
    body: 'Пользователь обязан корректно использовать свою роль, не искажать документы, не обходить контур исполнения сделки и не выдавать неподтверждённые статусы за юридически подтверждённые результаты, если это не подтверждено документами и внешним контуром.',
  },
  {
...
const MODULE_LINKS = [
  ...
  },
  {
    ...
    note: 'Резерв, статусы банка, factor/escrow и transport gate оформлены в отдельную поверхность.',
    ...
    <div style={{ display: 'grid', gap: 16, maxWidth: 1040, margin: '0 auto' }}>
      <section style={{ background: '#fff', border: '1px solid #E4E6EA', borderRadius: 18, padding: 18 }}>
        ...
        <div style={{ marginTop: 8, fontSize: 13, color: '#6B778C', lineHeight: 1.7 }}>
          Краткая рабочая версия оферты для проверочного контура исполнения. Без притворства, что это уже финальный юридический пакет.
        </div>
      </section>
