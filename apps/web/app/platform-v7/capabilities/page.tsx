...
const COPY={
ru:{e:'Возможности',t:'Всё, что нужно для работы со сделкой',p:'Рынок, исполнение, документы, расчёт и закрытие связаны между собой. Ниже — обзор двенадцати задач, которые поддерживают работу со сделкой.',items:{
...
en:{e:'Capabilities',t:'What you need to work on a Deal',p:'Market, execution, documents, settlement and closure stay connected. Below is an overview of twelve tasks that support work on a Deal.',items:{
...
zh:{e:'功能',t:'处理交易所需的各项任务',p:'市场、履约、文件、结算和关闭保持关联。以下概览介绍支持交易工作的十二项任务。',items:{
