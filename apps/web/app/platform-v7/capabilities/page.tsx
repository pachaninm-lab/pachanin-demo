...
market:['Рынок','Публичные обезличенные лоты как первый этап Сделки.'],trading:['Торги','Результат торгов сразу остаётся связан с выбранным контрагентом и Сделкой.'],commitments:['Обязательства','Условия и ответственность сторон становятся частью исполнения.'],delivery:['Доставка','Логистика и водитель видят свои задачи, сроки и связанные события в той же Сделке.'],acceptance:['Приёмка / качество','Факт приёмки и качество влияют на дальнейшее исполнение.'],documents:['Документы','Документы и события остаются привязаны к Сделке и не теряются между этапами.'],settlement:['Документы / расчёт','Финансовый шаг зависит от подтверждённого основания.'],dispute:['Закрытие / спор','Отклонение и спор разбираются по фактам и основаниям.'],trust:['Доверие','Понятно, кто действовал, на каком основании и какое решение было зафиксировано.'],gekta:['Гекта','Показывает факты Сделки, риск и следующий допустимый шаг.'],roles:['9 ролей','Каждый участник видит только те данные и действия, которые соответствуют его полномочиям.'],history:['История Сделки','Действия и решения сохраняют связь с фактом и участником.']},cta:'Начать регистрацию',more:'Как проходит Сделка'},
...
market:['Market','Public anonymised lots shown as the first Deal stage.'],trading:['Trading','The trading result stays tied to the selected counterparty and the Deal.'],commitments:['Commitments','Terms and responsibilities become part of execution.'],delivery:['Delivery','Logistics and drivers see their tasks, timing and related events in the same Deal.'],acceptance:['Acceptance / quality','Acceptance facts and quality affect further execution.'],documents:['Documents','Documents and events remain attached to the Deal instead of getting lost between stages.'],settlement:['Documents / settlement','The financial step depends on confirmed basis.'],dispute:['Closure / dispute','Deviation and dispute are reviewed through facts and evidence.'],trust:['Trust','You can see who acted, why, and which decision was recorded.'],gekta:['Gekta','Shows Deal facts, risk and the next permitted step.'],roles:['9 roles','Each participant sees only the data and actions allowed by their authority.'],history:['Deal history','Actions and decisions stay linked to fact and participant.']},cta:'Register',more:'How the Deal works'},
zh:{e:'功能',t:'交易各阶段前后相连',p:'市场、交易、交付、质量、文件和结算始终属于同一笔交易，因此可以看到已经发生什么、还有什么待确认、下一步由谁处理。',items:{
market:['市场','公开匿名批次作为交易第一阶段展示。'],trading:['交易','交易结果始终与所选交易方和具体交易关联。'],commitments:['义务','条件和责任成为履约的一部分。'],delivery:['交付','物流和司机在同一笔交易中看到自己的任务、时间和相关事件。'],acceptance:['验收 / 质量','验收事实和质量影响后续履约。'],documents:['文件','文件和事件始终与交易关联，不会在阶段切换时丢失。'],settlement:['文件 / 结算','金融步骤取决于已确认依据。'],dispute:['关闭 / 争议','偏差和争议根据事实与依据处理。'],trust:['信任','可以看到谁做了什么、依据是什么，以及记录了什么决定。'],gekta:['Gekta','显示交易事实、风险和允许的下一步。'],roles:['9 个角色','每个参与方只看到其权限允许的数据和操作。'],history:['交易历史','操作和决定始终与事实和参与方关联。']},cta:'注册',more:'交易如何进行'},
} as const;
