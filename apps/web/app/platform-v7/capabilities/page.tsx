...
const COPY={
ru:{e:'Возможности',t:'Этапы Сделки связаны между собой',p:'Рынок, исполнение, документы, расчёт и закрытие связаны между собой. Данные не теряются при переходе между этапами.',items:{
market:['Рынок','Обезличенные данные опубликованных лотов.'],trading:['Торги','Торги и выбор контрагента остаются частью конкретной Сделки.'],commitments:['Обязательства','Условия и ответственность сторон остаются связаны с исполнением.'],delivery:['Доставка','Логист и водитель работают только с доступными им данными Сделки.'],acceptance:['Приёмка / качество','Результаты приёмки и качества влияют на дальнейшие действия.'],documents:['Документы','Документы и события остаются привязаны к Сделке на всех этапах.'],settlement:['Документы / расчёт','Действия по расчёту доступны только при подтверждённом основании.'],dispute:['Закрытие / спор','Отклонение и спор разбираются по фактам, документам и основаниям.'],trust:['Доверие','Для важного действия видны полномочия, основание, источник и решение.'],gekta:['Гекта','Состояние Сделки, риски и доступные дальнейшие действия по данным участника.'],roles:['9 ролей','Доступ появляется только после проверки роли и организации.'],history:['История Сделки','История связывает действия и решения с фактами и участниками.']},cta:'Начать регистрацию',more:'Как проходит Сделка'},
en:{e:'Capabilities',t:'Deal stages stay connected',p:'Market, execution, documents, settlement and closure stay connected. Data is not lost between stages.',items:{
market:['Market','Anonymised data from published lots.'],trading:['Trading','Trading and counterparty selection stay part of the Deal.'],commitments:['Commitments','Terms and responsibilities remain tied to execution.'],delivery:['Delivery','Logistics and the driver work only with Deal data available to them.'],acceptance:['Acceptance / quality','Acceptance and quality results affect what happens next.'],documents:['Documents','Documents and events remain tied to the Deal across stages.'],settlement:['Documents / settlement','Settlement actions are available only when there is confirmed basis.'],dispute:['Closure / dispute','Deviation and dispute are reviewed against facts, documents and evidence.'],trust:['Trust','Authority, basis, source and decision remain visible for important actions.'],gekta:['Gekta','Deal state, risk and available next actions from participant data.'],roles:['9 roles','Access is granted only after role and organisation verification.'],history:['Deal history','History links actions and decisions to facts and participants.']},cta:'Register',more:'How the Deal works'},
zh:{e:'功能',t:'交易各阶段保持关联',p:'市场、履约、文件、结算和关闭保持关联，阶段切换时数据不会丢失。',items:{
market:['市场','已发布批次的匿名公开数据。'],trading:['交易','交易和交易方选择结果始终与具体交易关联。'],commitments:['义务','条件和责任成为履约的一部分。'],delivery:['交付','物流和司机只处理其获准查看的交易数据。'],acceptance:['验收 / 质量','验收事实和质量影响后续履约。'],documents:['文件','文件和事件在各阶段始终与具体交易关联。'],settlement:['文件 / 结算','金融步骤取决于已确认依据。'],dispute:['关闭 / 争议','偏差和争议根据事实与依据处理。'],trust:['信任','重要操作会显示权限、依据、来源和决定。'],gekta:['Gekta','基于参与方数据显示交易状态、风险和可执行的下一步。'],roles:['9 个角色','角色和机构审核通过后才会开放访问权限。'],history:['交易历史','历史记录把操作和决定与事实及参与方关联起来。']},cta:'注册',more:'交易如何进行'},
} as const;
