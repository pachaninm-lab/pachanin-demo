...
const COPY={
ru:{e:'Возможности',t:'Весь путь Сделки — без разрывов между этапами',p:'Рынок, торги, доставка, качество, документы и расчёт работают как один связный процесс. Меньше ручных сверок — понятнее, что происходит и что делать дальше.',items:{
...
en:{e:'Capabilities',t:'The whole Deal without hand-offs between disconnected tools',p:'Market, trading, delivery, quality, documents and settlement work as one connected flow. Less manual reconciliation means a clearer view of what is happening and what comes next.',items:{
...
zh:{e:'功能',t:'整笔交易，不再被分散工具切断',p:'市场、交易、交付、质量、文件和结算连接成一个流程。减少人工核对，也更容易看清当前状态和下一步。',items:{
