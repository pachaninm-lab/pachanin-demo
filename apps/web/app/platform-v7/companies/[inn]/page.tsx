...
const COMPANIES: Record<string, {
  ...
  '6829123456': {
    ...
    deals: '12',
    avgCycle: '4.3 дня',
    note: 'Якорный контрагент в рабочем контуре. По компании виден стабильный документный слой, повторяемость исполнения и понятная банковая дисциплина.',
    ...
    method: ['Сроки и скорость отгрузки', 'Качество и спорность', 'Скорость закрытия документов', 'Надёжность денежного контура'],
    relatedDeals: [
      { id: 'DL-9102', note: 'Спор по качеству, деньги на hold', status: 'Спор' },
      { id: 'DL-9108', note: 'Контур готов к банковскому подтверждению', status: 'Основание готово' },
  ...
  '3664098765': {
    ...
    method: ['Сроки и скорость отгрузки', 'Качество и спорность', 'Скорость закрытия документов', 'Надёжность денежного контура'],
    relatedDeals: [
      { id: 'DL-9108', note: 'Готово к банковскому подтверждению', status: 'Ок' },
  ...
  '7701234567': {
    ...
    deals: '21',
    avgCycle: '5.7 дня',
    note: 'Крупный контрагент с высоким объёмом. Нуждается в дисциплине ролей и аккуратном контроле сроков, иначе платформа быстро превращается в ручной сервис.',
    certificates: ['Верификация контрагента пройдена', 'Высокий объём', 'Ручные проверки банка'],
    signals: ['Высокий объём', 'Требует контроля сроков', 'Есть ручной банковый слой'],
    method: ['Сроки и скорость отгрузки', 'Качество и спорность', 'Скорость закрытия документов', 'Надёжность денежного контура'],
    relatedDeals: [
