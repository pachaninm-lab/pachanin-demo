  ...
  return (
    <main style={{ display: 'grid', gap: 16 }}>
      <section style={{ background: '#fff', border: '1px solid #E4E6EA', borderRadius: 24, padding: 20, display: 'grid', gap: 10 }}>
        <p style={{ margin: 0, color: '#0A7A5F', fontSize: 12, fontWeight: 900, textTransform: 'uppercase', letterSpacing: '0.06em' }}>Логистика · входящие заявки</p>
        ...
        <p style={{ margin: 0, color: '#475569', fontSize: 15, lineHeight: 1.6 }}>Логистическая компания принимает заказ по сделке, выбирает ближайшего доступного водителя и создаёт рейс. Показан пилотный сценарий без боевого GPS и внешних API.</p>
      </section>

      <section style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(280px,1fr))', gap: 14 }}>
        <article style={{ background: '#fff', border: '1px solid #E4E6EA', borderRadius: 22, padding: 18, display: 'grid', gap: 10 }}>
          <p style={{ margin: 0, color: '#64748B', fontSize: 12, fontWeight: 900, textTransform: 'uppercase', letterSpacing: '0.06em' }}>Заявка</p>
          <h2 style={{ margin: 0, color: '#0F1419', fontSize: 26 }}>LOG-REQ-2403</h2>
          <p style={{ margin: 0, color: '#475569' }}>LOT-2403 → DL-9106</p>
          <p style={{ margin: 0, color: '#475569' }}>Пшеница 4 кл. · 600 т</p>
        ...
        <article style={{ background: '#0F1419', color: '#fff', borderRadius: 22, padding: 18, display: 'grid', gap: 10 }}>
          <p style={{ margin: 0, color: '#B6C2CF', fontSize: 12, fontWeight: 900, textTransform: 'uppercase', letterSpacing: '0.06em' }}>Назначение</p>
