  ...
  return (
    <>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
        ...
        {/* Back + header */}
        <div>
          <Link href="/platform-v7/deals" style={{ display: 'inline-flex', alignItems: 'center', gap: 4, fontSize: 12, color: '#6B778C', textDecoration: 'none', marginBottom: 10 }}>
            ...
            <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
              {deal.dispute && (
                <Button variant="danger" size="sm" asChild>
                  <Link href={`/platform-v7/disputes/${deal.dispute.id}`}>
                    <Scale size={14} /> War-room
                  </Link>
                </Button>
              )}
              <Button variant="ghost" size="sm" asChild>
                <Link href="/platform-v7/bank"><Landmark size={14} /> Банк</Link>
              </Button>
              {canRelease && (
                <Button
                  variant="primary"
          ...
          <TabsContent value="timeline">
            ...
            {deal.dispute && (
              <div style={{ marginTop: 12, padding: '12px 16px', background: 'rgba(220,38,38,0.05)', border: '1px solid rgba(220,38,38,0.2)', borderRadius: 8, display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap' }}>
                ...
                <Button variant="danger" size="sm" asChild>
                  <Link href={`/platform-v7/disputes/${deal.dispute.id}`}>Открыть war-room →</Link>
                </Button>
              </div>
            )}
          </TabsContent>
