...
export default function LoginPage() {
  ...
  return (
    <main className='pc-v7-public-entry pc-auth-page'>
      ...
      <style jsx>{`
        .pc-auth-page{--auth-header-height:64px;min-height:100dvh;padding-top:var(--auth-header-height);background:radial-gradient(circle at 12% 0%,rgba(8,122,59,.12),transparent 34%),linear-gradient(180deg,#f7faf7 0%,#eef5ef 58%,#f8faf8 100%);color:#102019;font-family:var(--font-inter),Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif}
        .pc-auth-page *{box-sizing:border-box}.pc-auth-shell{width:min(100%,560px);min-height:calc(100dvh - var(--auth-header-height));margin:0 auto;padding:clamp(34px,7vh,74px) 18px 40px;display:flex;flex-direction:column;justify-content:center;gap:24px}.pc-auth-heading{text-align:center}.pc-auth-heading h1{margin:0;font-size:clamp(38px,7vw,58px);line-height:1;letter-spacing:-.055em}.pc-auth-heading p{max-width:520px;margin:16px auto 0;color:#5c6b64;font-size:16px;line-height:1.5;font-weight:600}
        .pc-auth-card{display:grid;gap:18px;padding:clamp(22px,5vw,36px);border-radius:30px;background:rgba(255,255,255,.96);border:1px solid rgba(16,32,25,.1);box-shadow:0 28px 80px rgba(27,66,45,.13)}.pc-auth-label{display:grid;gap:8px}.pc-auth-label>span:first-child{font-size:13px;font-weight:900;color:#31423a}.pc-auth-field{height:56px;display:flex;align-items:center;gap:10px;padding:0 15px;border-radius:17px;background:#f9fbf9;border:1px solid rgba(16,32,25,.12);transition:border-color .15s,box-shadow .15s}.pc-auth-field:focus-within{border-color:rgba(8,122,59,.58);box-shadow:0 0 0 4px rgba(8,122,59,.1)}.pc-auth-field>svg{color:#708078;flex:0 0 auto}.pc-auth-field input{width:100%;height:100%;min-width:0;border:0;outline:0;background:transparent;color:#102019;font:inherit;font-size:16px}.pc-auth-password-toggle{width:38px;height:38px;flex:0 0 38px;border:0;border-radius:11px;background:transparent;color:#607068;display:grid;place-items:center;cursor:pointer}
        .pc-auth-links{display:flex;align-items:center;justify-content:space-between;gap:14px;flex-wrap:wrap}.pc-auth-links a{color:#087a3b;text-decoration:none;font-size:13px;font-weight:850}.pc-auth-error{margin:0;padding:12px 14px;border-radius:14px;background:#fff1f1;border:1px solid #f2c5c5;color:#9b2525;font-size:13px;font-weight:800;line-height:1.4}.pc-auth-submit,.pc-auth-secondary{min-height:56px;border-radius:17px;font:inherit;font-size:15px;font-weight:950;cursor:pointer}.pc-auth-submit{border:0;background:linear-gradient(135deg,#087a3b,#075f31);color:#fff;box-shadow:0 18px 36px rgba(8,122,59,.22)}.pc-auth-secondary{border:1px solid rgba(16,32,25,.14);background:#fff;color:#31423a}.pc-auth-submit:disabled,.pc-auth-secondary:disabled{cursor:wait;opacity:.66}.pc-auth-note{margin:0;color:#6b7973;font-size:12px;line-height:1.5;text-align:center}
        .pc-auth-methods{display:grid;grid-template-columns:1fr 1fr;gap:10px}.pc-auth-methods button{min-height:48px;border:1px solid rgba(16,32,25,.13);border-radius:14px;background:#f7faf7;color:#31423a;font:inherit;font-size:13px;font-weight:850;display:flex;align-items:center;justify-content:center;gap:8px;cursor:pointer}.pc-auth-methods button[aria-pressed='true']{border-color:rgba(8,122,59,.55);background:rgba(8,122,59,.08);color:#087a3b}.pc-auth-enrollment{display:flex;gap:14px;padding:16px;border-radius:18px;background:rgba(8,122,59,.07);border:1px solid rgba(8,122,59,.18)}.pc-auth-enrollment>svg{flex:0 0 auto;color:#087a3b}.pc-auth-enrollment h2{margin:0;font-size:17px}.pc-auth-enrollment p{margin:6px 0 12px;color:#5c6b64;font-size:13px;line-height:1.45}.pc-auth-enrollment span{display:block;color:#5c6b64;font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:.06em}.pc-auth-enrollment code{display:block;margin-top:6px;padding:10px;border-radius:10px;background:#fff;overflow-wrap:anywhere;font-size:13px}.pc-auth-backup-codes{text-align:center;justify-items:center}.pc-auth-backup-codes>svg{color:#087a3b}.pc-auth-code-grid{width:100%;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.pc-auth-code-grid code{padding:10px;border-radius:10px;background:#f4f7f4;border:1px solid rgba(16,32,25,.09);font-size:13px}
        button:focus-visible,a:focus-visible,input:focus-visible{outline:3px solid rgba(8,122,59,.34);outline-offset:3px}@media(max-width:520px){.pc-auth-shell{padding:28px 14px;justify-content:flex-start}.pc-auth-heading h1{font-size:38px}.pc-auth-card{padding:22px;border-radius:24px}.pc-auth-links{align-items:flex-start;flex-direction:column}.pc-auth-field{height:54px}.pc-auth-methods,.pc-auth-code-grid{grid-template-columns:1fr}}
      `}</style>
    </main>
  );
}
