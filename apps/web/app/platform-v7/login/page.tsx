...
const methods = [
  ...
  { title: 'Email + пароль', note: 'Резервный вход для внутренних пользователей, операторов и пилотного контура.', tone: 'rgba(217,119,6,0.08)', border: 'rgba(217,119,6,0.18)', color: '#B45309' },
];
      ...
      <section style={{ background: '#fff', border: '1px solid #E4E6EA', borderRadius: 18, padding: 18 }}>
        <div style={{ display: 'grid', gap: 10 }}>
          ...
          <div style={{ fontSize: 13, color: '#6B778C', lineHeight: 1.7, maxWidth: 760 }}>
            Выберите способ входа в зависимости от роли: ЕСИА для подтверждённой государственной роли, СберБизнес ID для банкового контура, email для внутреннего и операторского доступа.
          </div>
        </div>
      </section>
