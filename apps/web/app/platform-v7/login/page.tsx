...
export default function LoginPage() {
  ...
  function onSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    if (!lockedRole) {
      setError('Рабочее место не определено. Откройте вход через нужную роль на главной странице.');
      return;
    }
      ...
      <section className='login-shell'>
        ...
        <section className='login-main' aria-label='Форма входа'>
          <div className='login-copy'>
            ...
            <p>{selected ? 'Рабочее место закреплено. Продолжите вход по корпоративным данным.' : 'Авторизуйтесь по корпоративным данным. Рабочее место определяется маршрутом доступа.'}</p>
          </div>
          ...
          <form className='login-form' onSubmit={onSubmit}>
            ...
            {selected ? (
              <article className='login-selected' aria-label='Рабочее место'>
                <em>рабочее место</em>
