...
const groups = [
  {
    ...
    items: [
      ...
      ['Банковый контур в проверочном контуре', 'partial'],
      ['Рабочее место сделки', 'partial'],
      ['Партии ФГИС в проверочном контуре', 'partial'],
      ['Финансирование покупателя в проверочном контуре', 'partial'],
      ['Логистика в проверочном контуре', 'partial'],
    ],
  },
  {
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', gap: 12, flexWrap: 'wrap', alignItems: 'flex-start' }}>
          <div>
            ...
            <div style={{ marginTop: 8, fontSize: 14, color: M, maxWidth: 880 }}>
              Честная карта состояния platform-v7: что уже собрано в проверочном контуре, что требует управляемого пилота и что нельзя заявлять как готовое к промышленному запуску.
            </div>
          </div>
