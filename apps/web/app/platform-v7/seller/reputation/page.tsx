...
const COPY: Record<Locale, Copy> = {
  ru: {
    ...
    notice: 'Удалены числовой рейтинг, неподтверждённая история оплаты, статус проверок и вывод о резерве. Пустой backend не заменяется локальной оценкой.',
  ...
  en: {
    ...
    notice: 'The numeric score, unsupported payment history, check status and reserve conclusion were removed. An empty backend is not replaced with a local assessment.',
  ...
  zh: {
    ...
    noticeTitle: '虚构评分已删除',
    notice: '已删除数字评分、未确认的付款历史、检查状态和预留结论。空 backend 不会由本地评估替代。',
    boundaryTitle: '评估边界',
