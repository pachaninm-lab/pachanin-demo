...
const operations = [
  ...
  { type: 'Release', desc: 'Ожидает: 2 документа не загружены', amount: '5 760 000 ₽', date: 'Ожидает', tone: 'warn' },
] as const;

const callbacks = [
  { id: 'CB-441', type: 'Резерв', deal: 'DL-9102', status: 'OK', note: 'Подтверждено автоматически', date: '11.03 09:12', tone: 'success' },
  { id: 'CB-442', type: 'Качество', deal: 'DL-9102', status: 'Mismatch', note: 'Расхождение 0.8% — требует ручной сверки', date: '11.03 14:30', tone: 'danger' },
      ...
      <div className='t7-stack'>
        ...
        <section className='t7-hero'>
          ...
          <div className='t7-actions'>
            <Link href='#' className='t7-btn primary'>Подтвердить резерв</Link>
            <Link href='#' className='t7-btn'>Выпустить средства</Link>
