...
const integrations = [
  { name: 'Сбер · Безопасные сделки', role: 'резерв и выплата денег', status: 'условия выплаты проверяются', screen: '/platform-v7/bank', state: 'wait', mode: 'проверочный контур', live: 'банковская проверка выплаты требует подтверждения банка' },
...
const connectorSummary = [
  ...
  { label: 'Что блокирует', value: 'ФГИС, ЭТрН, УПД', note: 'Эти контуры напрямую останавливают банковскую проверку выплаты продавцу.' },
