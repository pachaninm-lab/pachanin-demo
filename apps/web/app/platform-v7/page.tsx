...
export const metadata: Metadata = {
  ...
  description: 'Торги, договор, поставка, приёмка, качество, документы, расчёт, спор и TAI связаны в одной Сделке.',
  alternates: {
  ...
  openGraph: {
    type: 'website',
    title: 'Прозрачная Цена — единая система управления агросделкой',
    description: 'От цены до расчёта: участники, логистика, качество, документы, деньги, спор и ИИ работают в одной Сделке.',
    url: '/platform-v7',
  ...
  twitter: {
    ...
    description: 'Единая система управления агросделкой с собственным ИИ TAI: исполнение, расчёт, доказательства и закрытие.',
  },
  robots: {
    index: true,
    follow: true,
