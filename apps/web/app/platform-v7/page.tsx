...
.pc-shell-root-v4:has(.pc-v7-entry-page) .pc-v4-top > button.pc-v4-iconbtn:first-child { display: none !important; }
...
.pc-v7-entry-page{--green:#008B2E;--deep:#061A16;--muted:#5E6875;--border:rgba(15,23,42,.075);position:relative;overflow:hidden;min-height:100dvh;padding:28px 42px 42px;background:radial-gradient(circle at 72% 12%,rgba(226,171,89,.24),transparent 33%),linear-gradient(180deg,#FFFCF6,#fff 56%,#FEFCF7);color:var(--deep);font-family:-apple-system,BlinkMacSystemFont,'SF Pro Display','SF Pro Text','Inter','Manrope',system-ui,sans-serif}
...
@media(max-width:980px){.pc-shell-root-v4:has(.pc-v7-entry-page) .pc-v4-top{grid-template-columns:minmax(0,1fr) auto!important}.pc-shell-root-v4:has(.pc-v7-entry-page) .pc-v4-brand{justify-self:start}.pc-v7-entry-page{padding:0 18px calc(env(safe-area-inset-bottom) + 108px);display:flex;flex-direction:column;align-items:center;background:#fff;min-height:100dvh;overflow:visible}.entry-desktop-bg,.entry-kicker,.entry-process,.entry-how,.entry-note,.entry-secondary-action,.entry-desktop-role-groups,.entry-desktop-trust-strip,.entry-desktop-integration-note{display:none!important}.entry-mobile-bg{display:block;position:absolute;pointer-events:none;opacity:.045;filter:blur(.45px);z-index:0}.entry-mobile-bg.field{left:-60px;right:-60px;bottom:70px;height:220px;transform:rotate(-5deg);background:repeating-linear-gradient(105deg,rgba(0,139,46,.78) 0 18px,rgba(198,147,32,.55) 18px 36px)}.entry-mobile-bg.elevator{right:12px;top:88px;width:126px;height:178px;background:rgba(15,23,42,.34);clip-path:polygon(18% 100%,18% 30%,30% 30%,30% 12%,70% 12%,70% 30%,82% 30%,82% 100%)}.entry-mobile-bg.route{left:34px;right:24px;top:250px;height:124px;border-top:9px solid rgba(0,139,46,.65);border-right:9px solid rgba(0,139,46,.42);border-radius:0 72px 0 0;transform:rotate(-9deg)}.entry-mobile-bg.truck{left:26px;bottom:132px;width:86px;height:42px;border-radius:12px;background:rgba(15,23,42,.26)}.entry-soft{display:block;position:absolute;inset:0;background:linear-gradient(180deg,rgba(255,255,255,.985),rgba(255,255,255,.95) 50%,rgba(250,253,250,.98));pointer-events:none}.entry-hero,.entry-roles,.entry-trust{width:min(100%,430px);margin-left:auto;margin-right:auto}.entry-hero{display:block;min-height:auto;padding-top:30px}.entry-copy{gap:18px}.entry-title{font-family:inherit;font-size:clamp(40px,10.35vw,50px);line-height:.94;letter-spacing:-.075em;font-weight:950;color:#061A16}.entry-title span:last-child{color:#008B2E}.entry-lead{max-width:350px;color:#5E6875;font-size:clamp(16.5px,4.6vw,19px);line-height:1.45;font-weight:620}.entry-actions{display:grid;gap:12px}.entry-primary-action{min-height:62px;width:100%;border-radius:16px;justify-content:center;padding:0 22px;font-size:18px;background:linear-gradient(180deg,#00A83B,#008B2E)}.entry-primary-action svg{display:none}.entry-primary-action b{margin-left:auto;font-size:30px}.entry-auth-actions{display:grid;gap:12px}.entry-auth-actions a{min-height:58px;border-radius:16px;display:flex;align-items:center;justify-content:center;text-decoration:none;color:#111827;background:rgba(255,255,255,.94);border:1px solid rgba(15,23,42,.075);box-shadow:0 8px 20px rgba(15,23,42,.052);font-size:18px;font-weight:900}.entry-roles{margin-top:22px;display:grid;gap:12px}.entry-roles h2{font-size:19px;color:#061A16}.entry-mobile-role-grid{display:grid!important;grid-template-columns:repeat(4,minmax(0,1fr))!important;gap:10px!important;width:100%}.entry-role-card.mobile{min-width:0!important;width:auto!important;min-height:132px!important;padding:13px 6px 11px!important;border-radius:15px!important;gap:7px!important;background:rgba(255,255,255,.88)!important;border:1px solid rgba(15,23,42,.075)!important;box-shadow:0 8px 20px rgba(15,23,42,.052)!important;display:grid!important;grid-template-columns:1fr!important;justify-items:center!important;align-content:start!important;text-align:center!important}.entry-role-card.mobile svg{width:28px!important;height:28px!important;color:#008B2E!important}.entry-role-card.mobile strong{font-size:12.4px!important;line-height:1.08!important;color:#061A16!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important;max-width:100%;font-weight:950!important}.entry-role-card.mobile span{color:#66717C!important;font-size:10.2px!important;line-height:1.2!important;font-weight:640!important}.entry-role-card.mobile i{display:none!important}.entry-more-roles{display:block;border:1px solid rgba(15,23,42,.075);border-radius:16px;background:rgba(255,255,255,.78);padding:0 12px}.entry-more-roles summary{cursor:pointer;min-height:42px;display:flex;align-items:center;color:#0F2A23;font-size:13px;font-weight:900;list-style:none}.entry-more-roles summary::-webkit-details-marker{display:none}.entry-more-roles>div{display:grid;gap:8px;padding-bottom:12px}.entry-role-card.small{min-height:92px;display:grid;grid-template-columns:auto 1fr;justify-items:start;text-align:left;align-items:center;padding:10px}.entry-role-card.small svg{width:28px;height:28px}.entry-trust{margin-top:20px;display:grid;grid-template-columns:auto minmax(0,1fr) auto;align-items:center;gap:12px;padding:13px;border-radius:18px;background:linear-gradient(180deg,rgba(241,252,244,.92),rgba(255,255,255,.92));border:1px solid rgba(0,139,46,.12);box-shadow:0 10px 24px rgba(15,23,42,.052)}.entry-trust-shield{width:46px;height:46px;border-radius:16px;display:inline-flex;align-items:center;justify-content:center;color:#fff;background:linear-gradient(180deg,#19B84D,#008B2E);box-shadow:0 9px 20px rgba(0,139,46,.22)}.entry-trust-shield svg{width:28px;height:28px}.entry-trust-copy{display:grid;gap:3px}.entry-trust-copy strong{font-size:14.5px;line-height:1.14;font-weight:950}.entry-trust-copy small{color:#5E6875;font-size:12.2px;line-height:1.34}.entry-trust-chart{width:58px;height:34px;display:flex;align-items:end;gap:5px;opacity:.65}.entry-trust-chart i{display:block;width:12px;border-radius:5px 5px 3px 3px;background:#008B2E}.entry-trust-chart i:nth-child(1){height:13px;opacity:.35}.entry-trust-chart i:nth-child(2){height:22px;opacity:.55}.entry-trust-chart i:nth-child(3){height:31px}.entry-bottom-tabs{position:fixed;z-index:50;left:50%;bottom:0;transform:translateX(-50%);width:min(100%,430px);padding:9px 0 calc(env(safe-area-inset-bottom) + 10px);display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:3px;border-top:1px solid rgba(15,23,42,.07);background:rgba(255,255,255,.965);box-shadow:0 -12px 28px rgba(15,23,42,.055);backdrop-filter:blur(18px)}.entry-bottom-tabs a{min-width:0;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:4px;min-height:48px;text-decoration:none;color:#6B7280}.entry-bottom-tabs svg{width:19px;height:19px}.entry-bottom-tabs small{max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:10.5px;line-height:1;font-weight:760}.entry-bottom-tabs a.active{color:#008B2E}}
