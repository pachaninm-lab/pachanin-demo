    ...
    <main data-testid='platform-v7-root-execution-cockpit' className='pc-v7-entry-page'>
      ...
      <section className='entry-hero' aria-label='Первый экран'>
        <div className='entry-copy'>
          <header className='entry-mobile-brand-row' aria-hidden='true'>
            <Link href='/platform-v7' className='entry-mobile-brand' tabIndex={-1} aria-label='Прозрачная Цена'>
              <BrandMark />
              <strong>Прозрачная Цена</strong>
            </Link>
            <Link href='/platform-v7/notifications' className='entry-mobile-bell' tabIndex={-1} aria-label='Уведомления'>
              <span />
              <Icon name='bell' />
            </Link>
          </header>
