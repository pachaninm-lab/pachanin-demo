    ...
    <main data-testid='platform-v7-root-execution-cockpit' className='pc-v7-entry-page pc-v7-public-entry'>
      ...
      <header className='entry-header' aria-label={t('publicNav')}>
        <Link href='/platform-v7' className='entry-brand' aria-label={t('brand')}>
          <span className='entry-brand-mark'><BrandMark size={42} /></span>
...
.pc-v7-public-entry a:focus-visible{outline:3px solid var(--entry-green);outline-offset:3px;border-radius:12px}
.pc-v7-public-entry :where(.entry-role-tile,.entry-primary-cta,.entry-secondary-cta,.entry-register-cta,.entry-login,.entry-header-register,.entry-trust-cta):focus-visible{outline:3px solid var(--entry-green-dark);outline-offset:3px}
@media (prefers-reduced-motion:reduce){.pc-v7-public-entry *,.pc-v7-public-entry *::before,.pc-v7-public-entry *::after{animation-duration:.001ms!important;animation-iteration-count:1!important;transition-duration:.001ms!important;scroll-behavior:auto!important}}
.entry-header{
