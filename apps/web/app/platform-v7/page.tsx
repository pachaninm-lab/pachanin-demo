...
export const metadata: Metadata = {
  title: 'Прозрачная Цена — исполнение агросделки от цены до расчёта',
  description: 'Одна Сделка связывает торги, логистику, качество, документы и деньги. TAI объясняет блокеры, основания и следующий шаг.',
  alternates: {
  ...
  openGraph: {
    type: 'website',
    title: 'Прозрачная Цена — исполнение агросделки в одной Сделке',
    description: 'Торги, логистика, качество, документы и деньги связаны в одном проверяемом контуре исполнения.',
    url: '/platform-v7',
  ...
  twitter: {
    ...
    title: 'Прозрачная Цена — исполнение Сделки',
    description: 'Единая цифровая инфраструктура агросделки и операционный интеллект TAI.',
  },
  robots: {
    index: true,
    follow: true,
