import '@/styles/platform-v7-elevator.css';
...
export default async function Page() {
  ...
  return (
    <main data-testid='platform-v7-elevator-page' style={{ display: 'grid', gap: 14, padding: '4px 0 24px' }}>
      <LiveApiStatusBar apiOnline={apiOnline} blockers={liveBlockers} activeShipments={shipmentCount} role="ЭЛЕВАТОР · ПРИЁМКА" summary={apiOnline ? `${shipmentCount} рейсов на приёмке · ${pendingSamples.length} проб ожидают протокола` : 'Внешние источники требуют подключения'} />
