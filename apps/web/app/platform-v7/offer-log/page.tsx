...
export default function PlatformV7OfferLogPage() {
  return (
    <div data-testid="platform-v7-offer-log-page" style={{ display: 'grid', gap: 18, padding: '8px 0', width: '100%', maxWidth: '100%', minWidth: 0, overflowX: 'clip' }}>
      <style dangerouslySetInnerHTML={{ __html: `
        [data-testid='platform-v7-offer-log-page']{max-width:100%!important;overflow-x:hidden!important}
        [data-testid='platform-v7-offer-log-page'] *{min-width:0;overflow-wrap:anywhere;box-sizing:border-box}
        [data-testid='platform-v7-offer-log-page'] a{max-width:100%!important;white-space:normal!important}
        @media(max-width:767px){
          [data-testid='platform-v7-offer-log-page']{gap:10px!important;padding:0!important}
          [data-testid='platform-v7-offer-log-page'] > section:nth-of-type(1){padding:16px!important;border-radius:24px!important;overflow:hidden!important}
          ...
          [data-testid='platform-v7-offer-log-page'] > div:nth-of-type(1) > div{padding:12px!important;border-radius:16px!important;overflow:hidden!important}
          [data-testid='platform-v7-offer-log-page'] > div:nth-of-type(1) > div:nth-child(n+4){display:none!important}
          [data-testid='platform-v7-offer-log-page'] > section:nth-of-type(2){padding:12px!important;border-radius:16px!important;overflow:hidden!important}
          ...
          [data-testid='platform-v7-offer-log-page'] > section:nth-of-type(3){padding:14px!important;border-radius:20px!important;gap:9px!important;overflow:hidden!important}
          [data-testid='platform-v7-offer-log-page'] > section:nth-of-type(3) > div:not(:first-child){grid-template-columns:58px 1fr!important;gap:8px!important;padding:12px!important;border-radius:16px!important;align-items:start!important;overflow:hidden!important}
          ...
          [data-testid='platform-v7-offer-log-page'] > section:nth-of-type(3) > div:not(:first-child) > span{grid-column:1 / -1!important;width:fit-content!important;max-width:100%!important}
          [data-testid='platform-v7-offer-log-page'] > section:nth-of-type(3) > div:nth-of-type(n+6){display:none!important}
          [data-testid='platform-v7-offer-log-page'] > section:nth-of-type(4){padding:14px!important;border-radius:20px!important;gap:9px!important;overflow:hidden!important}
          ...
          [data-testid='platform-v7-offer-log-page'] > section:nth-of-type(4) > div:nth-child(2) > div{padding:12px!important;border-radius:16px!important;overflow:hidden!important}
        ...
        @media(max-width:380px){
          [data-testid='platform-v7-offer-log-page'] > div:nth-of-type(1),
          [data-testid='platform-v7-offer-log-page'] > section:nth-of-type(4) > div:nth-child(2){grid-template-columns:1fr!important}
        }
      ` }} />
      <section style={{ background: S, border: `1px solid ${B}`, borderRadius: 18, padding: 18, minWidth: 0, overflow: 'hidden' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', gap: 12, flexWrap: 'wrap', alignItems: 'flex-start', minWidth: 0 }}>
          <div style={{ minWidth: 0 }}>
            ...
            <div style={{ marginTop: 6, fontSize: 28, lineHeight: 1.1, fontWeight: 900, color: T, overflowWrap: 'anywhere' }}>История ставок и действий по лоту</div>
      ...
      <section style={{ background: S, border: `1px solid ${B}`, borderRadius: 18, padding: 18, display: 'grid', gap: 12, minWidth: 0, overflow: 'hidden' }}>
        ...
        {events.map(([time, action, actor, note, status]) => {
          const t = tone(status);
          return (
            <div key={`${time}-${action}`} style={{ background: SS, border: `1px solid ${B}`, borderRadius: 14, padding: 14, display: 'grid', gridTemplateColumns: '70px minmax(160px, 0.8fr) minmax(140px, 0.7fr) minmax(240px, 1.4fr) auto', gap: 10, alignItems: 'center', minWidth: 0, overflow: 'hidden' }}>
              <div style={{ fontFamily: 'monospace', fontSize: 13, fontWeight: 900, color: BRAND, overflowWrap: 'anywhere' }}>{time}</div>
              <div style={{ fontSize: 13, fontWeight: 900, color: T, overflowWrap: 'anywhere' }}>{action}</div>
              <div style={{ fontSize: 12, color: M, overflowWrap: 'anywhere' }}>{actor}</div>
              <div style={{ fontSize: 12, color: T, lineHeight: 1.45, overflowWrap: 'anywhere' }}>{note}</div>
              <span style={{ padding: '5px 9px', borderRadius: 999, background: t.bg, border: `1px solid ${t.border}`, color: t.color, fontSize: 11, fontWeight: 900, maxWidth: '100%', overflowWrap: 'anywhere' }}>{status}</span>
            </div>
          );
        })}
      </section>
      ...
      <section style={{ background: S, border: `1px solid ${B}`, borderRadius: 18, padding: 18, display: 'grid', gap: 12, minWidth: 0, overflow: 'hidden' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(230px,1fr))', gap: 10, minWidth: 0, maxWidth: '100%' }}>
          {controls.map(([label, note]) => (
            <div key={label} style={{ background: SS, border: `1px solid ${B}`, borderRadius: 12, padding: 12, minWidth: 0, overflow: 'hidden' }}>
              <div style={{ fontSize: 13, fontWeight: 900, color: T, overflowWrap: 'anywhere' }}>{label}</div>
              <div style={{ marginTop: 5, fontSize: 12, color: M, lineHeight: 1.5, overflowWrap: 'anywhere' }}>{note}</div>
            </div>
          ))}
        </div>
      </section>
