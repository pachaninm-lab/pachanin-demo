...
const METRICS = [
  { label: 'Сделок в контуре', value: '23', note: 'Включая проверочные и операторские' },
  { label: 'Оборот', value: '130.6 млн ₽', note: 'По проверочному портфелю апреля' },
  { label: 'Средний цикл', value: '4.8 дня', note: 'От сделки до банковского подтверждения' },
  ...
  return (
    <div style={{ display: 'grid', gap: 16, maxWidth: 1040, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', gap: 12, flexWrap: 'wrap', alignItems: 'flex-start' }}>
          <div>
            ...
            <div style={{ marginTop: 8, fontSize: 13, color: '#6B778C', lineHeight: 1.7 }}>
              Рабочая карточка компании: реквизиты, базовое доверие, история исполнения и статус проверки. Это P1-страница контура исполнения, а не финальный промышленный кабинет.
            </div>
          </div>
      ...
      <section style={{ background: '#fff', border: '1px solid #E4E6EA', borderRadius: 18, padding: 18, display: 'grid', gap: 10 }}>
        ...
        <Bullet text='Часть интеграций ещё требует ручного или внешнего подтверждения, и это видно честно.' />
      </section>
