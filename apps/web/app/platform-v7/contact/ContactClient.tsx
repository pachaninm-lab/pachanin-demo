...
const css = `
.p7-contact-page{min-height:100svh;padding:12px clamp(14px,4vw,56px) calc(env(safe-area-inset-bottom) + 42px);color:#071611;background:linear-gradient(180deg,#fbfcf9 0%,#f3f7f1 56%,#fff 100%);font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif}
.p7-contact-page *{box-sizing:border-box}.p7-contact-page a{color:inherit;text-decoration:none}
.p7-contact-layout{display:grid;grid-template-columns:minmax(0,.95fr) minmax(340px,.78fr);gap:20px;padding:34px 0 0}
.p7-contact-copy,.p7-contact-form-card{border:1px solid rgba(7,22,17,.075);border-radius:32px;background:rgba(255,255,255,.84);box-shadow:0 18px 48px rgba(7,22,17,.07)}
...
.p7-contact-form-card{padding:22px}.p7-contact-form{display:grid;grid-template-columns:1fr 1fr;gap:13px}
