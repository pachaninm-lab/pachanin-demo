      ...
      <section className='p7-contact-layout'>
        <div className='p7-contact-copy'>
          ...
          <div className='p7-contact-cards' aria-label='Назначение формы'>
            <InfoCard icon={<MessageSquareText size={22} />} title='Обращение без регистрации' text='Для отправки вопроса не требуется выбирать роль или входить в личный кабинет.' />
            <InfoCard icon={<ShieldCheck size={22} />} title='Без доступа к рабочим данным' text='Форма не предоставляет доступ к сделкам, ролям и закрытым маршрутам платформы.' />
            <InfoCard icon={<HelpCircle size={22} />} title='Отдельный канал связи' text='Заявка на подключение организации оформляется через отдельную форму.' />
          </div>
        </div>
