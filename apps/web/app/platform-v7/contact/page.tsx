...
export const metadata: Metadata = {
  ...
  description: 'Форма обращения по платформе Прозрачная Цена: публичный разбор сделки, controlled pilot, банковский контур, региональный запуск, роли участников и техническое подключение.',
  alternates: { canonical: 'https://xn----8sbjf4befbjgs9b.xn--p1ai/platform-v7/contact' },
  openGraph: {
    title: 'Задать вопрос — Прозрачная Цена',
    description: 'Связаться по пилоту, подключению организации, банковскому контуру, региональному запуску или техническому взаимодействию с платформой.',
