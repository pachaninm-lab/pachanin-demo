        ...
        <section className='p7-contact-form-card' aria-labelledby='p7-contact-form-title'>
          {sent ? (
            ...
            <form method='post' action='/api/platform-v7/inquiries' className='p7-contact-form' aria-labelledby='p7-contact-form-title'>
              ...
              <label className='p7-contact-full'><span>Сообщение</span><textarea name='message' maxLength={2000} rows={6} placeholder='Опишите вопрос по платформе, пилоту, роли участника, документам, банковскому контуру, региональному запуску или техническому подключению.' required /></label>
