...
const COPY={
ru:{
 e:'Гекта',t:'Гекта',p:'Гекта помогает быстро разобраться в Сделке: собирает доступные факты, показывает блокеры, находит связанные документы и объясняет возможный следующий шаг. Решение принимает человек.',
 ...
 ['Решение','Гекта объясняет варианты, но не выполняет критическое действие сама'],
