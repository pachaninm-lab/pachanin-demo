...
const css = `
.pc-shell-root-v4:has(.p7-deal-flow-page){--pc-header-offset:0px!important;background:#f6faf4!important}.pc-shell-root-v4:has(.p7-deal-flow-page) .pc-v4-header,.pc-shell-root-v4:has(.p7-deal-flow-page) .pc-v4-bottomnav,.pc-shell-root-v4:has(.p7-deal-flow-page) .pc-v4-drawer,.pc-shell-root-v4:has(.p7-deal-flow-page) .pc-v4-pilot-note,.pc-shell-root-v4:has(.p7-deal-flow-page) .pc-v7-role-dock,.pc-shell-root-v4:has(.p7-deal-flow-page) .pc-v7-assistant-widget,.pc-shell-root-v4:has(.p7-deal-flow-page) .p7-mobile-action-rail,.pc-shell-root-v4:has(.p7-deal-flow-page) .p7-mobile-tool-panel{display:none!important}.pc-shell-root-v4:has(.p7-deal-flow-page) .pc-v4-main{max-width:none!important;margin:0!important;padding:0!important;background:#f6faf4!important;min-height:100svh!important}
.p7-deal-flow-page{min-height:100svh;padding:10px clamp(14px,4vw,56px) 42px;color:#071611;background:linear-gradient(180deg,#fbfcf9 0%,#f3f8f1 58%,#fff 100%);font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif}.p7-deal-flow-page *{box-sizing:border-box}.p7-deal-flow-page a{color:inherit;text-decoration:none}.p7-flow-header{position:sticky;top:max(8px,env(safe-area-inset-top));z-index:40;min-height:64px;display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:12px;padding:8px 12px;border:1px solid rgba(7,22,17,.08);border-radius:22px;background:rgba(255,255,255,.98);box-shadow:0 10px 24px rgba(7,22,17,.075);backdrop-filter:blur(18px)}.p7-flow-brand{display:flex;align-items:center;gap:10px;min-width:0}.p7-flow-brand span{min-width:0}.p7-flow-brand strong{display:block;font-size:18px;line-height:1.05;font-weight:950;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.p7-flow-brand small{display:block;color:#61716b;font-size:12px;font-weight:760}.p7-flow-actions{display:flex;gap:8px}.p7-flow-actions a{width:44px;height:44px;display:grid;place-items:center;border-radius:15px;border:1px solid rgba(7,22,17,.1);background:#fff}.p7-flow-hero{max-width:1220px;margin:0 auto;padding:clamp(34px,6vw,84px) 0 28px;display:grid;grid-template-columns:minmax(0,1fr) minmax(320px,.48fr);gap:24px;align-items:stretch}.p7-flow-kicker{display:inline-flex;width:fit-content;margin-bottom:14px;padding:8px 12px;border-radius:999px;background:rgba(0,122,47,.08);color:#087a3b;font-size:11px;font-weight:950;text-transform:uppercase;letter-spacing:.08em}.p7-flow-hero h1{margin:0;max-width:820px;font-size:clamp(42px,6vw,82px);line-height:.96;letter-spacing:-.06em}.p7-flow-hero p,.p7-section-head p,.p7-money-section p,.p7-proof-section p{color:#43514b;font-size:16px;line-height:1.52;font-weight:620}.p7-flow-hero-actions{display:flex;flex-wrap:wrap;gap:10px;margin-top:22px}.p7-flow-hero-actions a{min-height:52px;display:inline-flex;align-items:center;justify-content:center;gap:8px;padding:0 18px;border-radius:17px;border:1px solid rgba(7,22,17,.1);background:#fff;font-weight:950}.p7-flow-hero-actions a:first-child{background:#087a3b;color:#fff;border-color:#087a3b}.p7-flow-status,.p7-stage-card,.p7-role-layer,.p7-money-card{border:1px solid rgba(7,22,17,.08);border-radius:28px;background:rgba(255,255,255,.92);box-shadow:0 18px 44px rgba(7,22,17,.07)}.p7-flow-status{padding:24px;display:grid;gap:10px}.p7-flow-status span,.p7-case-card span{color:#087a3b;font-weight:950;font-size:12px;text-transform:uppercase}.p7-flow-status strong{font-size:28px;line-height:1.08}.p7-flow-status small{color:#61716b;font-weight:800}.p7-flow-section,.p7-money-section,.p7-proof-section{max-width:1220px;margin:20px auto 0}.p7-section-head{display:grid;gap:8px;margin-bottom:16px}.p7-section-head span{color:#087a3b;font-size:12px;font-weight:950}.p7-section-head h2,.p7-money-section h2,.p7-proof-section h2{margin:0;font-size:clamp(30px,4vw,52px);line-height:1;letter-spacing:-.05em}.p7-stage-grid,.p7-role-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px}.p7-stage-card,.p7-role-layer{padding:20px;display:grid;gap:10px}.p7-stage-num{font-size:12px;color:#087a3b;font-weight:950}.p7-stage-card strong,.p7-role-layer strong{font-size:20px;font-weight:950}.p7-stage-card em,.p7-role-layer small{font-style:normal;color:#61716b;font-weight:800}.p7-stage-card p,.p7-role-layer p{margin:0;color:#43514b;font-size:14px;line-height:1.45}.p7-stage-card small{width:fit-content;padding:7px 10px;border-radius:999px;background:rgba(0,122,47,.08);color:#087a3b;font-weight:950}.p7-money-section{display:grid;grid-template-columns:minmax(0,1fr) 320px;gap:16px;align-items:stretch;padding:22px;border-radius:30px;background:linear-gradient(135deg,rgba(0,122,47,.08),rgba(255,255,255,.82));border:1px solid rgba(7,22,17,.08)}.p7-money-card{padding:20px}.p7-money-card strong{display:block;margin-top:8px;font-size:34px}.p7-money-card a{display:inline-flex;margin-top:10px;min-height:42px;align-items:center;justify-content:center;border-radius:14px;background:#087a3b;color:#fff;padding:0 14px;font-weight:950}.p7-proof-section{display:grid;grid-template-columns:minmax(0,.85fr) minmax(300px,.55fr);gap:18px;align-items:start}.p7-proof-section ul{margin:0;padding:0;list-style:none;display:grid;gap:10px}.p7-proof-section li{display:flex;gap:9px;align-items:center;border:1px solid rgba(7,22,17,.08);border-radius:17px;background:#fff;padding:12px;font-weight:850}.p7-proof-section li svg{color:#087a3b;flex:0 0 auto}.p7-flow-footer{max-width:1220px;margin:28px auto 0;display:flex;gap:10px;justify-content:center}.p7-flow-footer a{min-height:44px;display:inline-flex;align-items:center;border-radius:15px;border:1px solid rgba(7,22,17,.1);padding:0 14px;background:#fff;font-weight:950}
@media(max-width:900px){.p7-flow-hero,.p7-money-section,.p7-proof-section{grid-template-columns:1fr}.p7-stage-grid,.p7-role-grid{grid-template-columns:1fr 1fr}}@media(max-width:560px){.p7-deal-flow-page{padding:10px 12px 28px}.p7-flow-header{border-radius:20px}.p7-flow-brand small{display:none}.p7-flow-brand strong{font-size:16px}.p7-flow-actions a{width:40px;height:40px}.p7-flow-hero h1{font-size:39px}.p7-stage-grid,.p7-role-grid{grid-template-columns:1fr}.p7-flow-status,.p7-stage-card,.p7-role-layer,.p7-money-card{border-radius:24px}.p7-money-section{padding:16px}.p7-flow-footer{flex-direction:column}.p7-flow-footer a{justify-content:center}}
`;
