...
const ITEMS = [
  { id: 'N-101', type: 'critical', title: 'DL-9102: выпуск денег заблокирован', note: 'Открыт спор по качеству и не хватает пакета доказательств.', action: '/platform-v7/disputes/DSP-104' },
  { id: 'N-102', type: 'sla', title: 'DL-9107: истекает SLA оператора', note: 'До дедлайна осталось менее 4 часов.', action: '/platform-v7/control-tower' },
  { id: 'N-103', type: 'bank', title: 'CB-441: банк подтвердил release', note: 'Деньги по сделке готовы к финальному отражению.', action: '/platform-v7/bank/events/CB-441' },
  { id: 'N-104', type: 'logistics', title: 'ТМБ-14: водитель подтвердил прибытие', note: 'Можно переходить к приёмке и акту.', action: '/platform-v7/logistics/%D0%A2%D0%9C%D0%91-14' },
  { id: 'N-105', type: 'deal', title: 'LOT-2403: лот переведён в PASS', note: 'Документы и source reference прошли проверку.', action: '/platform-v7/lots/LOT-2403' },
];
