...
const routeDocs = [
  ['ЭТрН', 'транспортный документ', 'ждёт подписи грузополучателя', 'wait'],
...
const driverSummary = [
  { label: 'Что сейчас', value: 'TRIP-SIM-001 · в пути · 62%', note: 'Текущий рейс и ближайшее полевое действие.' },
  { label: 'Куда ехать', value: 'склад продавца → элеватор ВРЖ-08', note: 'Маршрут открыт в Яндекс.Картах. Срок прибытия — 14:28.' },
  ...
  { label: 'Что скрыто', value: 'деньги, предложения, банк, покупатель, кредит', note: 'Полевой кабинет не раскрывает коммерческие и банковские данные.' },
  ...
  return (
    <main style={{ display: 'grid', gap: 14, width: '100%', maxWidth: 760, margin: '0 auto', padding: '4px 0 18px' }}>
      <section style={card}>
        ...
        <p style={lead}>Водитель видит только свой рейс, маршрут, транспортные документы и полевые действия. Деньги, предложения, банк, покупатель и кредит скрыты.</p>
        <div style={grid4}>
          <Info label='Рейс' value='TRIP-SIM-001' />
          <Info label='Контур' value='только перевозка' />
          <Info label='Статус' value='В пути · 62%' accent />
          <Info label='Срок прибытия' value='14:28' />
        </div>
      </section>
      ...
      <section style={darkCard}>
        <div style={{ display: 'grid', gap: 6 }}>
          ...
          <h2 style={{ margin: 0, color: '#fff', fontSize: 'clamp(24px,6vw,34px)', lineHeight: 1.08, letterSpacing: '-0.04em', fontWeight: 950 }}>Текущий рейс и следующее действие</h2>
          <p style={{ margin: 0, color: '#CBD5E1', fontSize: 14, lineHeight: 1.55 }}>Один рейс, один маршрут, одно следующее действие. Никаких предложений, денег, банка, покупателя и кредитных сценариев.</p>
        </div>
      ...
      <section style={card}>
        ...
        <div style={mapBox}>
          ...
          <div style={mapStatus}>62% пути · прибытие 14:28</div>
        </div>
      </section>
