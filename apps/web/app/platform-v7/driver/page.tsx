...
const routeDocs = [
  ['ЭТрН', 'ЭТрН', 'ждёт подписи грузополучателя', 'wait'],
...
const driverSummary = [
  ...
  { label: 'Куда ехать', value: 'склад продавца → элеватор ВРЖ-08', note: 'Маршрут открыт в Яндекс.Картах, прибытие — 14:28.' },
    ...
    <main style={{ display: 'grid', gap: 14, width: '100%', maxWidth: 760, margin: '0 auto', padding: '4px 0 18px' }}>
      <section style={card}>
        ...
        <div style={grid4}>
          ...
          <Info label='Прибытие' value='14:28' />
        </div>
      </section>
