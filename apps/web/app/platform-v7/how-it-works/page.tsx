...
const COPY={
ru:{
 e:'Как проходит Сделка',t:'Как проходит Сделка',p:'Семь этапов: от публикации лота до расчёта, закрытия или спора. На каждом этапе видно, кто отвечает, какие документы нужны и что влияет на следующий шаг.',
 ...
 ['Торги','Продавец · Покупатель','Ставки и зафиксированный результат торгов','Правила торгов и подтверждённый результат торгов','Фиксируются экономические условия будущей Сделки','Перейти к обязательствам сторон'],
 ...
 ['Доставка','Логистика · Водитель','Рейс, маршрут и фактическое исполнение','Разрешённые действия логистической роли и события доставки','Доставка сама по себе не подтверждает финансовое событие и не меняет статус расчёта','Передать факт на приёмку'],
...
en:{
 e:'How the Deal works',t:'Seven stages from listing to settlement, closure or dispute.',p:'At every stage, the user can see who is responsible, which facts and documents are required, and what affects settlement.',
 ...
 ['Trading','Seller · Buyer','Bids and confirmed trading result','Trading rules and confirmed trading result','Economic terms of the future Deal are fixed','Move to commitments'],
 ...
 ['Delivery','Logistics · Driver','Trip, route and execution facts','Authorised logistics actions and delivery events','Delivery alone does not confirm a financial event or change settlement status','Pass confirmed facts to acceptance'],
...
zh:{
 e:'交易如何进行',t:'七个阶段：从发布批次到结算、关闭或争议。',p:'每个阶段都会显示负责人、所需事实与文件，以及对结算的影响。',
 actor:'参与方',fact:'事实',basis:'依据',money:'结算影响',next:'下一步',
 stages:[
 ['批次','卖方','商品的公开和非公开参数','已确认的批次数据和机构权限','尚未形成结算依据','允许批次进入授权交易流程'],
 ['交易','卖方 · 买方','报价和已确认交易结果','交易规则和已确认的交易结果','固定未来交易的经济条件','进入义务阶段'],
 ['义务','卖方 · 买方','条件、角色和责任','已同意条件和已确认权限','明确影响未来金融步骤的条件','启动履约'],
 ['交付','物流 · 司机','运输、路线和履约事实','获授权物流操作和交付事件','仅完成交付不会确认金融事件，也不会改变结算状态','将确认事实传递到验收'],
