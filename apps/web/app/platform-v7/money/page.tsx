...
const COPY: Record<Locale, MoneyCopy> = {
  ru: {
    ...
    description: 'Выбери серверно доступную Сделку. Только в её контексте можно безопасно различить резерв, удержание, сумму к запросу, банковское подтверждение и сверку.',
    status: 'денежный статус подтверждает сервер',
    priorityTitle: 'Открой Сделку с денежным обязательством',
