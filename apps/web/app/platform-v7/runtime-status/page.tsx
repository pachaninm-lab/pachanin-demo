...
const ITEMS = [
  {
    ...
    note: 'Резерв, удержание и проверка выплаты доступны, но финальный выпуск всё ещё зависит от блокеров сделки.',
  ...
  },
  {
    ...
    note: 'Транспортные документы уже участвуют в логике остановки и проверки выплаты.',
