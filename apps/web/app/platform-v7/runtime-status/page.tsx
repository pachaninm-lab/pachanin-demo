...
const ITEMS = [
  {
    ...
    note: 'Резерв, hold и банковское подтверждение видны как статусы, но финальное решение зависит от блокеров сделки.',
    accent: { bg: 'rgba(10,122,95,0.08)', border: 'rgba(10,122,95,0.18)', color: '#0A7A5F' },
  },
  {
    title: 'Документный контур',
    state: 'Требует контроля',
    note: 'Неполный пакет документов должен сразу останавливать передачу основания банку.',
    accent: { bg: 'rgba(217,119,6,0.08)', border: 'rgba(217,119,6,0.18)', color: '#B45309' },
  },
  {
    title: 'Регуляторный gate',
    state: 'Ручная проверка',
    note: 'Связка с ФГИС и ЕСИА не должна маскироваться под активную интеграцию без внешнего подтверждения.',
    accent: { bg: 'rgba(71,85,105,0.08)', border: 'rgba(71,85,105,0.18)', color: '#334155' },
  },
  {
    title: 'Транспортный пакет',
    state: 'Влияет на деньги',
    note: 'Транспортные документы участвуют в stop/hold логике сделки и банковского основания.',
