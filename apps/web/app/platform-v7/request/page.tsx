...
export const metadata: Metadata = {
  ...
  description: 'Отдельная страница заявки на демонстрацию, пилотный проект, подключение организации, банковское взаимодействие или региональный запуск платформы Прозрачная Цена.',
  alternates: {
