...
const gates = [
  { title: 'Резерв', value: 'подтверждён', note: 'Деньги зарезервированы, но не передаются к банковскому шагу без закрытых условий.', href: '/platform-v7/bank/grain', tone: 'good' },
  ...
  { title: 'Банковский шаг', value: 'закрыт', note: 'Ручная банковская проверка основания запрещена до выполнения условий сделки.', href: '/platform-v7/deals/grain-release', tone: 'stop' },
] as const;
  ...
  return (
    <main style={{ display: 'grid', gap: 14, padding: '4px 0 24px' }}>
      <section style={card}>
        ...
        <p style={lead}>Расчёт показывает, почему деньги ещё не могут перейти к банковскому шагу: какие условия закрыты, какие удерживают сумму и какое действие должно быть следующим.</p>
        <div style={actions}>
      ...
      <section style={darkCard}>
        ...
        <p style={{ margin: 0, color: '#CBD5E1', fontSize: 14, lineHeight: 1.55 }}>Любой банковский шаг или удержание должны ссылаться на документ, событие рейса, акт, протокол или решение. Без основания действие не проводится и фиксируется как заблокированное.</p>
      </section>
    </main>
  );
}
