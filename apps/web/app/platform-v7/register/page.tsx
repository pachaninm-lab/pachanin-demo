    ...
    <main className='p7-register-page' style={pageShell}>
      ...
      <section style={card} aria-label='Статусы проверки заявки'>
        ...
        <p style={{ margin: 0, fontSize: 12.5, color: '#66758A', lineHeight: 1.5 }}>
          Текущий статус заявки и причина уточнения видны участнику после отправки. Проверка участника — часть предынтеграционного контура; внешние подтверждения ожидают подключения.
        </p>
      </section>
