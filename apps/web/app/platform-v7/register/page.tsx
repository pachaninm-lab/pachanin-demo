...
type PublicRegistrationIntent = 'sell' | 'buy' | 'execution' | 'finance' | 'employee';
...
const WORKSPACE_BY_INTENT: Partial<Record<PublicRegistrationIntent, PublicWorkspace>> = {
  sell: 'seller', buy: 'buyer', finance: 'bank', employee: 'employee',
};
const PAGE_COPY = {
  ru: {
    ...
    employeeEntry: 'Присоединиться к организации',
  ...
  en: {
    ...
    employeeEntry: 'Join an existing organisation',
...
function registrationIntent(value: string | undefined): PublicRegistrationIntent | null {
  return value === 'sell' || value === 'buy' || value === 'execution' || value === 'finance' || value === 'employee' ? value : null;
}
