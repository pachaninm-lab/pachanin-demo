...
const SERVICES = [
  {
    ...
    incidents: ['Проверить доступ к внешнему контуру', 'Сверить партию и расхождения по приёмке'],
  },
  {
    id: 'bank',
  ...
  },
  {
    ...
    status: 'test_mode',
    uptime: 'Контур',
    note: 'Качество и протоколы отражены как сценарий внутреннего контура. Часть данных требует ручного сопровождения.',
    ...
    <div style={{ display: 'grid', gap: 16, maxWidth: 1040, margin: '0 auto' }}>
      <section style={{ background: '#fff', border: '1px solid var(--pc-border, #E4E6EA)', borderRadius: 18, padding: 18 }}>
        ...
        <div style={{ marginTop: 8, fontSize: 13, color: 'var(--pc-text-muted, #6B778C)', lineHeight: 1.7 }}>
          Честный статус интеграций и внешних контуров. Здесь видно: что собрано в интерфейсе, что требует ручной проверки, а что ждёт договоров, доступов и внешней сверки.
        </div>
      </section>
