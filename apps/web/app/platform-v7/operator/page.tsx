...
const STATIC_BLOCKERS = [
  ...
  { deal: 'DL-9106', lot: 'LOT-2403', reason: 'Протокол качества ожидается', source: 'лабораторный контур', amount: '9,65 млн ₽', owner: 'лаборатория', next: 'получить протокол качества', href: '/platform-v7/elevator', severity: 'wait' as const },
...
export default function PlatformV7OperatorPage() {
  ...
  return (
    <main style={{ display: 'grid', gap: 14, padding: '4px 0 24px' }}>
      <section style={hero}>
        <div style={badge}>Центр управления оператора · пилотный контур · ручная проверка</div>
      ...
      <section style={metricsGrid}>
        ...
        <Metric label='Удержано по спорам' value='15,89 млн ₽' danger />
      </section>
