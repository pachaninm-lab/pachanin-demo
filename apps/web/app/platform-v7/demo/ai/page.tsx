...
export const metadata: Metadata = {
  ...
  description: 'Интерактивный анимированный разбор: как ИИ собирает разрешённые факты сделки, выявляет риск, объясняет причину и готовит следующий шаг под подтверждением участника.',
  alternates: {
    canonical: '/platform-v7/demo/ai',
    languages: {
      ru: '/platform-v7/demo/ai?lang=ru',
      en: '/platform-v7/demo/ai?lang=en',
      zh: '/platform-v7/demo/ai?lang=zh',
    },
  },
  robots: {
    index: true,
  ...
  openGraph: {
    title: 'Как ИИ работает в платформе — Прозрачная Цена',
    description: 'Интерактивный показ ролевого ИИ: факты, риск, объяснение, следующий шаг и подтверждение человека.',
    url: 'https://xn----8sbjf4befbjgs9b.xn--p1ai/platform-v7/demo/ai',
