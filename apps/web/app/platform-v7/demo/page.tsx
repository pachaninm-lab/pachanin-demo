...
const FLOW_STEPS = [
  ...
  { title: 'Запросить резерв', role: 'Банк', status: 'запрос отправлен', blocker: 'ответ банка ожидается', impact: 'банковская проверка выплаты ещё невозможна', href: '/platform-v7/bank', cta: 'Открыть банк' },
  { title: 'Подтвердить резерв', role: 'Банк', status: 'резерв подтверждён в тестовом сценарии', blocker: 'требуются логистика и документы', impact: 'резерв виден в денежном контуре сделки', href: '/platform-v7/bank', cta: 'Открыть деньги' },
  ...
  { title: 'Закрыть рейс', role: 'Водитель', status: 'рейс проходит field-события', blocker: 'фото, GPS, пломба и вес должны быть отправлены', impact: 'без закрытия рейса банковская проверка выплаты блокируется', href: '/platform-v7/driver/field', cta: 'Открыть рейс водителя' },
  ...
  { title: 'Выпуск или удержание', role: 'Банк', status: 'банк получил основание', blocker: 'спор или ручная проверка могут остановить выпуск', impact: 'банк подтверждает выплату или удержание', href: '/platform-v7/bank', cta: 'Открыть банковскую проверку' },
  ...
  { title: 'Закрыть по доказательствам', role: 'Арбитр / оператор', status: 'решение требует основания', blocker: 'без причины спор не закрывается', impact: 'решение объясняет влияние на удержание и выплату', href: '/platform-v7/disputes', cta: 'Открыть доказательства' },
] as const;
