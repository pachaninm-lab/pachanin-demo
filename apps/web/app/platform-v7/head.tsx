...
const pageDescription = 'Товар, логистика, качество, документы, расчёт и спор связаны в одной Сделке. Гекта показывает блокеры и доступные действия по данным Сделки.';
const taiDescription = 'Гекта — цифровой помощник для земли, урожая и агробизнеса. Он разбирает данные Сделки, документы, логистику, качество, расчёт и риски.';
...
const platformDescription = '«Прозрачная Цена» связывает цену, участников, логистику, качество, документы, расчёт и спор в одной Сделке. Внешние системы подключаются через отдельные управляемые интеграции.';
