  ...
  return (
    <main style={{ display: 'grid', gap: 14, padding: '4px 0 24px' }}>
      <section style={card}>
        ...
        <p style={lead}>Арбитр видит только доказательный пакет: акт осмотра, протокол качества, вес, документы, комментарии сторон и рекомендуемое решение. Ручной банковский шаг недоступен.</p>
        <div style={actions}>
          ...
          <Link href='/platform-v7/deals/grain-release' style={ghostBtn}>Условия банковского основания</Link>
        </div>
      </section>
