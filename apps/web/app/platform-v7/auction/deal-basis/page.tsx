  ...
  return (
    <main style={{ display: 'grid', gap: 16 }}>
      <section style={{ border: '1px solid var(--pc-border)', background: 'var(--pc-shell-surface)', borderRadius: 22, padding: 18, boxShadow: 'var(--pc-shadow-sm)', display: 'grid', gap: 10 }}>
        ...
        <p style={{ margin: 0, maxWidth: 780, fontSize: 14, lineHeight: 1.55, color: 'var(--pc-text-secondary)' }}>После победившей ставки платформа создаёт основание сделки: партия ФГИС, СДИЗ, покупатель, продавец, цена, объём, базис, документы и следующий банковский шаг.</p>
      </section>
