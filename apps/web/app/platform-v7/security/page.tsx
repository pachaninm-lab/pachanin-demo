...
const SECTIONS = [
  ...
  {
    title: 'Контур денег',
    body: 'Деньги не должны идти раньше документов и подтверждённых событий. Банковское подтверждение привязано к банку, документам и состоянию спора. Если есть blocker, основание останавливается.',
  },
  {
    title: 'Честная стадия зрелости',
    body: 'Система находится в проверочной стадии с сопровождением. Часть интеграций требует внешнего подтверждения, часть ещё работает в режиме ручной проверки.',
  },
];

const CHECKS = [
  'Контроль ролей и доступов',
  'Блокировка банковского основания при открытом споре',
  'Проверка обязательных документов перед банковским подтверждением',
...
const CONTROL_MODULES = [
  {
    ...
    note: 'Резерв, factor/escrow и transport gate вынесены в отдельный контролируемый модуль.',
    ...
    <div style={{ display: 'grid', gap: 16, maxWidth: 1040, margin: '0 auto' }}>
      <section style={{ background: '#fff', border: '1px solid #E4E6EA', borderRadius: 18, padding: 18 }}>
        ...
        <div style={{ marginTop: 8, fontSize: 13, color: '#6B778C', lineHeight: 1.7 }}>
          Это не декларация “всё закрыто”, а понятное описание того, как платформа снижает риск ошибок, спорности и ранней передачи неполного основания банку.
        </div>
      </section>
