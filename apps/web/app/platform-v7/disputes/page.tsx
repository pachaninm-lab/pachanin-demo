  ...
  return (
    <main style={{ display: 'grid', gap: 14, padding: '4px 0 24px' }}>
      <section style={hero}>
        ...
        <h1 style={h1}>Спор должен объяснять, почему деньги не выпущены</h1>
        <p style={lead}>Здесь собраны причины удержания, сумма влияния, ответственный и доказательства. Спор не закрывается без решения, суммы и основания.</p>
        <div style={actions}>
