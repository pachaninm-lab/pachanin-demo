...
ru:{
 ...
 lead:'«Прозрачная Цена» связывает рынок и исполнение в одной Сделке. Каждый участник работает в своём подтверждённом контексте, а критическое действие остаётся связано с полномочиями, основанием, источником и решением.',
 ...
 ['9 ролей','Участник видит только тот рабочий контекст, который разрешён его серверно подтверждённым полномочиям.'],
 ['7 этапов','Путь Сделки одинаков в публичном объяснении и рабочем контуре — меняются только доступные действия и факты.'],
...
zh:{
 ...
 lead:'“透明价格”把市场和履约连接在同一笔交易中。每个参与方都在已确认上下文中工作，而关键操作始终与权限、依据、来源和决定关联。',
 domain:'Процент-Агро.рф 是“透明价格”平台的公开域名。',
 what:'平台连接什么',cards:[
 ['一笔交易','商品、交易、义务、交付、质量、文件、结算和关闭保持关联。'],
 ['9 个角色','参与方只看到服务器确认权限允许的工作上下文。'],
 ['7 个阶段','公开说明与工作上下文使用同一交易路径；不同的是可见事实和允许操作。'],
