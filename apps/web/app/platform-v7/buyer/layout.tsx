...
const buyerSteps = [
  { label: 'Лот', value: 'выбор товара', href: '/platform-v7/lots' },
  { label: 'Ставка', value: 'цена и условия', href: '/platform-v7/buyer' },
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', gap: 16, flexWrap: 'wrap', alignItems: 'flex-start' }}>
          <div style={{ display: 'grid', gap: 9, maxWidth: 840 }}>
            <div style={{ display: 'inline-flex', width: 'fit-content', padding: '7px 11px', borderRadius: 999, background: 'rgba(10,122,95,0.08)', border: '1px solid rgba(10,122,95,0.18)', color: '#0A7A5F', fontSize: 12, fontWeight: 900 }}>
              Покупательский контур сделки
            </div>
            <h1 style={{ margin: 0, fontSize: 'clamp(30px, 4.8vw, 52px)', lineHeight: 1.04, letterSpacing: '-0.045em', color: '#0F1419', fontWeight: 950 }}>
              Ставка должна сразу вести к сделке, резерву денег и логистике
            </h1>
            <p style={{ margin: 0, color: '#475569', fontSize: 15, lineHeight: 1.7 }}>
              Покупатель должен видеть не каталог, а путь исполнения: какой лот выбран, какие условия предложены, создана ли сделка, где деньги и что мешает получению груза.
            </p>
          </div>
          <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
            <Link href='/platform-v7/lots' style={primary}>Открыть лоты</Link>
