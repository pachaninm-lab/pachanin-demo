...
export default async function PlatformV7MarketPage({ searchParams }: { searchParams?: Promise<Params> }) {
  ...
  const c = locale === 'ru'
    ? {e:'Продажа и закупка',t:'Рынок продукции растениеводства',p:'Выберите культуру для продажи или закупки. Опубликованные предложения можно отобрать по региону, классу и цене.',offers:'Опубликованные предложения',search:'Культура, класс или регион',query:'Поиск',filters:'Фильтры',activeFilters:'Применённые фильтры',crop:'Культура',region:'Регион',regionHint:'Например, Тамбовская область',grade:'Класс / сорт',gradeHint:'Например, 3 класс',sort:'Сортировка',apply:'Применить',reset:'Сбросить фильтры',remove:'Убрать фильтр',path:'От лота до завершения сделки'}
    : locale === 'en'
      ? {e:'Sale and purchase',t:'Crop market',p:'Choose a crop to sell or buy. Filter published offers by region, grade and price.',offers:'Published offers',search:'Crop, grade or region',query:'Search',filters:'Filters',activeFilters:'Applied filters',crop:'Crop',region:'Region',regionHint:'For example, Tambov Region',grade:'Grade',gradeHint:'For example, grade 3',sort:'Sort',apply:'Apply',reset:'Reset filters',remove:'Remove filter',path:'From a lot to a completed Deal'}
      : {e:'销售与采购',t:'农产品市场',p:'选择要销售或采购的作物，按地区、等级和价格筛选已发布的供求信息。',offers:'已发布的供求信息',search:'作物、等级或地区',query:'搜索',filters:'筛选',activeFilters:'已应用筛选',crop:'作物',region:'地区',regionHint:'例如：坦波夫州',grade:'等级',gradeHint:'例如：3 级',sort:'排序',apply:'应用',reset:'重置筛选',remove:'移除筛选',path:'从批次到交易完成'};
