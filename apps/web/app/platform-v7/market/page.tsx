...
const TRENDS = [
  ...
  { title: '90 дней', note: 'Средний тренд для оценки базиса и времени сделки.', values: ['13.2', '13.5', '13.8', '14.1', '14.5'] },
    ...
    <div style={{ display: 'grid', gap: 16, maxWidth: 1080, margin: '0 auto' }}>
      <section style={{ background: '#fff', border: '1px solid #E4E6EA', borderRadius: 18, padding: 18 }}>
        ...
        <div style={{ marginTop: 8, fontSize: 13, color: '#6B778C', lineHeight: 1.7 }}>
          Рабочий ценовой слой для переговоров и принятия решений. Не просто график ради графика, а полезный контекст: культура, регион, базис, направление и динамика.
        </div>
      </section>
