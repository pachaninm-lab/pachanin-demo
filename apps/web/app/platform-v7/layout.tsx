...
@media (max-width:767px){
  html body .pc-shell-root-v4 .pc-v4-header-inner{position:relative!important;overflow:visible!important;padding:calc(env(safe-area-inset-top) + 7px) 8px 7px!important}
  html body .pc-shell-root-v4 .pc-v4-top{display:grid!important;grid-template-columns:38px 42px minmax(0,1fr)!important;gap:6px!important;align-items:center!important;inline-size:100%!important;max-inline-size:100%!important;min-block-size:42px!important;overflow:visible!important}
