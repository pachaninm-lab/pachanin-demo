...
@media (max-width:767px){
  ...
  html body .pc-shell-root-v4 .pc-v4-top>button[aria-label='Открыть меню']{grid-column:1!important;display:inline-flex!important;visibility:visible!important;opacity:1!important}
  html body .pc-shell-root-v4 .pc-v4-brand{grid-column:2!important;display:inline-flex!important;inline-size:48px!important;min-inline-size:48px!important;max-inline-size:48px!important;block-size:44px!important;align-items:center!important;justify-content:center!important;overflow:visible!important;visibility:visible!important;opacity:1!important}
  html body .pc-shell-root-v4 .pc-v4-brand>span[aria-hidden]{display:inline-flex!important;inline-size:42px!important;min-inline-size:42px!important;max-inline-size:42px!important;block-size:42px!important;min-block-size:42px!important;max-block-size:42px!important;flex:0 0 42px!important;visibility:visible!important;opacity:1!important;overflow:visible!important}
  ...
  html body .pc-shell-root-v4 .pc-v4-actions{grid-column:3!important;position:static!important;display:flex!important;flex-wrap:nowrap!important;align-items:center!important;justify-content:flex-end!important;gap:4px!important;inline-size:100%!important;max-inline-size:100%!important;min-inline-size:0!important;overflow:visible!important;visibility:visible!important;opacity:1!important}
  ...
  html body .pc-shell-root-v4 .pc-v4-search,html body .pc-shell-root-v4 .pc-v4-theme-toggle,html body .pc-shell-root-v4 .p7-note-widget,html body .pc-shell-root-v4 .pc-v7-notice-wrap,html body .pc-shell-root-v4 .p7-role-support,html body .pc-shell-root-v4 .p7-calc-widget,html body .pc-shell-root-v4 .pc-v7-logout-btn{display:inline-flex!important;flex:0 0 35px!important;inline-size:35px!important;min-inline-size:35px!important;max-inline-size:35px!important;block-size:35px!important;min-block-size:35px!important;visibility:visible!important;opacity:1!important}
  html body .pc-shell-root-v4 .pc-v4-search{order:10!important}html body .pc-shell-root-v4 .pc-v4-theme-toggle{order:20!important}html body .pc-shell-root-v4 .p7-note-widget{order:30!important}html body .pc-shell-root-v4 .pc-v7-notice-wrap{order:40!important;position:relative!important}html body .pc-shell-root-v4 .p7-role-support{order:50!important}html body .pc-shell-root-v4 .p7-calc-widget{order:60!important}html body .pc-shell-root-v4 .pc-v7-logout-btn{order:100!important}
  html body .pc-shell-root-v4 .pc-v4-search,html body .pc-shell-root-v4 .pc-v4-theme-toggle,html body .pc-shell-root-v4 .p7-note-widget .pc-v4-iconbtn,html body .pc-shell-root-v4 .pc-v7-notice-wrap .pc-v4-iconbtn,html body .pc-shell-root-v4 .p7-role-support.pc-v4-iconbtn,html body .pc-shell-root-v4 .pc-v7-logout-btn,html body .pc-shell-root-v4 .p7-calc-widget .pc-v4-iconbtn{display:inline-flex!important;inline-size:35px!important;min-inline-size:35px!important;max-inline-size:35px!important;block-size:35px!important;min-block-size:35px!important;border-radius:12px!important;padding:0!important;align-items:center!important;justify-content:center!important}
  html body .pc-shell-root-v4 .pc-v4-search strong,html body .pc-shell-root-v4 .pc-v4-search span{display:none!important}
  html body .pc-shell-root-v4 .pc-v7-notice-panel,html body .pc-shell-root-v4 .p7-note-panel,html body .pc-shell-root-v4 .p7-calc-panel{position:fixed!important;left:10px!important;right:10px!important;top:calc(env(safe-area-inset-top) + 58px)!important;width:auto!important;max-width:none!important;z-index:900!important}
...
@media (max-width:374px){
  html body .pc-shell-root-v4 .pc-v4-top{grid-template-columns:38px 42px minmax(0,1fr)!important;gap:5px!important}
  html body .pc-shell-root-v4 .pc-v4-search,html body .pc-shell-root-v4 .pc-v4-theme-toggle,html body .pc-shell-root-v4 .p7-note-widget,html body .pc-shell-root-v4 .pc-v7-notice-wrap,html body .pc-shell-root-v4 .p7-role-support,html body .pc-shell-root-v4 .pc-v7-logout-btn,html body .pc-shell-root-v4 .p7-calc-widget,html body .pc-shell-root-v4 .p7-note-widget .pc-v4-iconbtn,html body .pc-shell-root-v4 .pc-v7-notice-wrap .pc-v4-iconbtn,html body .pc-shell-root-v4 .p7-role-support.pc-v4-iconbtn,html body .pc-shell-root-v4 .p7-calc-widget .pc-v4-iconbtn{flex-basis:32px!important;inline-size:32px!important;min-inline-size:32px!important;max-inline-size:32px!important;block-size:32px!important;min-block-size:32px!important}
}
`;
