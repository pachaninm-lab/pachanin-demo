...
const copy: Record<AppLocale, PublicProductEntryVariantsCopy> = {
  ru: {
    ...
    role: {
      ...
      options: [
        { id: 'sell', label: 'Я продаю', description: 'Товар, условия, поставка, документы и основания расчёта.', perspective: 'seller', lens: 'participants' },
    ...
    problem: {
      ...
      options: [
        { id: 'progress', label: 'Как проходит Сделка', description: 'Текущий этап, ответственный, блокер и следующий переход.', lens: 'execution' },
  ...
  en: {
    ...
    role: {
      ...
      options: [
        { id: 'sell', label: 'I sell', description: 'Product, terms, delivery, documents and settlement grounds.', perspective: 'seller', lens: 'participants' },
    ...
    problem: {
      ...
      options: [
        { id: 'progress', label: 'How the Deal is progressing', description: 'Current stage, responsible party, blocker and next transition.', lens: 'execution' },
  ...
  zh: {
    ...
    role: {
      ...
      options: [
        { id: 'sell', label: '我要出售', description: '商品、条件、交付、文件和结算依据。', perspective: 'seller', lens: 'participants' },
    ...
    problem: {
      ...
      options: [
        { id: 'progress', label: '交易如何推进', description: '当前阶段、责任方、阻塞项和下一步。', lens: 'execution' },
