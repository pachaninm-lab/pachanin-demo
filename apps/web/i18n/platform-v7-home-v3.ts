...
const ru = {
  ...
  category: {
    ...
    title: 'Платформа не заканчивается после выбора цены',
  ...
  money: {
    ...
    title: 'Выплата опирается на подтверждённые события',
  ...
  federal: {
    ...
    title: 'Критические действия имеют проверяемое основание',
  ...
  final: { title: 'Подключите организацию к единому контуру Сделки', lead: 'Начните с рабочего сценария. Платформа свяжет участников, исполнение, документы и расчёты без разрыва между системами.', primary: 'Начать подключение', secondary: 'Посмотреть Сделку в работе' },
