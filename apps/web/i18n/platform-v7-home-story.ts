...
const copies = {
  ru: {
    ...
    trust: {
      ...
      headers: ['Система', 'Сценарий', 'Честная граница', 'Публичный статус'],
      integrations: [
        {
          system: 'ERP / 1С',
      ...
      ladder: ['Реализовано', 'Проверено', 'Интегрировано', 'Подключено', 'Эксплуатируется', 'Измерен эффект'],
  ...
  en: {
    ...
    difference: {
      ...
      headers: ['Criterion', 'Typical catalogue / marketplace', 'Transparent Price'],
      rows: [
        {
    ...
    demo: {
      ...
      stages: ['Terms', 'Party selection', 'Obligations', 'Delivery', 'Acceptance', 'Settlement and closure'],
      states: [
        {
          key: 'normal',
          tab: 'Normal',
    ...
    trust: {
      ...
      headers: ['System', 'Scenario', 'Honest boundary', 'Public status'],
      integrations: [
        {
          system: 'ERP / 1C',
      ...
      ladder: ['Implemented', 'Verified', 'Integrated', 'Connected', 'In production use', 'Measured impact'],
  ...
  zh: {
    ...
    demo: {
      ...
      role: '买方',
      stageLabel: '交易阶段',
      stages: ['条件', '选择交易方', '义务', '交付', '验收', '结算与关闭'],
      states: [
        {
          key: 'normal',
          tab: '正常',
    ...
    trust: {
      ...
      ladderTitle: '证据等级',
      ladder: ['已实现', '已验证', '已集成', '已接入', '生产使用中', '效果已测量'],
