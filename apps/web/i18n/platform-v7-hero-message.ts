...
const messages: Record<'ru' | 'en' | 'zh', PlatformV7HeroMessage> = {
  ru: {
    ...
    lead: '«Прозрачная Цена» ведёт одну агросделку от товара и торгов до поставки, качества, документов и расчёта. Каждый участник видит свою ответственность, доступные факты и основания и что делать дальше. Гекта помогает разобрать факты и риск, но не принимает решение вместо человека.',
  },
  en: {
