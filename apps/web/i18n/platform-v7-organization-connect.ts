...
const ru: OrganizationConnectCopy = {
  ...
  title: 'Уточните вопрос до регистрации',
  lead: 'Оставьте данные организации и рабочий вопрос, если перед регистрацией нужно уточнить роль, сценарий или подключение.',
  stepOne: 'Шаг 1 из 2', stepTwo: 'Шаг 2 из 2',
  stepOneTitle: 'Организация и контакт', stepTwoTitle: 'Роль и рабочий сценарий',
  ...
  consent: 'Я согласен на обработку указанных данных для ответа на обращение.',
  submit: 'Отправить обращение', submitting: 'Отправляем…', call: 'Обсудить по телефону',
  note: 'Обращение не создаёт аккаунт и не предоставляет доступ к платформе. Для доступа используется отдельная регистрация и проверка организации.',
  required: 'Проверь обязательные поля текущего шага.',
  successTitle: 'Обращение принято', successText: 'Мы рассмотрим вопрос и свяжемся по указанным контактам.', requestLabel: 'Номер заявки', replayText: 'Повторная отправка распознана: новая заявка не создана.',
...
const en: OrganizationConnectCopy = {
  ...
  title: 'Clarify your question before registering',
  lead: 'Share the organisation details and your working question if you need to clarify a role, scenario or connection before registration.',
  stepOne: 'Step 1 of 2', stepTwo: 'Step 2 of 2',
  stepOneTitle: 'Organisation and contact', stepTwoTitle: 'Role and operating scenario',
  ...
  consent: 'I consent to processing the supplied data to answer this request.', submit: 'Send request', submitting: 'Submitting…', call: 'Discuss by phone',
  note: 'This request does not create an account or grant platform access. Access uses a separate registration and organisation verification process.', required: 'Check the required fields in this step.',
  successTitle: 'Request received', successText: 'We will review the question and contact you using the supplied details.', requestLabel: 'Request number', replayText: 'The repeated submission was recognised; no duplicate request was created.',
...
const zh: OrganizationConnectCopy = {
  eyebrow: '注册前帮助',
  title: '注册前先确认你的问题',
  lead: '如果注册前需要确认角色、场景或接入方式，请留下机构信息和具体问题。',
  stepOne: '第 1 步，共 2 步', stepTwo: '第 2 步，共 2 步',
  stepOneTitle: '机构与联系人', stepTwoTitle: '角色与运营场景',
  continue: '继续', back: '返回',
  organization: '机构', inn: '税号', name: '姓名', position: '职务', phone: '电话', email: '邮箱', role: '机构角色', scenario: '关注场景',
  consent: '我同意为回复本次咨询而处理所填写的数据。', submit: '发送咨询', submitting: '正在提交…', call: '电话沟通',
  note: '本次咨询不会创建账户，也不会授予平台访问权限。访问平台需另行完成注册和机构审核。', required: '请检查当前步骤的必填字段。',
  successTitle: '咨询已收到', successText: '我们会查看问题并通过所填写的联系方式联系你。', requestLabel: '申请编号', replayText: '系统识别到重复提交，未创建重复申请。',
