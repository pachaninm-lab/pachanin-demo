...
const ru: OrganizationConnectCopy = {
  ...
  jsRequired: 'Без JavaScript публичная форма заблокирована, чтобы персональные данные не попали в URL или неподтверждённый канал.',
  protectedContinue: 'Перейти в защищённую регистрацию',
...
const en: OrganizationConnectCopy = {
  ...
  jsRequired: 'Without JavaScript the public form is locked so personal data cannot enter the URL or an unverified channel.',
  protectedContinue: 'Continue in protected registration',
...
const zh: OrganizationConnectCopy = {
  ...
  jsRequired: '未启用 JavaScript 时公开表单会被锁定，避免个人数据进入网址或未经验证的通道。',
  protectedContinue: '进入受保护的注册流程',
