...
const scenarios: Record<Locale, Record<RoleKey, RoleScenario>> = {
  ru: {
    ...
    employee: { label: 'Сотрудник подключённой организации', lens: 'Только данные и действия, относящиеся к его организации, назначенной роли и конкретной Сделке.', responsibility: 'Выполнять действия организации в пределах предоставленных полномочий.', money: 'Видеть только относящиеся к своей роли расчётные основания без права распоряжаться средствами вне полномочий.' },
  },
  en: {
    ...
    employee: { label: 'Employee of a connected organisation', lens: 'Only data and actions related to the employee’s organisation, assigned role and specific Deal.', responsibility: 'Act for the organisation within granted authority.', money: 'See only role-relevant settlement grounds without authority over funds outside granted permissions.' },
  },
  zh: {
    ...
    employee: { label: '已接入机构员工', lens: '仅查看与其机构、已分配角色和具体交易相关的数据与操作。', responsibility: '仅在机构授予的角色和权限范围内执行操作。', money: '仅查看与其角色相关的结算依据，不得超越授权支配资金。' },
  },
};
