const SYSTEMS = [
  { title: 'Банк', status: 'Ожидается ответ', note: 'Показан тестовый ответ вместо боевого банковского подключения.', next: 'Оператор должен открыть проверку банковской проверки выплаты.' },
