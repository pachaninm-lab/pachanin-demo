...
const pathnameMock = vi.fn(() => '/platform-v7');
...
describe('PlatformV7LeadCapture', () => {
  it('renders the homepage lead form with CRM-ready fields', () => {
    ...
    expect(screen.getByDisplayValue('homepage_lead_form')).toHaveAttribute('name', 'source');
  ...
  it('does not render outside the public platform homepage', () => {
    pathnameMock.mockReturnValue('/platform-v7/support');
