    ...
    <section id='lead-request' className='p7-lead-capture' aria-labelledby='p7-lead-title'>
      <div className='p7-lead-copy'>
        ...
        <div className='p7-lead-proof' aria-label='Что будет после заявки'>
          <span><CheckCircle2 size={17} /> источник обращения фиксируется</span>
          <span><CheckCircle2 size={17} /> контакт передаётся в CRM-контур</span>
          <span><CheckCircle2 size={17} /> ответ направляется по указанному контакту</span>
        </div>
      </div>
      ...
      <form className='p7-lead-card' action='/api/platform-v7/leads' method='post'>
        ...
        <span>Форма не открывает рабочие кабинеты и не предоставляет доступ к сделкам, документам или закрытым маршрутам платформы.</span>
        ...
        <label>
          <em>Организация</em>
          <input name='organization' type='text' autoComplete='organization' placeholder='Компания, хозяйство, банк или регион' minLength={2} required />
        </label>
        ...
        <label>
          <em>Комментарий</em>
          <textarea name='message' rows={3} placeholder='Кратко опишите вопрос, сценарий пилота или формат взаимодействия.' />
        </label>
