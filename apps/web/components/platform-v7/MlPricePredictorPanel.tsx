...
const ITEMS = [
  { title: 'Цена связана со сделкой', status: 'Платформа', text: 'Аналитика цены должна помогать допуску, аукциону, сделке и удержанию участника внутри платформы.', color: '#065F46', bg: '#D1FAE5' },
  { title: 'Источники данных', status: 'Доработка', text: 'Прогнозы допустимы только после фиксации источников, периодов, качества данных и правил обновления.', color: '#1E40AF', bg: '#DBEAFE' },
  { title: 'Модель и проверка', status: 'Доработка', text: 'Модель должна иметь версию, метрики качества, отчёт проверки и контроль деградации.', color: '#1E40AF', bg: '#DBEAFE' },
  { title: 'Внешние данные', status: 'Интеграция позже', text: 'Внешние ценовые, погодные и рыночные источники временно не подключены и не показываются как работающие.', color: '#92400E', bg: '#FEF3C7' },
];
  ...
  return (
    <div style={{ display: 'grid', gap: '1rem' }}>
      ...
      <div style={{ padding: '8px 12px', borderRadius: 8, background: '#EFF6FF', border: '1px solid #BFDBFE', fontSize: 10, color: '#1E40AF', fontWeight: 760, lineHeight: 1.55 }}>
        Ценовая аналитика: настоящая платформа временно без интеграций. Статичные графики, прогнозы, confidence и внешние источники не показываются как работающая модель.
      </div>
      ...
      <div style={{ fontSize: 9, color: '#94A3B8', padding: '4px 8px', borderRadius: 6, background: '#F8FAFB', border: '1px solid #E4E6EA' }}>
        Ценовая аналитика должна усиливать исполнение сделки; внешние интеграции временно не подключены.
      </div>
    </div>
  );
}
