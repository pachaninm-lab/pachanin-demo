...
export function ChatSupportWidget() {
  ...
  async function submit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (reason.includes('email_provider_not_configured')) {
        return setError('Обращение не отправлено: не настроен почтовый ключ RESEND_API_KEY.');
      }
      setError('Обращение не отправлено. Проверьте почтовый ключ Resend и отправителя.');
    }
  }
...
const css = `
html:has(.p7-support-chat-panel),body:has(.p7-support-chat-panel){overflow-x:hidden!important}.p7-support-chat-button{position:fixed;right:18px;bottom:calc(env(safe-area-inset-bottom,0px) + 22px);z-index:3600;width:56px;height:56px;border:1px solid rgba(255,255,255,.38);border-radius:20px;background:#087a3b;color:#fff;box-shadow:0 18px 42px rgba(0,122,47,.28);display:inline-flex;align-items:center;justify-content:center;cursor:pointer}.p7-support-chat-panel{box-sizing:border-box;position:fixed;right:18px;bottom:calc(env(safe-area-inset-bottom,0px) + 92px);z-index:3600;width:min(390px,calc(100dvw - 28px));max-width:calc(100dvw - 28px);max-height:min(680px,calc(100dvh - 150px));display:flex;flex-direction:column;overflow:hidden;border:1px solid rgba(7,22,17,.1);border-radius:26px;background:#fff;box-shadow:0 28px 80px rgba(7,22,17,.24);font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;color:#071611;overscroll-behavior:contain}.p7-support-chat-panel *{box-sizing:border-box;max-width:100%}.p7-support-chat-head{display:grid;grid-template-columns:42px minmax(0,1fr) 38px;align-items:center;gap:10px;padding:14px;background:#087a3b;color:#fff}.p7-support-chat-head img{display:block;width:42px;height:42px;object-fit:contain}.p7-support-chat-head strong{display:block;font-size:15px;line-height:1.08;font-weight:950;letter-spacing:-.02em;overflow-wrap:anywhere}.p7-support-chat-head button{width:38px;height:38px;border:1px solid rgba(255,255,255,.22);border-radius:14px;background:rgba(255,255,255,.12);color:#fff;display:inline-flex;align-items:center;justify-content:center;cursor:pointer}.p7-support-chat-form{display:grid;gap:11px;padding:14px;overflow:auto;overflow-x:hidden;min-width:0}.p7-support-chat-form label{display:grid;gap:6px;min-width:0}.p7-support-chat-form label span{color:#52615b;font-size:12px;font-weight:900}.p7-support-chat-form input,.p7-support-chat-form select,.p7-support-chat-form textarea{width:100%;min-width:0;border:1px solid rgba(7,22,17,.14);border-radius:15px;background:#fff;color:#071611;font:inherit;font-size:14px;font-weight:650;outline:none}.p7-support-chat-form input,.p7-support-chat-form select{min-height:46px;padding:0 12px}.p7-support-chat-form textarea{padding:12px;resize:vertical;line-height:1.4}.p7-support-chat-form input:focus,.p7-support-chat-form select:focus,.p7-support-chat-form textarea:focus{border-color:rgba(0,122,47,.52);box-shadow:0 0 0 4px rgba(0,122,47,.09)}.p7-support-chat-error{margin:0;padding:10px 12px;border-radius:14px;background:#fff4e8;color:#8a3d00;font-size:13px;line-height:1.35;font-weight:800;overflow-wrap:anywhere}.p7-support-chat-submit{min-height:48px;border:0;border-radius:16px;background:#087a3b;color:#fff;font-weight:950;font-size:14px;display:inline-flex;align-items:center;justify-content:center;gap:8px;cursor:pointer;box-shadow:0 14px 30px rgba(0,122,47,.22)}.p7-support-chat-submit:disabled{opacity:.7;cursor:wait}.p7-support-chat-form small{color:#6b7772;font-size:11.5px;line-height:1.35;font-weight:650;overflow-wrap:anywhere}.p7-support-chat-success{display:grid;gap:10px;padding:18px;min-width:0;overflow:hidden}.p7-support-chat-success svg{color:#087a3b}.p7-support-chat-success strong{font-size:22px;line-height:1.05;font-weight:950;letter-spacing:-.04em;overflow-wrap:anywhere}.p7-support-chat-success p{margin:0;color:#52615b;font-size:14px;line-height:1.45;font-weight:650;overflow-wrap:anywhere}.p7-support-chat-success button{min-height:46px;border-radius:15px;border:1px solid rgba(0,122,47,.22);background:#f2faf5;color:#087a3b;font-weight:950;cursor:pointer}@media(max-width:720px){.p7-support-chat-button{right:max(12px,env(safe-area-inset-right,0px));bottom:calc(env(safe-area-inset-bottom,0px) + 118px);width:54px;height:54px;border-radius:19px}.p7-support-chat-panel{left:max(10px,env(safe-area-inset-left,0px))!important;right:max(10px,env(safe-area-inset-right,0px))!important;bottom:calc(env(safe-area-inset-bottom,0px) + 184px)!important;width:auto!important;min-width:0!important;max-width:none!important;max-height:calc(100dvh - 250px);border-radius:24px;transform:none!important}.p7-support-chat-head{grid-template-columns:38px minmax(0,1fr) 36px;padding:12px}.p7-support-chat-head img{width:38px;height:38px}.p7-support-chat-head strong{font-size:14px}.p7-support-chat-form{padding:12px}.p7-support-chat-success{padding:16px}.p7-support-chat-success strong{font-size:20px}.p7-support-chat-success p{font-size:13px}}@media(max-width:380px){.p7-support-chat-panel{left:8px!important;right:8px!important;border-radius:22px}.p7-support-chat-head{gap:8px}.p7-support-chat-head strong{font-size:13px}.p7-support-chat-form input,.p7-support-chat-form select,.p7-support-chat-form textarea{font-size:13px}}
`;
