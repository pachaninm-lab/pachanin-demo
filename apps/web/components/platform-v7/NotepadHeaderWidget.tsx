  ...
  const widget = (
    <div className='p7-note-widget'>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .p7-note-panel{position:absolute;right:0;top:50px;width:min(360px,calc(100vw - 20px));padding:12px;border:1px solid var(--pc-border);border-radius:20px;background:var(--pc-bg-card);box-shadow:var(--pc-shadow-lg);z-index:521;display:grid;gap:10px;color:var(--pc-text-primary)}
