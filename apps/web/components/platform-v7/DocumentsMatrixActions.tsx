const ACTIONS = [
  ...
  {
    title: 'Повторить отправку на проверку',
    description: 'Повторить запрос без заявления внешнего подключения.',
    next: 'Следующий шаг: показать результат как проверочный статус, не как внешний ответ.',
  },
];
