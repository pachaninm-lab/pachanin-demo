...
// Demo data factory. Lives in a server-safe module (no 'use client') so it can be
// called from Server Components. Importing a plain function from a 'use client'
// module turns it into a client-reference proxy that is not callable on the server.
