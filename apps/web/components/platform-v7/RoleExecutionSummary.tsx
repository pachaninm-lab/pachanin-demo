...
export const PLATFORM_V7_ROLE_EXECUTION_SUMMARIES: Record<PlatformV7ExecutionRole, RoleExecutionSummaryConfig> = {
  seller: {
    ...
    tone: 'success',
    mode: 'commercial',
    now: 'лот LOT-2403: победитель выбран, сделка DL-9106 создана, банковская проверка выплаты ещё закрыта',
  ...
  bank: {
    ...
    blocked: 'банковскую проверку выплаты останавливают документы, спор или ручная проверка',
  ...
  arbitrator: {
    ...
    execution: 'решение влияет на удержание или банковскую проверку выплаты',
  ...
  compliance: {
    ...
    money: 'комплаенс-проверка может блокировать банковскую проверку выплаты',
