...
import type { PaymentHeatmapDay as DayData } from './payment-heatmap-demo-data';
...
// buildDemoPaymentHeatmapData живёт в ./payment-heatmap-demo-data (серверобезопасный
// модуль): функцию из 'use client'-файла нельзя вызывать в серверных страницах.
