...
// Дока/меню/уведомления берут навигацию из канонического реестра ролей
// (platformV7NavByRole / platformV7DrawerNavByRole / platformV7RoleRoute).
// Прежняя жёстко закодированная карта дока по ролям удалена как мёртвый код —
// рендер её не читал, она лишь дублировала реестр (ADR: единственный
// источник ролевой навигации — реестр shellRoutes).
