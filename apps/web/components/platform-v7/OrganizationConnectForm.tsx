  ...
  return (
    <section id='connect-organization' className={styles.section} aria-labelledby='connect-title'>
      ...
      <div>
        ...
        <noscript>
          <style>{`
            .pc-v7-public-entry #connect-organization form{display:none!important}
            .pc-root-loading-noscript{display:grid;width:min(100%,620px);gap:14px;padding:24px;border:1px solid rgba(8,122,59,.24);border-radius:22px;background:#fff;box-shadow:0 18px 44px rgba(7,22,17,.08);box-sizing:border-box}
            .pc-root-loading-noscript *{box-sizing:border-box}
