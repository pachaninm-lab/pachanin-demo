...
const ITEMS = [
  { title: 'Качество связано со сделкой', status: 'Платформа', text: 'Показатели качества должны быть связаны с приёмкой, лабораторией, документами и спором.', color: '#065F46', bg: '#D1FAE5' },
  { title: 'Документный пакет', status: 'Доработка', text: 'Состав сертификатного пакета должен показываться как чек-лист без имитации выданного документа.', color: '#1E40AF', bg: '#DBEAFE' },
  { title: 'Лабораторные показатели', status: 'Доработка', text: 'Значения качества должны появляться только из протокола или подтверждённого события сделки.', color: '#1E40AF', bg: '#DBEAFE' },
  ...
  return (
    <div style={{ display: 'grid', gap: '1rem' }}>
      ...
      <div style={{ padding: '8px 12px', borderRadius: 8, background: '#EFF6FF', border: '1px solid #BFDBFE', fontSize: 10, color: '#1E40AF', fontWeight: 760, lineHeight: 1.55 }}>
        Качество и сертификаты: настоящая платформа временно без интеграций. Номера сертификатов, сроки действия, ведомственные статусы и внешние реестры не показываются как подключённые.
      </div>
      ...
      <div style={{ fontSize: 9, color: '#94A3B8', padding: '4px 8px', borderRadius: 6, background: '#F8FAFB', border: '1px solid #E4E6EA' }}>
        Контур качества должен усиливать исполнение сделки; внешняя интеграция временно не подключена.
      </div>
    </div>
  );
}
