...
@media(max-width:760px){.pc-site-header{height:58px;gap:5px;padding:0 8px}.pc-site-brand{gap:6px;flex:1 1 auto}.pc-site-brand-mark{width:31px;height:31px;flex-basis:31px}.pc-site-brand-text strong{font-size:13px}.pc-site-actions,.pc-site-actions>div{gap:3px}.pc-site-mobile-menu>summary{width:44px}.pc-site-mobile-nav{top:62px}.pc-site-header :is(.pc-v6-header-cta,.pc-ppe-primary-button,.p7-about-register,.p7-contact-register){padding-inline:9px;font-size:11px}}
