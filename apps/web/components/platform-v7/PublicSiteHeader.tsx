...
.pc-site-brand-text{display:grid;min-width:0}.pc-site-brand-text strong{font-size:16px;line-height:1;font-weight:900;letter-spacing:-.035em;white-space:nowrap}.pc-site-brand-text small{margin-top:2px;color:#66736e;font-size:12px;font-weight:650;line-height:1.2;white-space:nowrap}
.pc-site-nav{flex:1 1 auto;display:flex;justify-content:center;align-items:center;gap:15px;min-width:0;font-size:13px;font-weight:720;color:#17251f}
