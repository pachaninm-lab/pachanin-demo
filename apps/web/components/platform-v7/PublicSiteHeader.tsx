...
.pc-site-brand-text{display:grid;min-width:0}.pc-site-brand-text strong{font-size:16px;line-height:1;font-weight:800;letter-spacing:-.035em;white-space:nowrap}.pc-site-brand-text small{margin-top:2px;color:#66736e;font-size:12px;font-weight:600;white-space:nowrap}
.pc-site-nav{flex:1 1 auto;display:flex;justify-content:center;align-items:center;gap:15px;min-width:0;font-size:12px;font-weight:700;color:#17251f}
...
.pc-site-locale-cluster{display:flex;align-items:center;justify-content:center;gap:2px;flex:0 0 auto}.pc-site-locale-option{box-sizing:border-box;min-width:44px;min-height:44px;display:inline-flex;align-items:center;justify-content:center;padding:0 5px;border-radius:8px;color:#5d6963;text-decoration:none;font-size:12px;font-weight:700;line-height:1}.pc-site-locale-option:focus-visible{outline:3px solid rgba(25,117,82,.34);outline-offset:2px}
.pc-site-locale-cluster{display:flex;align-items:center;justify-content:center;gap:2px;flex:0 0 auto}
.pc-site-locale-option{box-sizing:border-box;min-width:44px;min-height:44px;display:inline-flex;align-items:center;justify-content:center;padding:0 5px;border-radius:8px;color:#5d6963;text-decoration:none;font-size:12px;font-weight:700;line-height:1}
.pc-site-locale-option[data-active='true']{background:#087a3b;color:#fff;font-weight:800}.pc-site-locale-option:focus-visible{outline:3px solid rgba(25,117,82,.34);outline-offset:2px}
...
.pc-site-header[data-public-site-header='canonical'] .pc-site-nav{gap:2px;font-size:14px;font-weight:700;color:#24382e}
...
.pc-site-header[data-public-site-header='canonical'] .pc-site-nav-gekta{background:#edf8f2;color:#0a6548;font-weight:700}
