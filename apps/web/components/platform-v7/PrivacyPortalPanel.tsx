  ...
  return (
    <div style={{ display: 'grid', gap: 14 }}>
      <div style={{ padding: '14px 16px', borderRadius: 12, border: '1px solid #D7E1DB', background: '#F8FBF9' }}>
        <strong style={{ display: 'block', fontSize: 16, color: '#102019' }}>Права субъекта персональных данных</strong>
        <p style={{ margin: '6px 0 0', fontSize: 16, lineHeight: 1.6, color: '#526159' }}>
        ...
        <section role='tabpanel' style={{ display: 'grid', gap: 8 }}>
          {[
            ...
            <article key={title} style={{ padding: '12px 14px', borderRadius: 12, border: '1px solid #E2E8E4', background: '#fff' }}>
              <strong style={{ fontSize: 14, color: '#102019' }}>{title}</strong>
              <p style={{ margin: '4px 0 0', fontSize: 16, lineHeight: 1.55, color: '#526159' }}>{text}</p>
            </article>
          ))}
        </section>
      )}
      ...
      {tab === 'request' && (
        <section role='tabpanel' style={{ padding: '14px 16px', borderRadius: 12, border: '1px solid #E2E8E4', background: '#fff' }}>
          <strong style={{ display: 'block', fontSize: 16, color: '#102019' }}>Направить реальное обращение</strong>
          <p style={{ margin: '6px 0 12px', fontSize: 16, lineHeight: 1.55, color: '#526159' }}>
          ...
          <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
            <a href='/platform-v7/contact' style={{ minHeight: 44, display: 'inline-flex', alignItems: 'center', padding: '8px 14px', borderRadius: 9, background: '#087A3B', color: '#fff', textDecoration: 'none', fontSize: 14, fontWeight: 800 }}>
              Открыть контакты
            </a>
            <a href='/platform-v7/privacy' style={{ minHeight: 44, display: 'inline-flex', alignItems: 'center', padding: '8px 14px', borderRadius: 9, border: '1px solid #D7E1DB', color: '#102019', textDecoration: 'none', fontSize: 14, fontWeight: 700 }}>
