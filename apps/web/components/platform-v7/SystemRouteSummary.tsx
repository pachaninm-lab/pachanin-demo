...
export const PLATFORM_V7_SYSTEM_SURFACES: Record<SystemSurface, SystemRouteConfig> = {
  operator: {
    ...
    purpose: 'показывает причину остановки, сумму влияния, срок, ответственного и следующий подтверждаемый шаг',
  ...
  operatorQueues: {
    ...
    tone: 'warning',
    status: 'срок и ответственный выше списка',
  ...
  deployCheck: {
    ...
    purpose: 'служит только для внутренней проверки деплоя и не должен участвовать во внешнем показе',
