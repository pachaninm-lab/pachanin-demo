    ...
    >
      <div style={{ display: 'flex', justifyContent: 'space-between', gap: 10, flexWrap: 'wrap', alignItems: 'center', minWidth: 0 }}>
        <div style={{ display: 'grid', gap: 4, minWidth: 0 }}>
          ...
          <div style={{ color: 'var(--pc-text-primary, #0F1419)', fontSize: 15, fontWeight: 950, lineHeight: 1.2, overflowWrap: 'anywhere' }}>
            ...
            >
              <div style={{ display: 'flex', gap: 8, justifyContent: 'space-between', flexWrap: 'wrap', minWidth: 0 }}>
                <div
                  ...
                  style={{ color: 'var(--pc-text-primary, #0F1419)', fontSize: 13, fontWeight: 950, lineHeight: 1.3, minWidth: 0, overflowWrap: 'anywhere', flex: 1 }}
                >
...
function Field({ label, value, testId, strong = false }: { label: string; value: string; testId: string; strong?: boolean }) {
  return (
    <div style={{ display: 'grid', gap: 4, minWidth: 0 }}>
      ...
      <div data-testid={testId} style={{ color: strong ? 'var(--pc-text-primary, #0F1419)' : 'var(--pc-text-secondary, #475569)', fontSize: 12, lineHeight: 1.45, fontWeight: strong ? 800 : 700, overflowWrap: 'anywhere', minWidth: 0 }}>
        {value}
      </div>
    </div>
  );
