...
function suppressNativeHeaderActions() {
  const nativeActions = document.querySelector('.pc-v4-header .pc-v4-actions');
  if (nativeActions) (nativeActions as HTMLElement).style.setProperty('display', 'none', 'important');
}
