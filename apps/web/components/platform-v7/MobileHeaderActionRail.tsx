...
const css = `
html body .p7-mobile-action-rail{display:none}
@media(max-width:767px){
  ...
  html body .pc-shell-root-v4 .pc-v4-actions{display:flex!important;align-items:center!important;justify-content:flex-end!important;overflow:visible!important;visibility:visible!important;opacity:1!important;min-inline-size:0!important;max-inline-size:100%!important}
  ...
  html body .p7-mobile-action-rail{display:grid!important;grid-template-columns:repeat(7,30px)!important;gap:3px!important;align-items:center!important;justify-content:end!important;inline-size:max-content!important;max-inline-size:100%!important;z-index:2!important;visibility:visible!important;opacity:1!important;pointer-events:auto!important;flex:0 0 auto!important;position:relative!important}
...
@media(max-width:374px){
  html body .p7-mobile-action-rail{grid-template-columns:repeat(7,28px)!important;gap:2px!important}
