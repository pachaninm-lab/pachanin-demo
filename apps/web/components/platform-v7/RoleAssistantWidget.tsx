  ...
  return (
    <>
      <style>{`
        ...
        .pc-v4-bottomnav a[href='/platform-v7/ai']{display:none!important}
        ...
        @media(max-width:640px){.pc-v7-logout-btn{display:none!important}.pc-v7-assistant-widget{right:12px;bottom:calc(env(safe-area-inset-bottom) + 82px);min-height:42px;padding:0 12px;font-size:11px}.pc-v7-assistant-widget span{max-width:136px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}}
      `}</style>
