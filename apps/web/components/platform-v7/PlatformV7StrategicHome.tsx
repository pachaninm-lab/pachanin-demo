...
const COPY = {
  ru: {
    ...
    lensCells: [
      ['Объект', 'Сделка от лота до закрытия'],
    ...
    dealTitle: '7 этапов Сделки',
    dealLead: 'Лот, торги, доставка, качество, расчёт и закрытие остаются связаны с одной Сделкой.',
    whoEyebrow: 'Для кого',
    whoTitle: 'Что видит каждый участник',
    groups: [
      ...
      ['Финансы', 'Банк видит подтверждённые основания и финансовые данные, доступные его роли.'],
    ],
    rolesLabel: '9 ролей в Сделке',
    ...
    trustTitle: 'Видно, кто действовал и почему',
    ...
    gektaEyebrow: 'Гекта',
    gektaTitle: 'Гекта показывает факты, риски и следующий доступный шаг',
    opportunitiesEyebrow: 'Возможности',
    opportunitiesTitle: 'Что входит в рабочий контур Сделки',
    capability: {
      ...
      delivery: ['Доставка', 'Логистика и водитель видят свои задачи и связанные события Сделки.'],
      ...
      gekta: ['Гекта', 'Показывает важные факты Сделки и риски перед выбором следующего действия.'],
  ...
  en: {
    ...
    lensCells: [
      ['Object', 'Deal from lot to closure'],
    ...
    dealLead: 'Lot, trading, delivery, quality, settlement and closure stay linked to the same Deal.',
    whoEyebrow: 'For whom',
    whoTitle: 'What each participant sees',
    groups: [
      ...
      ['Finance', 'The bank sees confirmed basis and the financial data available to its role.'],
    ],
    rolesLabel: '9 roles in the Deal',
    liveEyebrow: 'Deal in progress',
    liveTitle: 'See what is happening and what to do next',
    liveLead: 'The screen answers five questions: what happened, who owns the next action, what supports the status, how settlement is affected, and what can happen next.',
    state: {
    ...
    trustEyebrow: 'Trust',
    trustTitle: 'See who acted and why',
    ...
    gektaEyebrow: 'Gekta',
    gektaTitle: 'Gekta shows the Deal facts, risks and the next permitted step',
    opportunitiesEyebrow: 'Capabilities',
    opportunitiesTitle: 'What the Deal workspace covers',
    capability: {
      market: ['Market', 'Public anonymised lots shown as the first Deal stage.'],
      ...
      gekta: ['Gekta', 'Shows the Deal facts that matter and flags risks before the participant chooses the next action.'],
  ...
  zh: {
    ...
    dealEyebrow: '交易阶段',
    dealTitle: '交易的七个阶段',
    dealLead: '批次、交易、交付、质量、结算和关闭始终与同一笔交易关联。',
    whoEyebrow: '面向谁',
    whoTitle: '每个参与方能看到什么',
    groups: [
      ...
      ['金融', '银行查看已确认依据，以及其角色有权访问的金融数据。'],
    ],
    rolesLabel: '交易中的 9 个角色',
    liveEyebrow: '进行中的交易',
    liveTitle: '看清正在发生什么，以及下一步做什么',
    liveLead: '页面回答五个问题：发生了什么、谁负责下一步、状态依据是什么、对结算有什么影响、接下来可以做什么。',
    state: {
    ...
    trustEyebrow: '信任',
    trustTitle: '看清谁执行了操作以及依据是什么',
    trustLead: '每个重要操作都能看到：谁有权操作、依据是什么、事实来自哪里、最终记录了什么决定。',
    gektaEyebrow: 'Gekta',
    gektaTitle: 'Gekta 显示交易事实、风险和下一步可执行操作',
    opportunitiesEyebrow: '功能',
    opportunitiesTitle: '交易工作区涵盖的内容',
    capability: {
      market: ['市场', '公开匿名批次作为交易第一阶段展示。'],
      trading: ['交易', '交易结果始终与所选交易方和具体交易关联。'],
      commitments: ['义务', '交易结束后，条件和责任仍继续跟随履约。'],
      delivery: ['交付', '物流和司机看到自己的任务及相关交易事件。'],
      ...
      gekta: ['Gekta', '在参与方选择下一步操作前，显示关键交易事实并提示风险。'],
