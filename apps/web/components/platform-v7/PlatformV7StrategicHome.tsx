...
const COPY = {
  ru: {
    ...
    groups: [
      ...
      ['Финансы', 'Банк видит только подтверждённые основания и доступные ему данные Сделки.'],
    ],
    rolesLabel: '9 ролей',
    ...
    capability: {
      ...
      settlement: ['Расчёт', 'Платформа показывает основание для расчёта; внешнее финансовое событие требует подтверждения.'],
      dispute: ['Спор', 'Спор разбирается по фактам, документам и журналу действий.'],
      trust: ['Доверие', 'В рабочем контексте видны полномочия, основания, источники и решения.'],
  ...
  en: {
    ...
    groups: [
      ...
      ['Finance', 'The bank sees only confirmed basis and the Deal data available to it.'],
    ],
    rolesLabel: '9 roles',
