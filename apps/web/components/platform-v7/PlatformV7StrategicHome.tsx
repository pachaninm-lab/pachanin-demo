  ...
  return (
    <main className='pc-canonical-public' data-testid='platform-v7-root-execution-cockpit'>
      ...
      <section className='pc-cp-hero' aria-labelledby='pc-cp-home-title'>
        <img className='pc-cp-hero-media' src='/platform-v7/hero-farmer-canonical.svg' alt='' width='400' height='320' loading='eager' decoding='async' fetchPriority='high' aria-hidden='true' />
