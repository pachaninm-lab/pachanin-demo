  ...
  return (
    <main className='pc-canonical-public' data-testid='platform-v7-root-execution-cockpit'>
      ...
      <section className='pc-cp-hero' aria-labelledby='pc-cp-home-title'>
        <img className='pc-cp-hero-media' src='/platform-v7/wheat-exact-background.svg' alt='' width='1448' height='1086' loading='eager' decoding='async' fetchPriority='high' aria-hidden='true' />
