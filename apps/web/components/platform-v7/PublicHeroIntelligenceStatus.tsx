...
const COPY = {
  ru: {
    label: 'Гекта · контроль исполнения сделки',
    ...
    introTitle: 'Гекта — операционный интеллект платформы',
