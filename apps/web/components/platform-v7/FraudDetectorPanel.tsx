...
const ITEMS = [
  { title: 'Контроль обхода сделки', status: 'Платформа', text: 'Антифрод должен защищать сделку, деньги, документы, допуск и удержание участников внутри платформы.', color: '#065F46', bg: '#D1FAE5' },
  { title: 'Правила сигналов', status: 'Доработка', text: 'Сигнал должен иметь основание, источник, уровень важности, ответственного и порядок проверки.', color: '#1E40AF', bg: '#DBEAFE' },
  { title: 'Решение и доказательства', status: 'Доработка', text: 'Статус проверки должен быть связан с доказательствами, журналом действий и возможностью спора.', color: '#1E40AF', bg: '#DBEAFE' },
  { title: 'Внешние источники', status: 'Интеграция позже', text: 'Внешние списки, платёжные данные, real-time события и модели временно не подключены и не показываются как работающие.', color: '#92400E', bg: '#FEF3C7' },
];
  ...
  return (
    <div style={{ display: 'grid', gap: '1rem' }}>
      ...
      <div style={{ padding: '8px 12px', borderRadius: 8, background: '#EFF6FF', border: '1px solid #BFDBFE', fontSize: 10, color: '#1E40AF', fontWeight: 760, lineHeight: 1.55 }}>
        Антифрод-контур: настоящая платформа временно без интеграций. Сигналы, оценки, расследования, внешние источники и real-time модель не показываются как подтверждённый runtime.
      </div>
      ...
      <div style={{ fontSize: 9, color: '#94A3B8', padding: '4px 8px', borderRadius: 6, background: '#F8FAFB', border: '1px solid #E4E6EA' }}>
        Антифрод должен усиливать исполнимость сделки и anti-bypass; внешние интеграции временно не подключены.
      </div>
    </div>
  );
}
