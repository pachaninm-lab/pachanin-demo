...
const ITEMS = [
  { title: 'Кредит связан со сделкой', status: 'Платформа', text: 'Кредитная проверка должна обслуживать допуск, лимит сделки, оплату и риск неисполнения.', color: '#065F46', bg: '#D1FAE5' },
  { title: 'Согласие и основание', status: 'Доработка', text: 'Запрос кредитных данных должен иметь правовое основание, согласие, цель и журнал обращения.', color: '#1E40AF', bg: '#DBEAFE' },
  { title: 'Скоринговая логика', status: 'Доработка', text: 'Оценка, лимит и факторы должны формироваться из подтверждённых источников и версионированных правил.', color: '#1E40AF', bg: '#DBEAFE' },
  { title: 'Внешние бюро', status: 'Интеграция позже', text: 'БКИ и банковские источники временно не подключены и не показываются как работающие.', color: '#92400E', bg: '#FEF3C7' },
];
  ...
  return (
    <div style={{ display: 'grid', gap: '1rem' }}>
      ...
      <div style={{ padding: '8px 12px', borderRadius: 8, background: '#EFF6FF', border: '1px solid #BFDBFE', fontSize: 10, color: '#1E40AF', fontWeight: 760, lineHeight: 1.55 }}>
        Кредитный контур: настоящая платформа временно без интеграций. ИНН, оценки, лимиты, просрочки и данные бюро не показываются как подтверждённые.
      </div>
      ...
      <div style={{ fontSize: 9, color: '#94A3B8', padding: '4px 8px', borderRadius: 6, background: '#F8FAFB', border: '1px solid #E4E6EA' }}>
        Кредитный контур должен усиливать допуск и исполнение сделки; внешние интеграции временно не подключены.
      </div>
    </div>
  );
}
