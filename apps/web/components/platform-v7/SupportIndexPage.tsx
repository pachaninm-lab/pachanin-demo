...
export function SupportIndexPage() {
  ...
  const consultationHref = `/platform-v7/support/new?role=${role}&context=consultation&entity=other&entityId=CONSULTATION`;

  return (
    <div data-testid='platform-v7-support-page' style={{ display: 'grid', gap: 16, maxWidth: 1180, margin: '0 auto' }}>
      <style dangerouslySetInnerHTML={{ __html: `@media(max-width:767px){[data-testid='platform-v7-support-page']{gap:10px!important}.p7-support-hero{padding:16px!important;border-radius:24px!important;gap:8px!important}.p7-support-hero h1{font-size:clamp(28px,8vw,38px)!important;line-height:1.04!important}.p7-support-hero p{font-size:13px!important;line-height:1.45!important}.p7-support-actions{display:grid!important;grid-template-columns:1fr!important;gap:8px!important}.p7-support-create,.p7-support-consult{width:100%!important;justify-content:center!important;min-height:52px!important}.p7-support-metrics{grid-template-columns:1fr 1fr!important;gap:8px!important}.p7-support-metrics>div{padding:12px!important;border-radius:16px!important}.p7-support-metrics>div:nth-child(n+3){display:none!important}.p7-support-list{padding:14px!important;border-radius:22px!important}.p7-support-list h2{font-size:22px!important}.p7-support-case{display:block!important;padding:14px!important;border-radius:16px!important;background:#fff!important;color:var(--pc-text-primary, #0F1419)!important}.p7-support-case a{display:grid!important;gap:8px!important;color:var(--pc-text-primary, #0F1419)!important;text-decoration:none!important}.p7-support-case-grid{display:none!important}.p7-support-mobile-card{display:grid!important}.p7-support-mobile-title{font-size:15px!important;line-height:1.25!important;color:var(--pc-text-primary, #0F1419)!important}.p7-support-mobile-meta{font-size:12px!important;line-height:1.35!important;color:#64748b!important}.p7-support-mobile-open{display:inline-flex!important;align-items:center!important;justify-content:center!important;width:fit-content!important;min-height:34px!important;padding:0 12px!important;border-radius:999px!important;border:1px solid var(--pc-border, #E4E6EA)!important;color:var(--pc-text-primary, #0F1419)!important;background:#fff!important;font-size:12px!important;font-weight:900!important}}@media(min-width:768px){.p7-support-mobile-card{display:none!important}}` }} />
      ...
      <section className='p7-support-hero' style={{ ...card, display: 'grid', gap: 12 }}>
        ...
        <div className='p7-support-actions' style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
          <Link className='p7-support-create' href={`/platform-v7/support/new?role=${role}`} style={primary}>Создать обращение</Link>
          <Link className='p7-support-consult' href={consultationHref} style={secondary}>Запросить консультацию</Link>
        </div>
      </section>
...
const secondary: CSSProperties = { textDecoration: 'none', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: 'fit-content', padding: '12px 14px', borderRadius: 14, background: 'var(--pc-bg-card,#fff)', border: '1px solid var(--pc-border,#E4E6EA)', color: 'var(--pc-accent,#0A7A5F)', fontSize: 13, fontWeight: 900 };
