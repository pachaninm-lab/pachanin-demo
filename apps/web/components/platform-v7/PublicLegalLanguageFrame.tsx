...
export async function PublicLegalLanguageFrame({ children }: { children: ReactNode }) {
  ...
  return <div lang='ru' data-public-legal-original='ru' style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr)', minWidth: 0, gap: 16, maxWidth: 1040, margin: '0 auto', overflowWrap: 'break-word', wordBreak: 'break-word', hyphens: 'auto' }}>
