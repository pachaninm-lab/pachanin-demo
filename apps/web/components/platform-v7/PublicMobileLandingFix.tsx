...
html body .pc-v7-public-entry{padding-top:0!important;padding-bottom:calc(132px + env(safe-area-inset-bottom,0px))!important;overflow-x:hidden!important;background:linear-gradient(180deg,#edf5e9 0,#f6f9f3 118px,#f4f7f0 100%)!important;scroll-padding-bottom:calc(132px + env(safe-area-inset-bottom,0px))!important}
...
html body .pc-v7-public-entry .entry-trust-strip{margin-bottom:calc(92px + env(safe-area-inset-bottom,0px))!important}
@media (max-width:720px){
html body .pc-v7-public-entry{padding-top:0!important;padding-bottom:calc(150px + env(safe-area-inset-bottom,0px))!important;scroll-padding-bottom:calc(150px + env(safe-area-inset-bottom,0px))!important}
