...
export function GektaMobileDrawer({ open, closeLabel, onClose, children }: { open: boolean; closeLabel: string; onClose: () => void; children: React.ReactNode }) {
  ...
  return (
    ...
    >
      ...
      <div ref={panelRef} data-gekta-mobile-drawer-panel='true' className='absolute inset-y-0 left-0 flex w-[min(92vw,360px)] flex-col overflow-hidden bg-[#f6f5ef] shadow-2xl'>
