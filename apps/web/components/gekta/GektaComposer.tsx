...
export function GektaComposer({ locale, value, placeholder, sending, stopLabel, sendLabel, boundary, documents, onDocuments, onChange, onSubmit, onStop, onError }: {
  locale: GektaLocale;
  value: string;
  placeholder: string;
  sending: boolean;
