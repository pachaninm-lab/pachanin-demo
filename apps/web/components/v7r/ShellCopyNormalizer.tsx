...
const NORMALIZED_RUNTIME_COPY = new Map([
  ...
  ['FARMER', 'Продавец'],
  ['В демо-контуре загрузка имитируется, в живом — ведёт в защищённое хранилище.', 'Загрузка фиксирует документ в контуре сделки и передаёт его на проверку.'],
  ['добавлен в демо-контуре', 'добавлен в контур сделки'],
  ['Control Tower', 'Центр контроля'],
  ['блокировок', 'остановок'],
  ['Блокировок', 'Остановок'],
  ['блокеры', 'остановки'],
  ['Блокеры', 'Остановки'],
  ['блокер', 'остановка'],
  ['Блокер', 'Остановка'],
  ['Подтвердить выпуск', 'Подтвердить банковский шаг'],
  ['Запросить выпуск денег', 'Запросить банковский шаг'],
  ['Запросить выпуск', 'Запросить банковский шаг'],
  ['Ожидает выпуск', 'Ожидает банковский шаг'],
  ['ожидаемого выпуска', 'ожидаемого банковского шага'],
  ['ожидаемый выпуск', 'ожидаемый банковский шаг'],
  ['выпуск подтверждён', 'банковский шаг подтверждён'],
  ['Получите на счёт', 'К банковскому шагу'],
  ['После закрытия спора и проверки акта сумма будет выпущена.', 'После закрытия спора и проверки акта сумма перейдёт к банковскому шагу.'],
  ['\u2705 Подтвердить выпуск', 'Подтвердить банковский шаг'],
  ['\u26a0\ufe0f Закрыть спор', 'Закрыть спор'],
  ['\ud83d\udcc4 Запросить выпуск', 'Запросить банковский шаг'],
