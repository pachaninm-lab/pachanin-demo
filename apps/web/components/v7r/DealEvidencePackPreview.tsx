      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', gap: 12, flexWrap: 'wrap', alignItems: 'flex-start' }}>
        <div>
          <div style={{ fontSize: 11, color: BRAND, fontWeight: 900, textTransform: 'uppercase', letterSpacing: '0.06em' }}>
            доказательный пакет · проверочный контур
          </div>
          <div style={{ marginTop: 6, fontSize: 22, lineHeight: 1.15, fontWeight: 900, color: T }}>
            Доказательный пакет по сделке {dealId}
          </div>
          <div style={{ marginTop: 6, fontSize: 13, lineHeight: 1.6, color: M, maxWidth: 860 }}>
            Один и тот же доказательный контур должен читаться из сделки, спора и банка. Этот блок показывает связку сделки с доказательствами, спором и деньгами без внешнего PDF, ЭДО или КЭП-экспорта.
          </div>
        </div>
