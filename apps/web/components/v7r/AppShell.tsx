    ...
    >
      <div
        ...
        style={{
          ...
          padding: 22,
          boxShadow: '0 18px 48px rgba(9,30,66,0.18)',
        }}
      >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '14px 16px', borderBottom: '1px solid #E4E6EA' }}>
          ...
          <input
            ...
            style={{ flex: 1, border: 'none', outline: 'none', fontSize: 14, color: '#0F1419' }}
          />
          <button
            onClick={() => setCommandOpen(false)}
        ...
        return (
          <Link
            ...
            style={{
              ...
              fontSize: 12,
              fontWeight: 700,
              background: active ? 'rgba(10,122,95,0.1)' : '#F5F7F8',
              color: active ? '#0A7A5F' : '#495057',
              border: active ? '1px solid rgba(10,122,95,0.2)' : '1px solid #E4E6EA',
            }}
          >
            {item.label}
          </Link>
...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  React.useEffect(() => {
    ...
    const handler = (event: KeyboardEvent) => {
      ...
      if (key === 'g') {
        state.waitingForSecondKey = true;
  ...
  return (
    <div className="v9-root" style={{ minHeight: '100dvh', background: 'linear-gradient(180deg, #F7FAFB 0%, #F1F5F7 100%)' }}>
      <a
        ...
        onBlur={(event) => {
          event.currentTarget.style.top = '-50px';
        }}
      >
      ...
      {sidebarOpen && (
        <div
          ...
          style={{ position: 'fixed', inset: 0, background: 'rgba(15,20,25,0.36)', zIndex: 79 }}
          aria-hidden
        />
      )}
      ...
      <aside
        style={{
          ...
          boxShadow: sidebarOpen ? '0 16px 40px rgba(9,30,66,0.14)' : 'none',
          display: 'flex',
        ...
        <div style={{ padding: 18, borderBottom: '1px solid #E4E6EA' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 12 }}>
            <div>
              ...
              <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#6B778C', marginTop: 3 }}>
                Исполнение сделки
              </div>
            </div>
            <button
          ...
          <div
            style={{
              ...
              padding: 14,
              borderRadius: 16,
              background: 'linear-gradient(180deg, rgba(10,122,95,0.08) 0%, rgba(10,122,95,0.03) 100%)',
          ...
          >
            ...
            <div style={{ fontSize: 12, color: '#6B778C', marginTop: 8, lineHeight: 1.55 }}>
              Логика экранов и действий подстроена под выбранную роль.
            </div>
          </div>
        </div>
            ...
            return (
              <Link
                ...
                style={{
                  ...
                  background: active ? 'rgba(10,122,95,0.09)' : 'transparent',
                  color: active ? '#0A7A5F' : '#1F2937',
                  border: active ? '1px solid rgba(10,122,95,0.14)' : '1px solid transparent',
                }}
              >
                {item.label}
              </Link>
        ...
        <div style={{ marginTop: 'auto', padding: 12, borderTop: '1px solid #E4E6EA', display: 'grid', gap: 8 }}>
          ...
          <button
            ...
            style={{
              ...
              padding: '11px 12px',
              borderRadius: 12,
              background: demoMode ? 'rgba(217,119,6,0.08)' : 'rgba(22,163,74,0.08)',
              border: `1px solid ${demoMode ? 'rgba(217,119,6,0.18)' : 'rgba(22,163,74,0.18)'}`,
              color: demoMode ? '#B45309' : '#15803D',
              fontSize: 13,
              fontWeight: 700,
              cursor: 'pointer',
            }}
          >
            {demoMode ? 'Демо-контур включён' : 'Живой режим включён'}
          </button>
        </div>
      </aside>
      ...
      <div style={{ paddingBottom: 72 }}>
        ...
        >
          ...
          >
            ...
            <div style={{ minWidth: 0 }}>
                ...
                {breadcrumbs.map((crumb, index) => (
                  <React.Fragment key={crumb.href}>
                    ...
                    {crumb.isLast ? (
                      ...
                      <Link href={crumb.href} style={{ textDecoration: 'none', color: '#6B778C', fontSize: 12, fontWeight: 600 }}>
                        {crumb.label}
                      </Link>
                    )}
                  </React.Fragment>
              ...
              <div style={{ fontSize: 11, color: '#6B778C', marginTop: 4 }}>
                {roleLabels[role]} · {demoMode ? 'демо-контур' : 'живой режим'}
              </div>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
              ...
              >
                <Search size={14} />
                <span style={{ fontSize: 12, color: '#495057', fontWeight: 700 }}>Найти</span>
              </button>
              ...
              <button
                onClick={() => {
                  ...
                  if (next && unreadNotifications > 0) setUnreadNotifications(0);
                }}
                style={{
                  position: 'relative',
                  background: '#FFFFFF',
          ...
          <div style={{ maxWidth: 1360, margin: '10px auto 0', display: 'flex', flexWrap: 'wrap', gap: 8 }}>
            ...
            >
              ...
              >
                {demoMode ? 'Переключить' : 'Вернуть демо'}
              </button>
            </div>
          </div>
        </header>
        ...
        <main id="main-content" style={{ padding: 16, maxWidth: 1360, margin: '0 auto' }}>
          {children}
        </main>
      </div>
