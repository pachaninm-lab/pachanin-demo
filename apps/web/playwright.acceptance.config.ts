...
export default defineConfig({
  testDir: './tests/e2e',
  testMatch: /platform-v7-(design-system-v8-acceptance|canonical-visual-evidence|registration-official|recovery-dirty-guard|legal-language-reflow|contact-priority|docs-chain|market-result-navigation)\.spec\.ts/,
  fullyParallel: false,
  workers: 1,
  ...
  projects: [
    ...
    },
    {
      ...
      grep: /Design System v8|public registration locale cycle|canonical protected cabinet boundary|canonical cross-browser public smoke|Platform V7 public registration official UX|UX-05 recovery unsaved-entry guard|UX-29 legal language and reflow|public market result navigation UX-10 UX-17/,
