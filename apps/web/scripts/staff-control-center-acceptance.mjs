...
const copies = {
  ...
  zh: { access: '访问', submit: '创建申请', activate: '激活受保护会话', operationalTitle: '平台员工工作台', tabs: [['支持','Отсутствует ЭПД'],['履约','TP-2026-001'],['资金','12500000'],['诊断','bank-sandbox'],['员工','平台所有者'],['双人控制操作','deal:operation:retry'],['紧急访问','当前没有需要处理的项目。']], viewBanner: '正在查看其他账户', cabinet: '账户视图' },
};
