...
-- Legacy permissive policy from 0001 must be removed before canonical policies.
...
-- Legacy permissive policies from 0001 must not survive canonical activation.
