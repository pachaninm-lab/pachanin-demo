...
Прогресс: **7.6%** по матрице §H. PR #4216 открыт, не смержен.
...
10. **Реестр правил рантайм читает и не пишет.** Налоговое право — не настройка организации.
...
4. Остаток workstream 4: налоговый профиль организации, версии договоров, format registry.
   Налоговый профиль — следующий по ценности из них: он замыкает вторую висящую ссылку
   в снимке ревизий (`TAX_PROFILE`) ровно так же, как реестр правил замкнул первую.
