...
- the compact mobile header action recovery from #2046/#2048/#2049 remains intact;
...
3. Mobile protected header action recovery is active from #2046/#2048/#2049.
...
- #2048 protected mobile header action scope sync.
- #2049 protected mobile header tool anchoring.
