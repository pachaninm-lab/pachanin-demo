...
- #2115 remains open as a prior chat-runtime/tool-safety blocker for the current auth write path; it does not change repo source-of-truth readiness.
...
21. P0 backend register role assignment hardening is current.
