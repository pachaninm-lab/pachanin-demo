...
CURRENT: PR 6.3 — FGIS Adapter Emulator
...
- Do not start UI, onboarding, visual polish, AI gateway or theme-pass during PR 6.3.
- PR 6.3 is FGIS emulator only: implement deterministic FGIS/SDIZ event model, no live FGIS connectivity.
...
- FGIS emulator must not claim live FGIS/SDIZ connectivity.

NEXT AUTOPILOT STEP:
- Prepare PR 6.3 — FGIS Adapter Emulator.
...
- Do not advance to PR 6.4 until PR 6.3 is green, reviewed and merged.
