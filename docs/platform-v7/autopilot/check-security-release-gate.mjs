...
check(errors, JSON.stringify(scope.releaseAuthority?.iacRoots ?? []) === JSON.stringify(['infra/docker']), 'Blocking IaC scope must be explicit and limited to release-authority Dockerfiles until #2606 closes.');
