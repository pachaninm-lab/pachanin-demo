...
test('provider-independent machine review counts only distinct green trusted analyzers', () => {
  const checks = [
    ...
    { workflowName: 'Dependency Review', name: 'dependency', status: 'IN_PROGRESS', conclusion: null },
    { workflowName: 'CI', name: 'unit', status: 'COMPLETED', conclusion: 'SUCCESS' },
  ];
