...
## Разделение полос (от владельца, 2026-06-11)

- Codex — кодовая полоса: остаток тест-долга VP-2.5 (ветки `codex/vp25-*`,
  PR #1715+), runtime-логика.
- Claude — визуальная полоса: Living Deal Interface по 11 макетам
  (`styles/platform-v7-living-deal.css` и далее), дизайн-токены, HX-подготовка.
