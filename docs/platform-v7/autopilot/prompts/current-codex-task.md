# Codex current task — Autopilot Product Slice 03
...
Implement Autopilot Product Slice 03 strictly inside the agent writable scope. Create exactly one Playwright smoke spec at `apps/web/tests/e2e/platform-v7-agent-generated-smoke-02.spec.ts` and do not modify product code.
