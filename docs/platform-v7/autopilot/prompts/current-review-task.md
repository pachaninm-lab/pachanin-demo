# Review current task — R1.2 Controlled open-as-role server authority
...
Review R1.2 Controlled open-as-role server authority strictly against the state allowed scope and queue.
