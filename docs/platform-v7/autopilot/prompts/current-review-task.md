# Review current task — IR-10.1 Documents PostgreSQL Authority
...
Review IR-10.1 Documents PostgreSQL Authority strictly against the state allowed scope and queue.
